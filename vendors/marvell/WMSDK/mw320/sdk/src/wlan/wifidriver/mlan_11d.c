...
static const chan_freq_power_t channel_freq_power_UN_AJ[] = {
 ...
 */
uint8_t *
wlan_11d_country_index_2_string(int country)
{
 ...
 */
t_bool
wlan_11d_support_is_enabled(mlan_private * pmpriv)
{
    ENTER();
    LEAVE();
 ...
 */
t_u16
wlan_enable_11d_support(mlan_private * pmpriv)
{
    ENTER();
    LEAVE();
 ...
 */
t_u16
wlan_11d_support_APIs(mlan_private * pmpriv)
{
    ENTER();
    LEAVE();
...
wlan_11d_set_universaltable(mlan_private * pmpriv, t_u8 band)
{
        ...
        /* If band B, G or N */
    {
        ...
        pmadapter->universal_channel[i].pcfp = (chan_freq_power_t *)
 ...
 */
t_u8
wlan_11d_get_scan_type(mlan_private * pmpriv,
                       t_u8 band,
                       t_u8 chan, parsed_region_chan_11d_t * parsed_region_chan)
{
	mlan_adapter *pmadapter = pmpriv->adapter;
