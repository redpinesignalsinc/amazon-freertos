 ...
 *           RS1xxxx from Redpine Signals Inc..
 *
 * @version  V1.2
 * @date     4. March 2016
 *
 * @note     Generated with SVDConv V2.86d 
 *           from CMSIS SVD File 'RS1xxxx.svd' Version 1.2,
 *
...
typedef enum {
  ...
  COMP1_IRQn                    =   8,              /*!< 8  COMP1                                                                  */IR_DECODER_IRQ                =  15,
...
typedef struct {
  ...
  union {
    __IOM uint32_t CHANNEL_CTRL_REG_CHNL;       /*!< (@ 0x0000000C) Channel Control Register for channel 0 to 7                */
    ...
    struct {
      ...
      __IOM uint32_t MSTR_IF_FETCH_SEL : 1;     /*!< [16..16] This selects the MASTER IF from which data to be fetched         */
      __IOM uint32_t MSTR_IF_SEND_SEL : 1;      /*!< [17..17] This selects the MASTER IF from which data to be sent            */
      ...
      __IOM uint32_t LINK_LIST_MSTR_SEL : 1;    /*!< [24..24] This mode is set, when we do link listed operation               */
      __IOM uint32_t SRC_ADDR_CONTIGUOUS : 1;   /*!< [25..25] Indicates Address is contiguous from previous                    */
      __IOM uint32_t DEST_ADDR_CONTIGUOUS : 1;  /*!< [26..26] Indicates Address is contiguous from previous                    */
  ...
  union {
    __IOM uint32_t MISC_CHANNEL_CTRL_REG_CHNL;  /*!< (@ 0x00000010) Misc Channel Control Register for channel 0                */
    ...
    struct {
      ...
      __IOM uint32_t MEM_FILL_ENABLE : 1;       /*!< [30..30] Enable for memory filling with either 1s or 0s.                  */
...
typedef struct {
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t TFR_DONE_MASK : 8;         /*!< [23..16] Transfer done interrupt bit mask control.                        */
  ...
  union {
    __IOM uint32_t DMA_CHNL_ENABLE_REG;         /*!< (@ 0x0000000C) This register used for enable DMA channel                  */
  ...
  union {
    __IOM uint32_t DMA_CHNL_SQUASH_REG;         /*!< (@ 0x00000010) This register used for enable DMA channel squash           */
...
typedef struct {
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t TMR_INTR_ENABLE : 1;       /*!< (@ 0x00000002) This Bit are Used to enable the time out interrupt         */
...
typedef struct {
  union {
    ...
    struct {
      ...
      __IOM uint32_t GROUP_INTERRUPT1_ENABLE : 1;/*!< (@ 0x00000008) When set, the corresponding GPIO is pin is selected
                                                                    for group intr 1 generation                                */
      __IOM uint32_t GROUP_INTERRUPT1_POLARITY : 1;/*!< (@ 0x00000009) Decides the active value of the pin to be considered
                                                                    for group interrupt 1 generation                           */
      __IOM uint32_t GROUP_INTERRUPT2_ENABLE : 1;/*!< (@ 0x0000000A) When set, the corresponding GPIO is pin is selected
                                                                    for group intr 2 generation                                */
      __IOM uint32_t GROUP_INTERRUPT2_POLARITY : 1;/*!< (@ 0x0000000B) Decides the active value of the pin to be considered
...
typedef struct {
  ...
  union {
    ...
    struct {
      __IOM uint32_t INTERRUPT_STATUS : 1;      /*!< (@ 0x00000000) Gets set when interrupt is enabled and occurs.             */
      __IOM uint32_t RISE_EDGE_STATUS : 1;      /*!< (@ 0x00000001) Gets set when rise edge is enabled and occurs.             */
      __IOM uint32_t FALL_EDGE_STATUS : 1;      /*!< (@ 0x00000002) Gets set when Fall edge is enabled and occurs.             */
...
typedef struct {
  union {
    __IOM uint32_t GPIO_GRP_INTR_CTRL_REG;      /*!< (@ 0x00000000) GPIO Interrupt 0 Control Register                          */
    ...
    struct {
      ...
      __IOM uint32_t ENABLE_INTERRUPT : 1;      /*!< (@ 0x00000003) Enable Interrupt                                           */
...
typedef struct {                                /*!< (@ 0x44010000) I2C1 Structure                                             */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t IC_SLAVE_DISABLE : 1;      /*!< (@ 0x00000006) This bit controls whether I2C has its slave disabled       */
      ...
      __IOM uint32_t STOP_DET_IF_MASTER_ACTIVE : 1;/*!< (@ 0x0000000A) In Master mode.                                         */
      __IOM uint32_t BUS_CLEAR_FEATURE_CTRL : 1;/*!< (@ 0x0000000B) In Master mode.                                            */
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t SLV_RX_DATA_LOST : 1;      /*!< (@ 0x00000002) Slave Received Data Lost                                   */
  ...
  union {
    __IOM uint32_t IC_SCL_STUCK_AT_LOW_TIMEOUT; /*!< (@ 0x000000AC) I2C SCL Stuck at Low Timeout                               */
  ...
  union {
    __IOM uint32_t IC_SDA_STUCK_AT_LOW_TIMEOUT; /*!< (@ 0x000000B0) I2C SDA Stuck at Low Timeout                               */
    
    struct {
      __IOM uint32_t IC_SDA_STUCK_LOW_TIMEOUT : 32;/*!< (@ 0x00000000) Initiates the recovery of SDA line , if it detects
  ...
  union {
    __IM  uint32_t IC_CLR_SCL_STUCK_DET;        /*!< (@ 0x000000B4) Clear SCL Stuck at Low Detect Interrupt Register           */
  ...
  union {
    __IOM uint32_t IC_SMBUS_CLOCK_LOW_SEXT;     /*!< (@ 0x000000BC) SMBUS Slave Clock Extend Timeout Register                  */
    
    struct {
      __IOM uint32_t SMBUS_CLK_LOW_SEXT_TIMEOUT : 32;/*!< (@ 0x00000000) The values in this register are in units of ic_clk
                                                                    period.                                                    */
    } IC_SMBUS_CLOCK_LOW_SEXT_b;
  } ;
  
  union {
    __IOM uint32_t IC_SMBUS_CLOCK_LOW_MEXT;     /*!< (@ 0x000000C0) SMBUS Master extend clock Timeout Register                 */
    
    struct {
      __IOM uint32_t SMBUS_CLK_LOW_MEXT_TIMEOUT : 32;/*!< (@ 0x00000000) The values in this register are in units of ic_clk
                                                                    period..                                                   */
    } IC_SMBUS_CLOCK_LOW_MEXT_b;
  } ;
  
  union {
    __IOM uint32_t IC_SMBUS_THIGH_MAX_IDLE_COUNT;/*!< (@ 0x000000C4) SMBus Thigh MAX Bus-Idle count Register                   */
    
    struct {
      __IOM uint32_t SMBUS_THIGH_MAX_BUS_IDLE_CNT : 16;/*!< (@ 0x00000000) The values in this register are in units of ic_clk
                                                                    period.                                                    */
      __IOM uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) Reserved1                                                  */
  ...
  union {
    __IOM uint32_t IC_SMBUS_INTR_RAW_STATUS;    /*!< (@ 0x000000D0) SMBUS Raw Interrupt Status Register                        */
  ...
  union {
    ...
    struct {
      __IM  uint32_t CLR_RESTART_DET : 1;       /*!< (@ 0x00000000) Read this register to clear the RESTART_DET interrupt
                                                                    (bit 12) of the IC_RAW_INTR_STAT registe                   */
      __IM  uint32_t            : 1;
      __IM  uint32_t MAX_SPEED_MODE : 2;        /*!< (@ 0x00000002) Maximum Speed Mode                                         */
      __IM  uint32_t HC_COUNT_VALUES : 1;       /*!< (@ 0x00000004) Hard Code the count values                                 */
      ...
      __IM  uint32_t ADD_ENCODED_PARAMS : 1;    /*!< (@ 0x00000007) Add Encoded Parameters                                     */
  ...
  union {
    ...
    struct {
      __IM  uint32_t IC_COMP_VERSION : 32;      /*!< (@ 0x00000000) Signifies the component version                            */
    } IC_COMP_VERSION_b;
  } ;
...
typedef struct {                                /*!< (@ 0x47070000) MCPWM Structure                                            */
  ...
  union {
    ...
    struct {
      __IM  uint32_t RISE_PWM_TIME_PERIOD_MATCH_INTR_CH0 : 1;/*!< (@ 0x00000000) This time base interrupt for 0th channel without
      ...
      __IM  uint32_t FLT_B_INTR : 1;            /*!< (@ 0x00000003) When the fault B pin is driven low, this interrupt
                                                                    is raised.                                                 */
      __IM  uint32_t RISE_PWM_TIME_PERIOD_MATCH_INTR_CH1 : 1;/*!< (@ 0x00000004) This time base interrupt for 1st channel without
      ...
      __IM  uint32_t PWM_TIME_PRD_MATCH_INTR_CH1 : 1;/*!< (@ 0x00000005) This time base interrupt for 1st channel, which
                                                                    considers postscaler value.                                */
      __IM  uint32_t RISE_PWM_TIME_PERIOD_MATCH_INTR_CH2 : 1;/*!< (@ 0x00000006) This time base interrupt for 2nd channel without
                                                                    considering postscaler value.                              */
      __IM  uint32_t PWM_TIME_PRD_MATCH_INTR_CH2 : 1;/*!< (@ 0x00000007) This time base interrupt for 2nd channel, which
                                                                    considers postscaler value                                 */
      __IM  uint32_t RISE_PWM_TIME_PERIOD_MATCH_INTR_CH3 : 1;/*!< (@ 0x00000008) This time base interrupt for 3rd channel without
                                                                    considering postscaler value.                              */
  ...
  union {
    ...
    struct {
      __IOM uint32_t PWM_INTR_UNMASK : 16;      /*!< (@ 0x00000000) Interrupt Unmask                                           */
      __IOM uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
    } PWM_INTR_UNMASK_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t PWM_INTR_UNMASK : 16;      /*!< (@ 0x00000000) Interrupt Mask                                             */
      __IOM uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
    } PWM_INTR_MASK_b;
  } ;
  ...
  union {
    ...
    struct {
      __OM  uint32_t RISE_PWM_TIME_PERIOD_MATCH_CH0_ACK : 1;/*!< (@ 0x00000000) pwm time period match interrupt for 0th channel
                                                                    will be cleared.                                           */
      __OM  uint32_t PWM_TIME_PRD_MATCH_INTR_CH0_ACK : 1;/*!< (@ 0x00000001) pwm time period match interrupt for 0th channel
                                                                    will be cleared                                            */
      __OM  uint32_t FLT_A_INTR_ACK : 1;        /*!< (@ 0x00000002) pwm fault A interrupt will be cleared.                     */
      __OM  uint32_t FLT_B_INTR_ACK : 1;        /*!< (@ 0x00000003) pwm fault B interrupt will be cleared.                     */
      __OM  uint32_t RISE_PWM_TIME_PERIOD_MATCH_CH1_ACK : 1;/*!< (@ 0x00000004) pwm time period match interrupt for 1st channel
                                                                    will be cleared                                            */
      __OM  uint32_t PWM_TIME_PRD_MATCH_INTR_CH1_ACK : 1;/*!< (@ 0x00000005) pwm time period match interrupt for 1st channel
                                                                    will be cleared.                                           */
      __OM  uint32_t RISE_PWM_TIME_PERIOD_MATCH_CH2_ACK : 1;/*!< (@ 0x00000006) pwm time period match interrupt for 2nd channel
                                                                    will be cleared.                                           */
      __OM  uint32_t PWM_TIME_PRD_MATCH_INTR_CH2_ACK : 1;/*!< (@ 0x00000007) pwm time period match interrupt for 2nd channel
                                                                    will be cleared.                                           */
      __OM  uint32_t RISE_PWM_TIME_PERIOD_MATCH_CH3_ACK : 1;/*!< (@ 0x00000008) pwm time period match interrupt for 3rd channel
                                                                    will be cleared.                                           */
      __OM  uint32_t PWM_TIME_PRD_MATCH_INTR_CH3_ACK : 1;/*!< (@ 0x00000009) pwm time period match interrupt for 3rd channel
                                                                    will be cleared.                                           */
  ...
  union {
    __IOM uint32_t PWM_TIME_PRD_WR_REG_CH0;     /*!< (@ 0x00000028) Base timer period register of channel 0                    */
    
    struct {
      __IOM uint32_t PWM_TIME_PRD_REG_WR_VALUE_CH0 : 16;/*!< (@ 0x00000000) Value to update the base timer period register
                                                                    of channel 0                                               */
      __IOM uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t PWM_TIME_PRD_CNTR_WR_REG_CH0 : 16;/*!< (@ 0x00000000) To update the base time counter initial value
                                                                    for channel 0                                              */
      __IOM uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t TMR_OPEARATING_MODE_CH0 : 3;/*!< (@ 0x00000000) Base timer operating mode for channel0                    */
      __IOM uint32_t RESERVED1  : 1;            /*!< (@ 0x00000003) reserved1                                                  */
      __IOM uint32_t PWM_TIME_PRD_PRE_SCALAR_VALUE_CH0 : 3;/*!< (@ 0x00000004) Base timer input clock pre scale select value
                                                                    for channel0.                                              */
      __IOM uint32_t RESERVED2  : 1;            /*!< (@ 0x00000007) reserved2                                                  */
      __IOM uint32_t PWM_TIME_PRD_POST_SCALAR_VALUE_CH0 : 4;/*!< (@ 0x00000008) Time base output post scale bits for channel0  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t PWM_TIME_PRD_CNTR_RST_FRM_REG : 1;/*!< (@ 0x00000000) Time period counter soft reset                      */
      __IOM uint32_t PWM_TIME_BASE_EN_FRM_REG_CH0 : 1;/*!< (@ 0x00000001) Base timer enable for channnel0                      */
  ...
  union {
    __IM  uint32_t PWM_TIME_PRD_STS_REG_CH0;    /*!< (@ 0x00000038) Base time period status register for channel0              */
    
    struct {
      __IM  uint32_t PWM_TIME_PRD_DIR_STS_CH0 : 1;/*!< (@ 0x00000000) Time period counter direction status for channel0        */
      __IM  uint32_t RESERVED1  : 31;           /*!< (@ 0x00000001) reserved1                                                  */
  ...
  union {
    ...
    struct {
      __IM  uint32_t PWM_TIME_PRD_CNTR_VALUE_CH0 : 16;/*!< (@ 0x00000000) Time period counter current value for channel0       */
      __IM  uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
  ...
  union {
    __IOM uint32_t PWM_DUTYCYCLE_CTRL_SET_REG;  /*!< (@ 0x00000050) Duty cycle Control Set Register                            */
    
    struct {
      __IOM uint32_t IMDT_DUTYCYCLE_UPDATE_EN : 4;/*!< (@ 0x00000000) Enable to update the duty cycle immediately              */
  ...
  union {
    __IOM uint32_t PWM_DUTYCYCLE_CTRL_RESET_REG;/*!< (@ 0x00000054) Duty cycle Control Reset Register                          */
  ...
  union {
    __IOM uint32_t PWM_DUTYCYCLE_REG_WR_VALUE[4];/*!< (@ 0x00000058) Duty cycle Value Register for Channel0 to channel3        */
    
    struct {
      __IOM uint32_t PWM_DUTYCYCLE_REG_WR_VALUE_CH : 16;/*!< (@ 0x00000000) Duty cycle value for channel0 to channel3          */
      __IM  uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
  ...
  union {
    __IOM uint32_t PWM_DEADTIME_CTRL_SET_REG;   /*!< (@ 0x00000078) Dead time Control Set Register                             */
    
    struct {
      __IOM uint32_t DEADTIME_SELECT_ACTIVE : 4;/*!< (@ 0x00000000) Dead time select bits for PWM going active                 */
      __IOM uint32_t DEADTIME_SELECT_INACTIVE : 4;/*!< (@ 0x00000004) Dead time select bits for PWM going inactive             */
      __IOM uint32_t DEADTIME_DISABLE_FRM_REG : 4;/*!< (@ 0x00000008) Dead time counter soft reset for each channel.           */
      __IM  uint32_t RESERVED1  : 20;           /*!< (@ 0x0000000C) reserved1                                                  */
    } PWM_DEADTIME_CTRL_SET_REG_b;
  } ;
  
  union {
    __IOM uint32_t PWM_DEADTIME_CTRL_RESET_REG; /*!< (@ 0x0000007C) Dead time Control Reset Register                           */
  ...
  union {
    __IOM uint32_t PWM_DEADTIME_PRESCALE_SELECT_A;/*!< (@ 0x00000080) Dead time Prescale Select Register for A                 */
    
    struct {
      __IOM uint32_t DEADTIME_PRESCALE_SELECT_A : 8;/*!< (@ 0x00000000) Dead time prescale selection bits for unit A.          */
      __IM  uint32_t RESERVED1  : 24;           /*!< (@ 0x00000008) reserved1                                                  */
    } PWM_DEADTIME_PRESCALE_SELECT_A_b;
  } ;
  
  union {
    __IOM uint32_t PWM_DEADTIME_PRESCALE_SELECT_B;/*!< (@ 0x00000084) Dead time Prescale Select Register for B                 */
    
    struct {
      __IOM uint32_t DEADTIME_PRESCALE_SELECT_B : 8;/*!< (@ 0x00000000) Dead time prescale selection bits for unit B           */
      __IM  uint32_t RESERVED1  : 24;           /*!< (@ 0x00000008) reserved1                                                  */
  ...
  union {
    __IOM uint32_t PWM_OP_OVERRIDE_CTRL_SET_REG;/*!< (@ 0x000000C8) output override control set register                       */
  ...
  union {
    __IOM uint32_t PWM_OP_OVERRIDE_CTRL_RESET_REG;/*!< (@ 0x000000CC) output override control reset register                   */
  ...
  union {
    __IOM uint32_t PWM_OP_OVERRIDE_ENABLE_SET_REG;/*!< (@ 0x000000D0) output override enable set register                      */
    
    struct {
      __IOM uint32_t PWM_OP_OVERRIDE_ENABLE_REG : 8;/*!< (@ 0x00000000) Pwm output over ride enable                            */
      __IOM uint32_t RESERVED1  : 24;           /*!< (@ 0x00000008) reserved1                                                  */
    } PWM_OP_OVERRIDE_ENABLE_SET_REG_b;
  } ;
  
  union {
    __IOM uint32_t PWM_OP_OVERRIDE_ENABLE_RESET_REG;/*!< (@ 0x000000D4) output override enable reset register                  */
  ...
  union {
    __IOM uint32_t PWM_OP_OVERRIDE_VALUE_SET_REG;/*!< (@ 0x000000D8) output override value set register                        */
    
    struct {
      __IOM uint32_t OP_OVERRIDE_VALUE : 8;     /*!< (@ 0x00000000) Pwm output over ride value.                                */
      __IOM uint32_t RESERVED1  : 24;           /*!< (@ 0x00000008) reserved1                                                  */
    } PWM_OP_OVERRIDE_VALUE_SET_REG_b;
  } ;
  
  union {
    __IOM uint32_t PWM_OP_OVERRIDE_VALUE_RESET_REG;/*!< (@ 0x000000DC) output override enable reset register                   */
  ...
  union {
    __IOM uint32_t PWM_FLT_OVERRIDE_CTRL_SET_REG;/*!< (@ 0x000000E0) fault override control set register                       */
    ...
    struct {
      ...
      __IOM uint32_t FLT_B_ENABLE : 4;          /*!< (@ 0x00000008) Fault B enable. Separate enable bit is present
                                                                    for channel                                                */
      __IOM uint32_t COMPLEMENTARY_MODE : 4;    /*!< (@ 0x0000000C) PWM I/O pair mode                                          */
      __IOM uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
    } PWM_FLT_OVERRIDE_CTRL_SET_REG_b;
  } ;
  
  union {
    __IOM uint32_t PWM_FLT_OVERRIDE_CTRL_RESET_REG;/*!< (@ 0x000000E4) fault override control reset register                   */
  ...
  union {
    __IOM uint32_t PWM_FLT_A_OVERRIDE_VALUE_REG;/*!< (@ 0x000000E8) Fault input A PWM override value                           */
    
    struct {
      __IOM uint32_t PWM_FLT_A_OVERRIDE_VALUE_L0 : 1;/*!< (@ 0x00000000) 0 bit for L0                                          */
      __IOM uint32_t PWM_FLT_A_OVERRIDE_VALUE_L1 : 1;/*!< (@ 0x00000001) 1 bit for L1                                          */
      __IOM uint32_t PWM_FLT_A_OVERRIDE_VALUE_L2 : 1;/*!< (@ 0x00000002) 2 bit for L2                                          */
      __IOM uint32_t PWM_FLT_A_OVERRIDE_VALUE_L3 : 1;/*!< (@ 0x00000003) 3 bit for L3                                          */
      __IOM uint32_t PWM_FLT_A_OVERRIDE_VALUE_H0 : 1;/*!< (@ 0x00000004) 4 bit for H0                                          */
      __IOM uint32_t PWM_FLT_A_OVERRIDE_VALUE_H1 : 1;/*!< (@ 0x00000005) 5 bit for H1                                          */
      __IOM uint32_t PWM_FLT_A_OVERRIDE_VALUE_H2 : 1;/*!< (@ 0x00000006) 6 bit for H2                                          */
      __IOM uint32_t PWM_FLT_A_OVERRIDE_VALUE_H3 : 1;/*!< (@ 0x00000007) 7 bit for H3                                          */
      __IOM uint32_t RESERVED1  : 24;           /*!< (@ 0x00000008) reserved1                                                  */
    } PWM_FLT_A_OVERRIDE_VALUE_REG_b;
  } ;
  
  union {
    __IOM uint32_t PWM_FLT_B_OVERRIDE_VALUE_REG;/*!< (@ 0x000000EC) Fault input B PWM override value                           */
    
    struct {
      __IOM uint32_t PWM_FLT_B_OVERRIDE_VALUE_L0 : 1;/*!< (@ 0x00000000) 0 bit for L0                                          */
      __IOM uint32_t PWM_FLT_B_OVERRIDE_VALUE_L1 : 1;/*!< (@ 0x00000001) 1 bit for L1                                          */
      __IOM uint32_t PWM_FLT_B_OVERRIDE_VALUE_L2 : 1;/*!< (@ 0x00000002) 2 bit for L2                                          */
      __IOM uint32_t PWM_FLT_B_OVERRIDE_VALUE_L3 : 1;/*!< (@ 0x00000003) 3 bit for L3                                          */
      __IOM uint32_t PWM_FLT_B_OVERRIDE_VALUE_H0 : 1;/*!< (@ 0x00000004) 4 bit for H0                                          */
      __IOM uint32_t PWM_FLT_B_OVERRIDE_VALUE_H1 : 1;/*!< (@ 0x00000005) 5 bit for H1                                          */
      __IOM uint32_t PWM_FLT_B_OVERRIDE_VALUE_H2 : 1;/*!< (@ 0x00000006) 6 bit for H2                                          */
      __IOM uint32_t PWM_FLT_B_OVERRIDE_VALUE_H3 : 1;/*!< (@ 0x00000007) 7 bit for H3                                          */
      __IOM uint32_t RESERVED1  : 24;           /*!< (@ 0x00000008) reserved1                                                  */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t SVT_DIRECTION_FRM : 1;     /*!< (@ 0x00000001) Special event trigger for time base direction              */
      __IOM uint32_t RESERVED1  : 30;           /*!< (@ 0x00000002) reserved1                                                  */
    } PWM_SVT_CTRL_SET_REG_b;
  } ;
  
  union {
    __IOM uint32_t PWM_SVT_CTRL_RESET_REG;      /*!< (@ 0x000000F4) Special event control reset register                       */
  ...
  union {
    __IOM uint32_t PWM_SVT_COMPARE_VALUE_REG;   /*!< (@ 0x000000FC) Special event compare value register                       */
  ...
  union {
    __IOM uint32_t PWM_TIME_PRD_WR_REG_CH1;     /*!< (@ 0x00000100) Base timer period register of channel1                     */
    
    struct {
      __IOM uint32_t PWM_TIME_PRD_REG_WR_VALUE_CH1 : 16;/*!< (@ 0x00000000) Value to update the base timer period register
                                                                    of channel 1                                               */
      __IOM uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t PWM_TIME_PRD_CNTR_WR_REG_CH1 : 16;/*!< (@ 0x00000000) To update the base time counter initial value
                                                                    for channel 1                                              */
      __IOM uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t TMR_OPEARATING_MODE_CH1 : 3;/*!< (@ 0x00000000) Base timer operating mode for channel1                    */
      __IOM uint32_t RESERVED1  : 1;            /*!< (@ 0x00000003) reserved1                                                  */
      __IOM uint32_t PWM_TIME_PRD_PRE_SCALAR_VALUE_CH1 : 3;/*!< (@ 0x00000004) Base timer input clock prescale select value
                                                                    for channel1.                                              */
      __IOM uint32_t RESERVED2  : 1;            /*!< (@ 0x00000007) reserved2                                                  */
      __IOM uint32_t PWM_TIME_PRD_POST_SCALAR_VALUE_CH1 : 4;/*!< (@ 0x00000008) Time base output post scale bits for channel1  */
      __IOM uint32_t RESERVED3  : 20;           /*!< (@ 0x0000000C) reserved3                                                  */
    } PWM_TIME_PRD_PARAM_REG_CH1_b;
  } ;
  
  union {
    __IOM uint32_t PWM_TIME_PRD_CTRL_REG_CH1;   /*!< (@ 0x0000010C) Base time period control register for channel1             */
    
    struct {
      __IOM uint32_t PWM_TIME_PRD_CNTR_RST_FRM_REG : 1;/*!< (@ 0x00000000) Time period counter soft reset                      */
      __IOM uint32_t PWM_TIME_BASE_EN_FRM_REG_CH1 : 1;/*!< (@ 0x00000001) Base timer enable for channnel1                      */
      __IOM uint32_t PWM_SFT_RST : 1;           /*!< (@ 0x00000002) MC PWM soft reset                                          */
      __IOM uint32_t RESERVED1  : 29;           /*!< (@ 0x00000003) reserved1                                                  */
  ...
  union {
    __IM  uint32_t PWM_TIME_PRD_STS_REG_CH1;    /*!< (@ 0x00000110) Base time period status register for channel1              */
    
    struct {
      __IM  uint32_t PWM_TIME_PRD_DIR_STS_CH1 : 1;/*!< (@ 0x00000000) Time period counter direction status for channel1.       */
      __IM  uint32_t RESERVED1  : 31;           /*!< (@ 0x00000001) reserved1                                                  */
    } PWM_TIME_PRD_STS_REG_CH1_b;
  } ;
  
  union {
    __IOM uint32_t PWM_TIME_PRD_CNTR_VALUE_CH1; /*!< (@ 0x00000114) Time period counter current value for channel1             */
    
    struct {
      __IOM uint32_t PWM_TIME_PRD_CNTR_VALUE_CH1 : 1;/*!< (@ 0x00000000) Time period counter current value for channel1        */
      __IM  uint32_t RESERVED1  : 31;           /*!< (@ 0x00000001) reserved1                                                  */
    } PWM_TIME_PRD_CNTR_VALUE_CH1_b;
  } ;
  
  union {
    __IOM uint32_t PWM_TIME_PRD_WR_REG_CH2;     /*!< (@ 0x00000118) Base timer period register of channel2                     */
    
    struct {
      __IOM uint32_t PWM_TIME_PRD_REG_WR_VALUE_CH2 : 16;/*!< (@ 0x00000000) Value to update the base timer period register
                                                                    of channel 2                                               */
      __IOM uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t PWM_TIME_PRD_CNTR_WR_REG_CH2 : 16;/*!< (@ 0x00000000) To update the base time counter initial value
                                                                    for channel 2                                              */
      __IOM uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t TMR_OPEARATING_MODE_CH2 : 3;/*!< (@ 0x00000000) Base timer operating mode for channel2                    */
      __IOM uint32_t RESERVED1  : 1;            /*!< (@ 0x00000003) reserved1                                                  */
      __IOM uint32_t PWM_TIME_PRD_PRE_SCALAR_VALUE_CH2 : 3;/*!< (@ 0x00000004) Base timer input clock pre scale select value
                                                                    for channel2.                                              */
      __IOM uint32_t RESERVED2  : 1;            /*!< (@ 0x00000007) reserved2                                                  */
      __IOM uint32_t PWM_TIME_PRD_POST_SCALAR_VALUE_CH2 : 4;/*!< (@ 0x00000008) Time base output post scale bits for channel2  */
      __IOM uint32_t RESERVED3  : 20;           /*!< (@ 0x0000000C) reserved3                                                  */
    } PWM_TIME_PRD_PARAM_REG_CH2_b;
  } ;
  
  union {
    __IOM uint32_t PWM_TIME_PRD_CTRL_REG_CH2;   /*!< (@ 0x00000124) Base time period control register for channel2             */
    
    struct {
      __IOM uint32_t PWM_TIME_PRD_CNTR_RST_FRM_REG : 1;/*!< (@ 0x00000000) Time period counter soft reset                      */
      __IOM uint32_t PWM_TIME_BASE_EN_FRM_REG_CH2 : 1;/*!< (@ 0x00000001) Base timer enable for channnel2                      */
      __IOM uint32_t PWM_SFT_RST : 1;           /*!< (@ 0x00000002) MC PWM soft reset                                          */
      __IOM uint32_t RESERVED1  : 29;           /*!< (@ 0x00000003) reserved1                                                  */
  ...
  union {
    __IM  uint32_t PWM_TIME_PRD_STS_REG_CH2;    /*!< (@ 0x00000128) Base time period status register for channel2              */
    
    struct {
      __IM  uint32_t PWM_TIME_PRD_DIR_STS_CH2 : 1;/*!< (@ 0x00000000) Time period counter direction status for channel2.       */
      __IM  uint32_t RESERVED1  : 31;           /*!< (@ 0x00000001) reserved1                                                  */
  ...
  union {
    ...
    struct {
      __IM  uint32_t PWM_TIME_PRD_CNTR_VALUE_CH2 : 1;/*!< (@ 0x00000000) Time period counter current value for channel2        */
  ...
  union {
    __IOM uint32_t PWM_TIME_PRD_WR_REG_CH3;     /*!< (@ 0x00000130) Base timer period register of channel3                     */
    
    struct {
      __IOM uint32_t PWM_TIME_PRD_REG_WR_VALUE_CH3 : 16;/*!< (@ 0x00000000) To update the base time counter initial value
                                                                    for channel 3                                              */
      __IOM uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t PWM_TIME_PRD_CNTR_WR_REG_CH3 : 16;/*!< (@ 0x00000000) Value to update the base timer period register
                                                                    of channel 3                                               */
      __IOM uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t TMR_OPEARATING_MODE_CH3 : 3;/*!< (@ 0x00000000) Base timer operating mode for channel3                    */
      __IOM uint32_t RESERVED1  : 1;            /*!< (@ 0x00000003) reserved1                                                  */
      __IOM uint32_t PWM_TIME_PRD_PRE_SCALAR_VALUE_CH3 : 3;/*!< (@ 0x00000004) Base timer input clock pre scale select value
                                                                    for channel2.                                              */
      __IOM uint32_t RESERVED2  : 1;            /*!< (@ 0x00000007) reserved2                                                  */
      __IOM uint32_t PWM_TIME_PRD_POST_SCALAR_VALUE_CH3 : 4;/*!< (@ 0x00000008) Time base output post scale bits for channel3  */
      __IOM uint32_t RESERVED3  : 20;           /*!< (@ 0x0000000C) reserved3                                                  */
    } PWM_TIME_PRD_PARAM_REG_CH3_b;
  } ;
  
  union {
    __IOM uint32_t PWM_TIME_PRD_CTRL_REG_CH3;   /*!< (@ 0x0000013C) Base time period control register for channel3             */
    
    struct {
      __IOM uint32_t PWM_TIME_PRD_CNTR_RST_FRM_REG : 1;/*!< (@ 0x00000000) Time period counter soft reset                      */
      __IOM uint32_t PWM_TIME_BASE_EN_FRM_REG_CH3 : 1;/*!< (@ 0x00000001) Base timer enable for channnel3                      */
      __IOM uint32_t PWM_SFT_RST : 1;           /*!< (@ 0x00000002) MC PWM soft reset                                          */
      __IOM uint32_t RESERVED1  : 29;           /*!< (@ 0x00000003) reserved1                                                  */
  ...
  union {
    __IM  uint32_t PWM_TIME_PRD_STS_REG_CH3;    /*!< (@ 0x00000140) Base time period status register for channel3              */
    
    struct {
      __IM  uint32_t PWM_TIME_PRD_DIR_STS_CH3 : 1;/*!< (@ 0x00000000) Time period counter direction status for channel3.       */
  ...
  union {
    ...
    struct {
      __IM  uint32_t PWM_TIME_PRD_CNTR_VALUE_CH3 : 16;/*!< (@ 0x00000000) Time period counter current value for channe3        */
      __IM  uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
    } PWM_TIME_PRD_CNTR_VALUE_CH3_b;
  } ;
  
  union {
    __IOM uint32_t PWM_TIME_PRD_COMMON_REG;     /*!< (@ 0x00000148) Time period common register                                */
    
    struct {
      __IOM uint32_t PWM_TIME_PRD_USE_0TH_TIMER_ONLY : 1;/*!< (@ 0x00000000) Instead of use four base timers for four channels,
                                                                    use only one base timer for all channels.                  */
      __IOM uint32_t PWM_TIME_PRD_COMMON_TIMER_VALUE : 2;/*!< (@ 0x00000001) Base timers select to generate special event
                                                                    trigger                                                    */
...
typedef struct {                                /*!< (@ 0x44030000) UDMA0 Structure                                            */
  ...
  union {
    ...
    struct {
      __IM  uint32_t ALT_CTRL_BASE_PTR : 32;    /*!< (@ 0x00000000) Base address of the alternative data structure             */
    } ALT_CTRL_BASE_PTR_b;
  } ;
  
  union {
    __IM  uint32_t DMA_WAITONREQUEST_STATUS;    /*!< (@ 0x00000010) Channel Wait on request status register                    */
    
    struct {
      __IM  uint32_t DMA_WAITONREQ_STATUS : 32; /*!< (@ 0x00000000) Per Channel wait on request status                         */
  ...
  union {
    __IOM uint32_t UDMA_SKIP_DESC_FETCH_REG;    /*!< (@ 0x00000050) UDMA skip descriptor fetch Register                        */
  ...
  union {
    ...
    struct {
      __IOM uint32_t DONE_STATUS_CHANNEL_0 : 1; /*!< (@ 0x00000000) UDMA done Status of the channel 0                          */
      __IOM uint32_t DONE_STATUS_CHANNEL_1 : 1; /*!< (@ 0x00000001) UDMA done Status of the channel 1                          */
      __IOM uint32_t DONE_STATUS_CHANNEL_2 : 1; /*!< (@ 0x00000002) UDMA done Status of the channel 2                          */
      __IOM uint32_t DONE_STATUS_CHANNEL_3 : 1; /*!< (@ 0x00000003) UDMA done Status of the channel 3                          */
      __IOM uint32_t DONE_STATUS_CHANNEL_4 : 1; /*!< (@ 0x00000004) UDMA done Status of the channel 4                          */
      __IOM uint32_t DONE_STATUS_CHANNEL_5 : 1; /*!< (@ 0x00000005) UDMA done Status of the channel 5                          */
      __IOM uint32_t DONE_STATUS_CHANNEL_6 : 1; /*!< (@ 0x00000006) UDMA done Status of the channel 6                          */
      __IOM uint32_t DONE_STATUS_CHANNEL_7 : 1; /*!< (@ 0x00000007) UDMA done Status of the channel 7                          */
      __IOM uint32_t DONE_STATUS_CHANNEL_8 : 1; /*!< (@ 0x00000008) UDMA done Status of the channel 8                          */
      __IOM uint32_t DONE_STATUS_CHANNEL_9 : 1; /*!< (@ 0x00000009) UDMA done Status of the channel 9                          */
      __IOM uint32_t DONE_STATUS_CHANNEL_10 : 1;/*!< (@ 0x0000000A) UDMA done Status of the channel 10                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_11 : 1;/*!< (@ 0x0000000B) UDMA done Status of the channel 3                          */
      __IOM uint32_t DONE_STATUS_CHANNEL_12 : 1;/*!< (@ 0x0000000C) UDMA done Status of the channel 12                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_13 : 1;/*!< (@ 0x0000000D) UDMA done Status of the channel 13                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_14 : 1;/*!< (@ 0x0000000E) UDMA done Status of the channel 14                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_15 : 1;/*!< (@ 0x0000000F) UDMA done Status of the channel 15                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_16 : 1;/*!< (@ 0x00000010) UDMA done Status of the channel 16                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_17 : 1;/*!< (@ 0x00000011) UDMA done Status of the channel 17                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_18 : 1;/*!< (@ 0x00000012) UDMA done Status of the channel 18                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_19 : 1;/*!< (@ 0x00000013) UDMA done Status of the channel 19                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_20 : 1;/*!< (@ 0x00000014) UDMA done Status of the channel 3                          */
      __IOM uint32_t DONE_STATUS_CHANNEL_21 : 1;/*!< (@ 0x00000015) UDMA done Status of the channel 21                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_22 : 1;/*!< (@ 0x00000016) UDMA done Status of the channel 22                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_23 : 1;/*!< (@ 0x00000017) UDMA done Status of the channel 23                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_24 : 1;/*!< (@ 0x00000018) UDMA done Status of the channel 24                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_25 : 1;/*!< (@ 0x00000019) UDMA done Status of the channel 25                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_26 : 1;/*!< (@ 0x0000001A) UDMA done Status of the channel 26                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_27 : 1;/*!< (@ 0x0000001B) UDMA done Status of the channel 27                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_28 : 1;/*!< (@ 0x0000001C) UDMA done Status of the channel 28                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_29 : 1;/*!< (@ 0x0000001D) UDMA done Status of the channel 29                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_30 : 1;/*!< (@ 0x0000001E) UDMA done Status of the channel 30                         */
      __IOM uint32_t DONE_STATUS_CHANNEL_31 : 1;/*!< (@ 0x0000001F) UDMA done Status of the channel 31                         */
  ...
  union {
    ...
    struct {
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_0 : 1;/*!< (@ 0x00000000) Reading 1 indicates that the channel 0 is busy     */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_1 : 1;/*!< (@ 0x00000001) Reading 1 indicates that the channel 1 is busy     */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_2 : 1;/*!< (@ 0x00000002) Reading 1 indicates that the channel 2 is busy     */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_3 : 1;/*!< (@ 0x00000003) Reading 1 indicates that the channel 3 is busy     */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_4 : 1;/*!< (@ 0x00000004) Reading 1 indicates that the channel 4 is busy     */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_5 : 1;/*!< (@ 0x00000005) Reading 1 indicates that the channel 5 is busy     */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_6 : 1;/*!< (@ 0x00000006) Reading 1 indicates that the channel 6 is busy     */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_7 : 1;/*!< (@ 0x00000007) Reading 1 indicates that the channel 7 is busy     */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_8 : 1;/*!< (@ 0x00000008) Reading 1 indicates that the channel 8 is busy     */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_9 : 1;/*!< (@ 0x00000009) Reading 1 indicates that the channel 9 is busy     */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_10 : 1;/*!< (@ 0x0000000A) Reading 1 indicates that the channel 10 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_11 : 1;/*!< (@ 0x0000000B) Reading 1 indicates that the channel 11 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_12 : 1;/*!< (@ 0x0000000C) Reading 1 indicates that the channel 12 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_13 : 1;/*!< (@ 0x0000000D) Reading 1 indicates that the channel 13 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_14 : 1;/*!< (@ 0x0000000E) Reading 1 indicates that the channel 14 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_15 : 1;/*!< (@ 0x0000000F) Reading 1 indicates that the channel 15 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_16 : 1;/*!< (@ 0x00000010) Reading 1 indicates that the channel 16 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_17 : 1;/*!< (@ 0x00000011) Reading 1 indicates that the channel 17 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_18 : 1;/*!< (@ 0x00000012) Reading 1 indicates that the channel 18 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_19 : 1;/*!< (@ 0x00000013) Reading 1 indicates that the channel 19 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_20 : 1;/*!< (@ 0x00000014) Reading 1 indicates that the channel 20 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_21 : 1;/*!< (@ 0x00000015) Reading 1 indicates that the channel 21 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_22 : 1;/*!< (@ 0x00000016) Reading 1 indicates that the channel 22 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_23 : 1;/*!< (@ 0x00000017) Reading 1 indicates that the channel 23 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_24 : 1;/*!< (@ 0x00000018) Reading 1 indicates that the channel 24 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_25 : 1;/*!< (@ 0x00000019) Reading 1 indicates that the channel 25 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_26 : 1;/*!< (@ 0x0000001A) Reading 1 indicates that the channel 26 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_27 : 1;/*!< (@ 0x0000001B) Reading 1 indicates that the channel 27 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_28 : 1;/*!< (@ 0x0000001C) Reading 1 indicates that the channel 28 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_29 : 1;/*!< (@ 0x0000001D) Reading 1 indicates that the channel 29 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_30 : 1;/*!< (@ 0x0000001E) Reading 1 indicates that the channel 30 is busy   */
      __IM  uint32_t BUSY_OR_IDEAL_STATUS_CHANNEL_31 : 1;/*!< (@ 0x0000001F) Reading 1 indicates that the channel 31 is busy   */
    } CHANNEL_STATUS_REG_b;
  } ;
  __IM  uint32_t  RESERVED2[8];
  
  union {
    __IOM uint32_t UDMA_CONFIG_CTRL_REG;        /*!< (@ 0x00000828) DMA Controller Transfer Length Register                    */
    
    struct {
      __IOM uint32_t SINGLE_REQUEST_ENABLE : 1; /*!< (@ 0x00000000) Enabled signal for single request                          */
...
typedef struct {                                /*!< (@ 0x24042000) TIMERS Structure                                           */
  ...
  union {
    __IOM uint32_t MCUULP_TMR_US_PERIOD_INT;    /*!< (@ 0x00000084) Timer micro second period Integral Part Register           */
  ...
  union {
    __IOM uint32_t MCUULP_TMR_US_PERIOD_FRAC;   /*!< (@ 0x00000088) Timer microsecond period Fractional Part Register          */
  ...
  union {
    __IOM uint32_t MCUULP_TMR_MS_PERIOD_INT;    /*!< (@ 0x0000008C) Timer 256 microsecond period Integral Part Register        */
  ...
  union {
    __IM  uint32_t MCUULP_TMR_ACTIVE_STATUS;    /*!< (@ 0x0000009C) Timer Active Status Register                               */
...
typedef struct {                                    /*!< QEI Structure                                                         */
	...
	union {
		...
		struct {
			...
			__I  uint32_t  POSITION_CNTR_DIRECTION:  1;   /*!< Position Counter Direction Status bit                                 */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  POS_CNT_RST_WITH_INDEX_EN:  1; /*!< Phase A and Phase B Input Swap Select bit                             */
			uint32_t             :  1;
			__IO uint32_t  POS_CNT_DIRECTION_CTRL:  1;    /*!< NONE                                                                  */
			__IO uint32_t  POS_CNT_DIR_FRM_REG:  1;       /*!< Position Counter Direction indication from user                       */
			uint32_t             :  2;
			__IO uint32_t  INDEX_CNT_RST_EN:  1;          /*!< NONE                                                                  */
			__IO uint32_t  DIGITAL_FILTER_BYPASS:  1;     /*!< NONE                                                                  */
			__IO uint32_t  TIMER_MODE :  1;               /*!< NONE                                                                  */
			__IO uint32_t  START_VELOCITY_CNTR:  1;       /*!< Starting the velocity counter. It is self reset bit.                  */
			__IO uint32_t  QEI_STOP_IN_IDLE:  1;          /*!< NONE                                                                  */
			__IO uint32_t  QEI_POS_CNT_16_BIT_MODE:  1;   /*!< Qei position counter 16 bit mode enable                               */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  UNIDIRECTIONAL_VELOCITY:  1;   /*!< Uni directional velocity enable.                                      */
			__IO uint32_t  UNIDIRECTIONAL_INDEX:  1;      /*!< Uni directional index enable.                                         */
	...
	union {
		...
		struct {
			__IO uint32_t  QEI_INDEX_MAX_CNT: 16;         /*!< Qei index maximum count.                                              */
	...
	union {
		__IO uint32_t  QEI_POSITION_MAX_CNT_LSW_REG;    /*!< NONE                                                                  */
	...
	union {
		...
		struct {
			__IO uint32_t  QEI_POSITION_CNT_RESET_INTR_LEV:  1;/*!< This is raised when the position counter reaches it's extremes   */
			...
			__I  uint32_t  VELOCITY_LESS_THAN_INTR_LEV:  1;/*!< When velocity count is less than the value given in velocity_value_to_comp
                                                         are register, interrupt is raised                                     */
			__I  uint32_t  QEI_POSITION_CNT_MATCH_INTR_LEV:  1;/*!< This is raised when the position counter reaches position match
	...
	union {
		...
		struct {
			__IO uint32_t  QEI_POSITION_CNT_RESET_INTR_LEV:  1;/*!< Qei_position_cnt_reset_intr_ack                                  */
			__IO uint32_t  QEI_INDEX_CNT_MATCH_INTR_LEV:  1;/*!< NONE                                                                */
			__IO uint32_t  POSITION_CNTR_ERR_INTR_LEV:  1;/*!< Position_cntr_err_intr_ack                                            */
	...
	union {
		...
		struct {
			__IO uint32_t  QEI_POSITION_CNT_RESET_INTR_MASK:  1;/*!< Qei_position_cnt_reset_intr_mask                                */
			__IO uint32_t  QEI_INDEX_CNT_MATCH_INTR_MASK:  1;/*!< Qei_index_cnt_match_intr_mask                                      */
			__IO uint32_t  POSITION_CNTR_ERR_INTR_MASK:  1;/*!< Position_cntr_err_intr_mask                                          */
			__IO uint32_t  VELOCITY_LESS_THAN_INTR_MASK:  1;/*!< Velocity_less_than_intr_mask                                        */
			__IO uint32_t  QEI_POSITION_CNT_MATCH_INTR_MASK:  1;/*!< Qei_position_cnt_match_intr_mask                                */
	...
	union {
		...
		struct {
			__IO uint32_t  QEI_POSITION_CNT_RESET_INTR_UNMASK:  1;/*!< Qei_position_cnt_reset_intr_unmask                            */
			__IO uint32_t  QEI_INDEX_CNT_MATCH_INTR_UNMASK:  1;/*!< Qei_index_cnt_match_intr_unmask                                  */
			__IO uint32_t  POSITION_CNTR_ERR_INTR_UNMASK:  1;/*!< Position_cntr_err_intr_unmask                                      */
	...
	union {
		...
		struct {
			__IO uint32_t  DELTA_TIME_FOR_VELOCITY: 20;   /*!< Delta time LSW to compute velocity                                    */
	...
	union {
		...
		struct {
			__IO uint32_t  POSTION_MATCH_VALUE_L: 16;     /*!< Position match value to compare the position counter.                 */
			__IO uint32_t  POSTION_MATCH_VALUE_H: 16;     /*!< Position match value to compare the position counter.                 */
...
typedef struct {                                    /*!< UART0 Structure                                                       */
	...
	union {
		...
		struct {
			...
			__I  uint32_t  UART_ADD_ENCODED_PARAMS:  1;   /*!< none                                                                  */
...
typedef struct {                                /*!< (@ 0x45030000) GSPI0 Structure                                            */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t GSPI_CLK_MODE_CSN0 : 1;    /*!< (@ 0x00000001) NONE                                                       */
      __IOM uint32_t GSPI_CLK_MODE_CSN1 : 1;    /*!< (@ 0x00000002) NONE                                                       */
      __IOM uint32_t GSPI_CLK_MODE_CSN2 : 1;    /*!< (@ 0x00000003) NONE                                                       */
      __IOM uint32_t GSPI_CLK_MODE_CSN3 : 1;    /*!< (@ 0x00000004) NONE                                                       */
      __IOM uint32_t GSPI_GPIO_MODE_ENABLES : 6;/*!< (@ 0x00000005) These bits are used to map GSPI on GPIO pins               */
  ...
  union {
    ...
    struct {
      __IOM uint32_t GSPI_MANUAL_CSN : 1;       /*!< (@ 0x00000000) SPI CS in manual mode                                      */
      __IOM uint32_t GSPI_MANUAL_WR : 1;        /*!< (@ 0x00000001) Write enable for manual mode when CS is low.               */
      __IOM uint32_t GSPI_MANUAL_RD : 1;        /*!< (@ 0x00000002) Read enable for manual mode when CS is low                 */
      __IOM uint32_t GSPI_MANUAL_RD_CNT : 10;   /*!< (@ 0x00000003) Indicates total number of bytes to be read                 */
      __IOM uint32_t GSPI_MANUAL_CSN_SELECT : 2;/*!< (@ 0x0000000D) Indicates which CSn is valid. Can be programmable
                                                                    in manual mode                                             */
      __IOM uint32_t SPI_FULL_DUPLEX_EN : 1;    /*!< (@ 0x0000000F) Full duplex mode enable                                    */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t GSPI_RD_DATA_SWAP_MNL_CSN3 : 1;/*!< (@ 0x00000007) Swap the read data inside the GSPI controller
                                                                    it-self.                                                   */
      __IOM uint32_t GSPI_MANUAL_SIZE_FRM_REG : 1;/*!< (@ 0x00000008) Manual reads and manual writes                           */
      __IOM uint32_t RESERVED1  : 1;            /*!< (@ 0x00000009) reserved for future use                                    */
      __IOM uint32_t TAKE_GSPI_MANUAL_WR_SIZE_FRM_REG : 1;/*!< (@ 0x0000000A) NONE                                             */
      __IOM uint32_t MANUAL_GSPI_MODE : 1;      /*!< (@ 0x0000000B) Internally the priority is given to manual mode            */
  ...
  union {
    ...
    struct {
      __IOM uint32_t GSPI_MANUAL_WRITE_DATA2 : 4;/*!< (@ 0x00000000) Number of bits to be written in write mode                */
      __IOM uint32_t RESERVED1  : 3;            /*!< (@ 0x00000004) reserved for future use                                    */
      __IOM uint32_t USE_PREV_LENGTH : 1;       /*!< (@ 0x00000007) Use previous length                                        */
  ...
  union {
    ...
    struct {
      __IOM uint32_t FIFO_AEMPTY_THRLD : 4;     /*!< (@ 0x00000000) FIFO almost empty threshold                                */
      __IOM uint32_t FIFO_AFULL_THRLD : 4;      /*!< (@ 0x00000004) FIFO almost full threshold                                 */
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t FIFO_FULL_WFIFO_S : 1;     /*!< (@ 0x00000001) Full status indication for Wfifo in manual mode            */
      __IM  uint32_t FIFO_AFULL_WFIFO_S : 1;    /*!< (@ 0x00000002) Almost full status indication for Wfifo in manual
                                                                    mode                                                       */
      __IM  uint32_t FIFO_EMPTY_WFIFO : 1;      /*!< (@ 0x00000003) Empty status indication for Wfifo in manual mode           */
      __IM  uint32_t RESERVED1  : 1;            /*!< (@ 0x00000004) reserved for future use                                    */
      __IM  uint32_t FIFO_FULL_RFIFO : 1;       /*!< (@ 0x00000005) Full status indication for Rfifo in manual mode            */
      __IM  uint32_t RESERVED2  : 1;            /*!< (@ 0x00000006) reserved for future use                                    */
      __IM  uint32_t FIFO_EMPTY_RFIFO_S : 1;    /*!< (@ 0x00000007) Empty status indication for Rfifo in manual mode           */
      __IM  uint32_t FIFO_AEMPTY_RFIFO_S : 1;   /*!< (@ 0x00000008) Aempty status indication for Rfifo in manual
                                                                    mode                                                       */
      __IM  uint32_t GSPI_MANUAL_RD_CNT : 1;    /*!< (@ 0x00000009) This is a result of 10 bits ORing counter                  */
      __IM  uint32_t GSPI_MANUAL_CSN : 1;       /*!< (@ 0x0000000A) Provide the status of chip select signal                   */
  ...
  union {
    ...
    struct {
      __IOM uint32_t GSPI_INTR_MASK : 1;        /*!< (@ 0x00000000) GSPI Interrupt mask bit                                    */
      __IOM uint32_t FIFO_AEMPTY_RFIFO_MASK : 1;/*!< (@ 0x00000001) NONE                                                       */
      __IOM uint32_t FIFO_AFULL_RFIFO_MASK : 1; /*!< (@ 0x00000002) NONE                                                       */
      __IOM uint32_t FIFO_AEMPTY_WFIFO_MASK : 1;/*!< (@ 0x00000003) NONE                                                       */
      __IOM uint32_t FIFO_AFULL_WFIFO_MASK : 1; /*!< (@ 0x00000004) NONE                                                       */
      __IOM uint32_t FIFO_FULL_WFIFO_MASK : 1;  /*!< (@ 0x00000005) NONE                                                       */
      __IOM uint32_t FIFO_EMPTY_RFIFO_MASK : 1; /*!< (@ 0x00000006) NONE                                                       */
  ...
  union {
    ...
    struct {
      __IOM uint32_t GSPI_INTR_UNMASK : 1;      /*!< (@ 0x00000000) GSPI Interrupt unmask bit                                  */
      __IOM uint32_t FIFO_AEMPTY_RFIFO_UNMASK : 1;/*!< (@ 0x00000001) NONE                                                     */
      __IOM uint32_t FIFO_AFULL_RFIFO_UNMASK : 1;/*!< (@ 0x00000002) NONE                                                      */
      __IOM uint32_t FIFO_AEMPTY_WFIFO_UNMASK : 1;/*!< (@ 0x00000003) NONE                                                     */
      __IOM uint32_t FIFO_AFULL_WFIFO_UNMASK : 1;/*!< (@ 0x00000004) NONE                                                      */
      __IOM uint32_t FIFO_FULL_WFIFO_UNMASK : 1;/*!< (@ 0x00000005) NONE                                                       */
      __IOM uint32_t FIFO_EMPTY_RFIFO_UNMASK : 1;/*!< (@ 0x00000006) NONE                                                      */
      __IOM uint32_t RESERVED1  : 25;           /*!< (@ 0x00000007) reserved for future use                                    */
    } GSPI_INTR_UNMASK_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t FIFO_AEMPTY_RFIFO_LVL : 1; /*!< (@ 0x00000001) NONE                                                       */
      __IM  uint32_t RESERVED1  : 2;            /*!< (@ 0x00000002) reserved for future use                                    */
      __IM  uint32_t FIFO_AFULL_WFIFO_LVL : 1;  /*!< (@ 0x00000004) NONE                                                       */
      __IM  uint32_t FIFO_FULL_WFIFO_LVL : 1;   /*!< (@ 0x00000005) NONE                                                       */
      __IM  uint32_t FIFO_EMPTY_RFIFO_LVL : 1;  /*!< (@ 0x00000006) NONE                                                       */
  ...
  union {
    ...
    struct {
      ...
      __OM  uint32_t FIFO_AEMPTY_RFIFO_ACK : 1; /*!< (@ 0x00000001) NONE                                                       */
      __OM  uint32_t RESERVED1  : 2;            /*!< (@ 0x00000002) reserved for future use                                    */
      __OM  uint32_t FIFO_AFULL_WFIFO_ACK : 1;  /*!< (@ 0x00000004) NONE                                                       */
      __OM  uint32_t FIFO_FULL_WFIFO_ACK : 1;   /*!< (@ 0x00000005) NONE                                                       */
      __OM  uint32_t FIFO_EMPTY_RFIFO_ACK : 1;  /*!< (@ 0x00000006) NONE                                                       */
  ...
  union {
    ...
    struct {
      __IM  uint32_t BUS_CTRL_PSTATE : 3;       /*!< (@ 0x00000000) Provides SPI bus controller present state                  */
...
typedef struct {                                /*!< (@ 0x47000000) SIO Structure                                              */
  ...
  union {
    ...
    struct {
      __IOM uint32_t SIO_OPERATION_ENABLE : 16; /*!< [15..0] Contains the Enables for all SIO                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t SIO_POSITION_COUNTER_DISABLE : 16;/*!< [15..0] Contains sio position counter disable for all SIOs         */
      __IM  uint32_t RESERVED3  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_PAUSE_REG_b;
  } ;
  ...
  union {
    __IOM uint32_t SIO_GPIO_INTR_EN_SET_REG;    /*!< (@ 0x00000014) GPIO Interrupt Enable Set Register                         */
    
    struct {
      __OM  uint32_t INTR_ENABLE_SET : 16;      /*!< [15..0] gpio interrupt enable set register for all SIOs                   */
      __IM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_GPIO_INTR_EN_SET_REG_b;
  } ;
  
  union {
    __OM  uint32_t SIO_GPIO_INTR_EN_CLEAR_REG;  /*!< (@ 0x00000018) GPIO Interrupt Enable Clear Register                       */
    
    struct {
      __OM  uint32_t INTR_ENABLE_CLEAR : 16;    /*!< [15..0] gpio interrupt enable Clear register for all SIOs                 */
      __OM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_GPIO_INTR_EN_CLEAR_REG_b;
  } ;
  
  union {
    __IOM uint32_t SIO_GPIO_INTR_MASK_SET_REG;  /*!< (@ 0x0000001C) GPIO Interrupt Enable Clear Register                       */
    
    struct {
      __IOM uint32_t INTR_MASK_SET : 16;        /*!< [15..0] Common gpio interrupt mask set register for all SIOs              */
      __IM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_GPIO_INTR_MASK_SET_REG_b;
  } ;
  
  union {
    __OM  uint32_t SIO_GPIO_INTR_MASK_CLEAR_REG;/*!< (@ 0x00000020) GPIO Interrupt Enable Clear Register                       */
    
    struct {
      __OM  uint32_t INTR_MASK_CLEAR : 16;      /*!< [15..0] gpio interrupt mask clear register for all SIOs                   */
      __OM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_GPIO_INTR_MASK_CLEAR_REG_b;
  } ;
  
  union {
    __IOM uint32_t SIO_GPIO_INTR_STATUS_REG;    /*!< (@ 0x00000024) GPIO Interrupt Status Register                             */
    
    struct {
      __OM  uint32_t INTR_MASK_SET : 16;        /*!< [15..0] Common gpio interrupt status register for all SIOs                */
      __IM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
  ...
  union {
    __IOM uint32_t SIO_SHIFT_COUNT_PRELOAD_REG[16];/*!< (@ 0x000000A8) Shift counter Reload Register                           */
    
    struct {
      __IOM uint32_t RELOAD_VALUE : 14;         /*!< [13..0] division factor required to generate shift clock                  */
  ...
  union {
    __IOM uint32_t SIO_DATA_POS_COUNT_REG[16];  /*!< (@ 0x000000E8) Data Position Counter Register                             */
    ...
    struct {
      ...
      __IOM uint32_t POSITION_COUNTER : 8;      /*!< [15..8] The position counter can be loaded via AHB                        */
      __IM  uint32_t RESERVED3  : 16;           /*!< [31..16] Reserved for future use                                          */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t IGNORE_FIRST_SHIFT_CONDITION : 1;/*!< [4..4] data shift condition                                         */
      ...
      __IOM uint32_t PARALLEL_MODE : 2;         /*!< [11..10] No. of bits to shift/capture at valid clk edge                   */
      __IOM uint32_t PIN_DETECTION_MODE : 2;    /*!< [13..12] Pin mode to be considered for gpio interrupt                     */
      ...
      __IOM uint32_t RESET_CLK_OUT : 1;         /*!< [15..15] When high resets the sio clock_out port. This is used
                                                     only when sio is not enabled                                              */
      __IOM uint32_t LOAD_DATA_POS_CNTR_VIA_APB : 1;/*!< [16..16] When set, data position counter can be loaded via APB        */
      __IM  uint32_t RESERVED1  : 15;           /*!< [31..17] Reserved for future use                                          */
    } SIO_CONFIG_REG_b[16];
  } ;
  
  union {
    __IOM uint32_t PATTERN_MATCH_MASK_REG_SLICE_0;/*!< (@ 0x00000168) Pattern Match Mask Register 0                            */
    
    struct {
      __IOM uint32_t MATCH_MASK_LOWER16_BITS : 32;/*!< [31..0] Enable for lower 16 bits                                        */
    } PATTERN_MATCH_MASK_REG_SLICE_0_b;
  } ;
  
  union {
    __IOM uint32_t PATTERN_MATCH_MASK_REG_slice_1;/*!< (@ 0x0000016C) Pattern Match Mask Register Slice 1                      */
  ...
  union {
    __IOM uint32_t PATTERN_MATCH_MASK_REG_SLICE_2;/*!< (@ 0x00000170) Pattern Match Mask Register Slice 2                      */
  ...
  union {
    __IOM uint32_t SIO_PATTERN_MATCH_MASK_REG_SLICE_8;/*!< (@ 0x00000188) Pattern Match Mask Register Slice 8                  */
  ...
  union {
    __IOM uint32_t SIO_PATTERN_MATCH_MASK_REG_SLICE_9;/*!< (@ 0x0000018C) Pattern Match Mask Register Slice 9                  */
  ...
  union {
    __IOM uint32_t SIO_PATTERN_MATCH_MASK_REG_SLICE_10;/*!< (@ 0x00000190) Pattern Match Mask Register Slice 10                */
  ...
  union {
    __IOM uint32_t SIO_PATTERN_MATCH_REG_SLICE_0;/*!< (@ 0x000001A8) Pattern Match Mask Register Slice 0                       */
    
    struct {
      __IOM uint32_t PATTERN_MATCH_LOWER16_BITS : 32;/*!< [31..0] Lower 16-bits of pattern to be detected                      */
    } SIO_PATTERN_MATCH_REG_SLICE_0_b;
  } ;
  
  union {
    __IOM uint32_t SIO_PATTERN_MATCH_REG_SLICE_1;/*!< (@ 0x000001AC) Pattern Match Mask Register Slice 1                       */
  ...
  union {
    __IOM uint32_t SIO_PATTERN_MATCH_REG_SLICE_2;/*!< (@ 0x000001B0) Pattern Match Mask Register Slice 2                       */
  ...
  union {
    __IOM uint32_t SIO_PATTERN_MATCH_REG_SLICE_8;/*!< (@ 0x000001C8) Pattern Match Mask Register Slice 8                       */
  ...
  union {
    __IOM uint32_t SIO_PATTERN_MATCH_REG_SLICE_9;/*!< (@ 0x000001CC) Pattern Match Mask Register Slice 9                       */
  ...
  union {
    __IOM uint32_t SIO_PATTERN_MATCH_REG_SLICE_10;/*!< (@ 0x000001D0) Pattern Match Mask Register Slice 10                     */
  ...
  union {
    __IOM uint32_t SIO_SHIFT_INTR_EN_SET_REG;   /*!< (@ 0x000001F0) Shift Interrupt Enable Set Register                        */
    
    struct {
      __IOM uint32_t INTR_ENABLE_SET : 16;      /*!< [15..0] Common shift interrupt enable set register for all SIOs           */
      __IM  uint32_t RESERVED3  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_SHIFT_INTR_EN_SET_REG_b;
  } ;
  
  union {
    __OM  uint32_t SIO_SHIFT_INTR_EN_CLEAR_REG; /*!< (@ 0x000001F4) Shift Interrupt Enable Clear Register                      */
  ...
  union {
    __IOM uint32_t SIO_SHIFT_INTR_MASK_SET_REG; /*!< (@ 0x000001F8) Shift Interrupt Mask Set Register                          */
    
    struct {
      __IOM uint32_t INTR_MASK_SET : 16;        /*!< [15..0] Common shift interrupt enable Set register for all SIOs           */
      __IM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_SHIFT_INTR_MASK_SET_REG_b;
  } ;
  
  union {
    __OM  uint32_t SIO_SHIFT_INTR_MASK_CLEAR_REG;/*!< (@ 0x000001FC) Shift Interrupt Mask Clear Register                       */
    
    struct {
      __OM  uint32_t INTR_MASK_CLEAR : 16;      /*!< [15..0] Common shift interrupt mask clear register for all SIOs           */
      __OM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_SHIFT_INTR_MASK_CLEAR_REG_b;
  } ;
  
  union {
    __IOM uint32_t SIO_SHIFT_INTR_STATUS_REG;   /*!< (@ 0x00000200) Shift Interrupt Status Register                            */
    
    struct {
      __IOM uint32_t INTR_ENABLE_SET : 16;      /*!< [15..0] Common shift interrupt mask clear register for all SIOs           */
      __IM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_SHIFT_INTR_STATUS_REG_b;
  } ;
  
  union {
    __IOM uint32_t SIO_SWAP_INTR_EN_SET_REG;    /*!< (@ 0x00000204) Swap Interrupt Enable Set Register                         */
    
    struct {
      __IOM uint32_t INTR_ENABLE_SET : 16;      /*!< [15..0] Swap interrupt enable set register for all SIOs                   */
      __IM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_SWAP_INTR_EN_SET_REG_b;
  } ;
  
  union {
    __OM  uint32_t SIO_SWAP_INTR_EN_CLEAR_REG;  /*!< (@ 0x00000208) Swap Interrupt Enable Clear Register                       */
    
    struct {
      __OM  uint32_t INTR_ENABLE_CLEAR : 16;    /*!< [15..0] Swap interrupt enable Clear register for all SIOs                 */
      __OM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_SWAP_INTR_EN_CLEAR_REG_b;
  } ;
  
  union {
    __IOM uint32_t SIO_SWAP_INTR_MASK_SET_REG;  /*!< (@ 0x0000020C) Swap Interrupt Mask Set Register                           */
    
    struct {
      __IOM uint32_t INTR_MASK_SET : 16;        /*!< [15..0] Common swap interrupt mask set register for all SIOs              */
      __IM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_SWAP_INTR_MASK_SET_REG_b;
  } ;
  
  union {
    __OM  uint32_t SIO_SWAP_INTR_MASK_CLEAR_REG;/*!< (@ 0x00000210) Swap Interrupt Mask Clear Register                         */
    
    struct {
      __OM  uint32_t INTR_MASK_CLEAR : 16;      /*!< [15..0] Common swap interrupt mask Clear register for all SIOs            */
      __OM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_SWAP_INTR_MASK_CLEAR_REG_b;
  } ;
  
  union {
    __IOM uint32_t SIO_SWAP_INTR_STATUS_REG;    /*!< (@ 0x00000214) Swap Interrupt Statusr Register                            */
    
    struct {
      __IOM uint32_t INTR_ENABLE_SET : 16;      /*!< [15..0] Common swap interrupt status register for all SIOs                */
      __IM  uint32_t RESERVED1  : 16;           /*!< [31..16] Reserved for future use                                          */
    } SIO_SWAP_INTR_STATUS_REG_b;
  } ;
  
  union {
    __IOM uint32_t SIO_PATTERN_MATCH_INTR_EN_SET_REG;/*!< (@ 0x00000218) Pattern Match Interrupt Enable Set Register           */
  ...
  union {
    __OM  uint32_t SIO_PATTERN_MATCH_INTR_EN_CLEAR_REG;/*!< (@ 0x0000021C) Pattern Match Interrupt Enable Clear Register       */
  ...
  union {
    __IOM uint32_t SIO_PATTERN_MATCH_INTR_MASK_SET_REG;/*!< (@ 0x00000220) Pattern Match Interrupt Mask Set Register           */
  ...
  union {
    __OM  uint32_t SIO_PATTERN_MATCH_INTR_MASK_CLEAR_REG;/*!< (@ 0x00000224) Pattern Match Interrupt Mask Clear Register       */
  ...
  union {
    __IOM uint32_t SIO_PATTERN_MATCH_INTR_STATUS_REG;/*!< (@ 0x00000228) Pattern Match Interrupt Status Register               */
  ...
  union {
    __IOM uint32_t SIO_BUFFER_INTR_STATUS_REG;  /*!< (@ 0x0000022C) Buffer Interrupt Status Register                           */
  ...
  union {
    __IOM uint32_t SIO_FIFO_WR_OFFSET_START_REG;/*!< (@ 0x000002B4) Points to start slice number forming the FIFO              */
  ...
  union {
    __IOM uint32_t SIO_FIFO_WR_OFFSET_END_REG;  /*!< (@ 0x000002B8) SIO last slice no indication Register                      */
    
    struct {
      __IOM uint32_t SIO_END_SLICE_NUMBER : 32; /*!< [31..0] points to last slice no forming fifo                              */
    } SIO_FIFO_WR_OFFSET_END_REG_b;
  } ;
  
  union {
    __IOM uint32_t SIO_FIFO_WR_OFFSET_CNT_REG;  /*!< (@ 0x000002BC) Points to current slice number forming the FIFO            */
  ...
  union {
    __IOM uint32_t SIO_FIFO_RD_OFFSET_START_REG;/*!< (@ 0x000002C0) Points to start slice number forming the FIFO              */
    
    struct {
      __IOM uint32_t SIO_START_SLICE_NUMBER : 32;/*!< [31..0] Points to start slice number forming the FIFO                    */
    } SIO_FIFO_RD_OFFSET_START_REG_b;
  } ;
  
  union {
    __IOM uint32_t SIO_FIFO_RD_OFFSET_END_REG;  /*!< (@ 0x000002C4) Points to last slice number forming the FIFO               */
    
    struct {
      __IOM uint32_t SIO_END_SLICE_NUMBER : 32; /*!< [31..0] Points to last slice number forming the FIFO                      */
    } SIO_FIFO_RD_OFFSET_END_REG_b;
  } ;
  
  union {
    __IOM uint32_t SIO_FIFO_RD_OFFSET_CNT_REG;  /*!< (@ 0x000002C8) Points to start current number forming the FIFO            */
...
typedef struct {                                    /*!< QSPI Structure                                                        */
	...
	union {
		...
		struct {
			__IO uint32_t  QSPI_9116_FEATURE_EN:  1;      /*!< 9115 specific features are enabled with this enable                   */
			...
			__IO uint32_t  QSPI_WRAP_EN:  1;              /*!< Model wrap is considered with this bit and uses wrap instruction
                                                         to read from FLASH                                                    */
			__IO uint32_t  QSPI_AUTO_MODE_FRM_REG:  1;    /*!< QSPI Mode of Operation                                                */
			uint32_t             :  1;
			...
			__IO uint32_t  QSPI_D3_DATA_CSN1:  1;         /*!< Value of SPI_IO3 in case of dual/single mode for chip select1
                                                         csn1                                                                  */
			__IO uint32_t  QSPI_DATA_SAMPLE_EDGE:  1;     /*!< Samples MISO data on clock edges                                      */
			__IO uint32_t  QSPI_CLK_MODE_CSN0:  1;        /*!< QSPI Clock Mode                                                       */
			__IO uint32_t  QSPI_CLK_MODE_CSN1:  1;        /*!< QSPI Clock Mode                                                       */
			__IO uint32_t  QSPI_CLK_MODE_CSN2:  1;        /*!< QSPI Clock Mode                                                       */
			__IO uint32_t  QSPI_CLK_MODE_CSN3:  1;        /*!< QSPI Clock Mode                                                       */
			uint32_t             :  3;
	...
	union {
		...
		struct {
			__IO uint32_t  QSPI_EXT_BYTE_MODE_CSN0:  2;   /*!< Mode of operation of QSPI in the extra byte phase                     */
			__IO uint32_t  QSPI_DUMMY_MODE_CSN0:  2;      /*!< Mode of operation of QSPI in instruction phase                        */
			__IO uint32_t  QSPI_ADDR_MODE_CSN0:  2;       /*!< Mode of operation of QSPI in instruction phase                        */
			__IO uint32_t  QSPI_CMD_MODE_CSN0:  2;        /*!< Mode of operation of QSPI in instruction phase                        */
			__IO uint32_t  QSPI_DATA_MODE_CSN0:  2;       /*!< Mode of operation of QSPI in DATA phase                               */
	...
	union {
		...
		struct {
			__IO uint32_t  QSPI_RD_DATA_SWAP_AUTO_CSN0:  1;/*!< NONE                                                                 */
			__IO uint32_t  QSPI_ADR_SIZE_16_BIT_AUTO_MODE_CSN0:  1;/*!< NONE                                                         */
			__IO uint32_t  QSPI_CONTI_RD_EN_CSN0:  1;     /*!< NONE                                                                  */
			__IO uint32_t  DUMMY_BYTES_WR_RD_CSN0:  1;    /*!< Dummy bytes to the model to be read or to be write                    */
			__IO uint32_t  QSPI_DUMMY_BYTES_JMP_CSN:  4;  /*!< Dummy cycles to be selected in case of JUMP                           */
			...
			__IO uint32_t  QSPI_RD_WRAP_INT_CSN0:  8;     /*!< Read instruction to be used, when wrap mode is supported by
                                                         QSPI flash                                                            */
			__IO uint32_t  QSPI_PG_JUMP_INST_CSN0:  8;    /*!< Read instruction to be used, when Page jump is to be used             */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  QSPI_MANUAL_CSN_SELECT:  2;    /*!< Indicates which CSn is valid                                          */
			uint32_t             :  4;
			__IO uint32_t  QSPI_MANUAL_SIZE_FRM_REG:  2;  /*!< Manual reads and manual writes follow this size                       */
			__IO uint32_t  TAKE_QSPI_MANUAL_WR_SIZE_FRM_REG:  1;/*!< NONE                                                            */
			__IO uint32_t  QSPI_FULL_DUPLEX_EN:  1;       /*!< Full duplex mode enable.                                              */
			uint32_t             :  2;
			__IO uint32_t  HW_CTRLD_QSPI_MODE_CTRL:  1;   /*!< Hardware controlled qspi mode in between AUTO and manual              */
			__IO uint32_t  QSPI_MANUAL_QSPI_MODE:  1;     /*!< Internally the priority is given to manual mode                       */
	...
	union {
		...
		struct {
			__IO uint32_t  QSPI_WR_DATA_SWAP_MNL_CSN0:  1;/*!< Swap the write data inside the QSPI controller it-self                */
			__IO uint32_t  QSPI_WR_DATA_SWAP_MNL_CSN1:  1;/*!< Swap the write data inside the QSPI controller it-self.               */
			__IO uint32_t  QSPI_WR_DATA_SWAP_MNL_CSN2:  1;/*!< Swap the write data inside the QSPI controller itself.                */
			__IO uint32_t  QSPI_WR_DATA_SWAP_MNL_CSN3:  1;/*!< Swap the write data inside the QSPI controller itself.                */
			__IO uint32_t  QSPI_RD_DATA_SWAP_MNL_CSN0:  1;/*!< Swap the read data inside the QSPIcontroller it self.                 */
			__IO uint32_t  QSPI_RD_DATA_SWAP_MNL_CSN1:  1;/*!< Swap the read data inside the QSPIcontroller itself.                  */
			__IO uint32_t  QSPI_RD_DATA_SWAP_MNL_CSN2:  1;/*!< Swap the read data inside the QSPIcontroller it-self                  */
			__IO uint32_t  QSPI_RD_DATA_SWAP_MNL_CSN3:  1;/*!< Swap the read data inside the QSPIcontroller itself                   */
			...
			__IO uint32_t  QSPI_MAN_MODE_CONF_CSN2:  2;   /*!< Configures the QSPI flash for Single or Dual or Quad mode operation
                                                         in manual mode for chip select2 csn2                                  */
			__IO uint32_t  QSPI_MAN_MODE_CONF_CSN3:  2;   /*!< Configures the QSPI flash for Single or Dual or Quad mode operation
                                                         in manual mode for chip select3 csn3                                  */
			__IO uint32_t  LOOP_BACK_EN:  1;              /*!< Internal loop back test mode.                                         */
			__IO uint32_t  QSPI_MANUAL_DDR_PHASE:  1;     /*!< DDR operations can be performed even in manual mode                   */
	...
	union {
		...
		struct {
			...
			__I  uint32_t  FIFO_AEMPTY_RFIFO_S:  1;       /*!< Status indication for Rfifo in manual mode                            */
			__I  uint32_t  GSPI_MANUAL_RD_CNT:  1;        /*!< This is a result of 10 bits ORing counter                             */
			__I  uint32_t  AUTO_MODE_FSM_IDLE_SCLK:  1;   /*!< Auto mode idle signal to track auto controller is busy or idle.       */
			...
			__I  uint32_t  HW_CTRLD_MODE_CTRL_SCLK:  1;   /*!< HW_CTRLD_MODE status                                                  */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  FIFO_AEMPTY_RFIFO_MASK:  1;    /*!< NONE                                                                  */
			__IO uint32_t  FIFO_AFULL_RFIFO_MASK:  1;     /*!< NONE                                                                  */
			__IO uint32_t  FIFO_AEMPTY_WFIFO_MASK:  1;    /*!< NONE                                                                  */
			__IO uint32_t  FIFO_AFULL_WFIFO_MASK:  1;     /*!< NONE                                                                  */
			__IO uint32_t  FIFO_FULL_WFIFO_MASK:  1;      /*!< NONE                                                                  */
			__IO uint32_t  FIFO_EMPTY_RFIFO_MASK:  1;     /*!< NONE                                                                  */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  FIFO_AEMPTY_RFIFO_UN:  1;      /*!< NONE                                                                  */
			__IO uint32_t  FIFO_AFULL_RFIFO_UNMASK:  1;   /*!< NONE                                                                  */
			__IO uint32_t  FIFO_AEMPTY_WFIFO_UNMASK:  1;  /*!< NONE                                                                  */
			__IO uint32_t  FIFO_AFULL_WFIFO_UNMASK:  1;   /*!< NONE                                                                  */
			__IO uint32_t  FIFO_FULL_WFIFO_UNMASK:  1;    /*!< NONE                                                                  */
			__IO uint32_t  FIFO_EMPTY_RFIFO_UNMASK:  1;   /*!< NONE                                                                  */
	...
	union {
		...
		struct {
			...
			__I  uint32_t  FIFO_AEMPTY_RFIFO_LVL:  1;     /*!< NONE                                                                  */
			__I  uint32_t  FIFO_AFULL_RFIFO_LVL:  1;      /*!< NONE                                                                  */
			__I  uint32_t  FIFO_AEMPTY_WFIFO_LVL:  1;     /*!< NONE                                                                  */
			__I  uint32_t  FIFO_AFULL_WFIFO_LVL:  1;      /*!< NONE                                                                  */
			__I  uint32_t  FIFO_FULL_WFIFO_LVL:  1;       /*!< NONE                                                                  */
			__I  uint32_t  FIFO_EMPTY_RFIFO_LVL:  1;      /*!< NONE                                                                  */
	...
	union {
		...
		struct {
			...
			__O  uint32_t  FIFO_AEMPTY_RFIFO_ACK:  1;     /*!< NONE                                                                  */
			__O  uint32_t  FIFO_AFULL_RFIFO_ACK:  1;      /*!< NONE                                                                  */
			__O  uint32_t  FIFO_AEMPTY_WFIFO_ACK:  1;     /*!< NONE                                                                  */
			__O  uint32_t  FIFO_AFULL_WFIFO_ACK:  1;      /*!< NONE                                                                  */
			__O  uint32_t  FIFO_FULL_WFIFO_ACK:  1;       /*!< NONE                                                                  */
			__O  uint32_t  FIFO_EMPTY_RFIFO_ACK:  1;      /*!< NONE                                                                  */
	...
	union {
		...
		struct {
			__IO uint32_t  QSPI_EXT_BYTE_MODE_CSN1:  2;   /*!< Mode of operation of QSPI in instruction phase.                       */
			__IO uint32_t  QSPI_DUMMY_MODE_CSN1:  2;      /*!< Mode of operation of QSPI in instruction phase                        */
			__IO uint32_t  QSPI_ADDR_MODE_CSN1:  2;       /*!< Mode of operation of QSPI in instruction phase.                       */
			__IO uint32_t  QSPI_CMD_MODE_CSN1:  2;        /*!< Mode of operation of QSPI in instruction phase.                       */
			__IO uint32_t  QSPI_DATA_MODE_CSN1:  2;       /*!< Mode of operation of QSPI in DATA phase.                              */
			__I  uint32_t  QSPI_EXTRA_BYTE_CSN1:  8;      /*!< Value of the extra byte to be transmitted, if the extra byte
                                                         mode is enabled.                                                      */
			__IO uint32_t  QSPI_EXTRA_BYTE_EN_CSN1:  2;   /*!< Mode of operation of QSPI in DATA phase.                              */
			uint32_t             :  3;
	...
	union {
		__IO uint32_t  QSPI_AUTO_CONFIG_2_CSN1_REG;     /*!< QSPI Auto Controller Configuration 2 CSN1 Register                    */

		struct {
			__IO uint32_t  QSPI_RD_SWAP_AUTO_CSN1:  1;    /*!< Swap the read data from the flash in byte order for chip select1
                                                         csn1 in auto mode.                                                    */
			__IO uint32_t  QSPI_ADR_SIZE_16BIT_AUTO_MODE_CSN1:  1;/*!< NONE                                                          */
			__IO uint32_t  QSPI_CONTI_RD_EN_CSN1:  1;     /*!< Continuous read enable bit.                                           */
			__IO uint32_t  DUMMY_BYTES_WR_RD:  1;         /*!< Dummy bytes to the model to be read or to be write.                   */
			__IO uint32_t  QSPI_DUMMY_BYTES_JMP_CSN1:  4; /*!< Dummy cycles to be selected in case of JUMP                           */
			...
			__IO uint32_t  QSPI_RD_WRAP_INST_CSN1:  8;    /*!< Read instruction to be used for the selected SPI modes and when
                                                         wrap is not needed or supported                                       */
			__IO uint32_t  QSPI_PG_JMP_INST_CSN1:  8;     /*!< Read instruction to be used, when Page jump is to be used.            */
	...
	union {
		...
		struct {
			__IO uint32_t  QSPI_MANUAL_WRITE_DATA2:  5;   /*!< Number of bits to be written in write mode                            */
			uint32_t             :  2;
	...
	union {
		...
		struct {
			__IO uint32_t  QSPI_EXT_BYTE_MODE_CSN2:  2;   /*!< Mode of operation of QSPI in instruction phase.                       */
			__IO uint32_t  QSPI_DUMMY_MODE_CSN2:  2;      /*!< Mode of operation of QSPI in instruction phase                        */
			__IO uint32_t  QSPI_ADDR_MODE_CSN2:  2;       /*!< Mode of operation of QSPI in instruction phase.                       */
			__IO uint32_t  QSPI_CMD_MODE_CSN2:  2;        /*!< Mode of operation of QSPI in instruction phase.                       */
			__IO uint32_t  QSPI_DATA_MODE_CSN2:  2;       /*!< Mode of operation of QSPI in DATA phase.                              */
			__I  uint32_t  QSPI_EXTRA_BYTE_CSN2:  8;      /*!< Value of the extra byte to be transmitted, if the extra byte
                                                         mode is enabled.                                                      */
			__IO uint32_t  QSPI_EXTRA_BYTE_EN_CSN2:  2;   /*!< Mode of operation of QSPI in DATA phase.                              */
			uint32_t             :  3;
	...
	union {
		__IO uint32_t  QSPI_AUTO_CONFIG_2_CSN2_REG;     /*!< QSPI Auto Controller Configuration 2 CSN2 Register                    */

		struct {
			__IO uint32_t  QSPI_RD_SWAP_AUTO_CSN2:  1;    /*!< Swap the read data from the flash in byte order for chip select1
                                                         csn1 in auto mode.                                                    */
			__IO uint32_t  QSPI_ADR_SIZE_16BIT_AUTO_MODE_CSN2:  1;/*!< NONE                                                          */
			__IO uint32_t  QSPI_CONTI_RD_EN_CSN2:  1;     /*!< Continuous read enable bit.                                           */
			__IO uint32_t  DUMMY_BYTES_WR_RD_CSN2:  1;    /*!< Dummy bytes to the model to be read or to be write.                   */
			__IO uint32_t  QSPI_DUMMY_BYTES_JMP_CSN2:  4; /*!< Dummy cycles to be selected in case of JUMP                           */
			...
			__IO uint32_t  QSPI_RD_WRAP_INST_CSN2:  8;    /*!< Read instruction to be used for the selected SPI modes and when
                                                         wrap is not needed or supported                                       */
			__IO uint32_t  QSPI_PG_JMP_INST_CSN2:  8;     /*!< Read instruction to be used, when Page jump is to be used.            */
	...
	union {
		...
		struct {
			__IO uint32_t  QSPI_EXT_BYTE_MODE_CSN3:  2;   /*!< Mode of operation of QSPI in instruction phase.                       */
			__IO uint32_t  QSPI_DUMMY_MODE_CSN3:  2;      /*!< Mode of operation of QSPI in instruction phase                        */
			__IO uint32_t  QSPI_ADDR_MODE_CSN3:  2;       /*!< Mode of operation of QSPI in instruction phase.                       */
			__IO uint32_t  QSPI_CMD_MODE_CSN3:  2;        /*!< Mode of operation of QSPI in instruction phase.                       */
			__IO uint32_t  QSPI_DATA_MODE_CSN3:  2;       /*!< Mode of operation of QSPI in DATA phase.                              */
			__I  uint32_t  QSPI_EXTRA_BYTE_CSN3:  8;      /*!< Value of the extra byte to be transmitted, if the extra byte
                                                         mode is enabled.                                                      */
			__IO uint32_t  QSPI_EXTRA_BYTE_EN_CSN3:  2;   /*!< Mode of operation of QSPI in DATA phase.                              */
			uint32_t             :  3;
	...
	union {
		__IO uint32_t  QSPI_AUTO_CONFIG_2_CSN3_REG;     /*!< QSPI Auto Controller Configuration 2 CSN3 Register                    */

		struct {
			__IO uint32_t  QSPI_RD_SWAP_AUTO_CSN3:  1;    /*!< Swap the read data from the flash in byte order for chip select1
                                                         csn1 in auto mode.                                                    */
			__IO uint32_t  QSPI_ADR_SIZE_16BIT_AUTO_MODE_CSN3:  1;/*!< NONE                                                          */
			__IO uint32_t  QSPI_CONTI_RD_EN_CSN3:  1;     /*!< Continuous read enable bit.                                           */
			__IO uint32_t  DUMMY_BYTES_WR_RD_CSN3:  1;    /*!< Dummy bytes to the model to be read or to be write.                   */
			__IO uint32_t  QSPI_DUMMY_BYTES_JMP_CSN3:  4; /*!< Dummy cycles to be selected in case of JUMP                           */
			...
			__IO uint32_t  QSPI_RD_WRAP_INST_CSN3:  8;    /*!< Read instruction to be used for the selected SPI modes and when
                                                         wrap is not needed or supported                                       */
			__IO uint32_t  QSPI_PG_JMP_INST_CSN3:  8;     /*!< Read instruction to be used, when Page jump is to be used.            */
		} QSPI_AUTO_CONFIG_2_CSN3_REG_b;                /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  QSPI_AUTO_CONFIG_3_CSN0_REG;     /*!< QSPI Auto Controller Configuration 3 CSN0 Register                    */

		struct {
			uint32_t             : 12;
			__IO uint32_t  QSPI_DDR_CMD_MODE_CSN0:  1;    /*!< DDR Command mode                                                      */
			__IO uint32_t  QSPI_DDR_ADDR_MODE_CSN0:  1;   /*!< DDR Address mode                                                      */
			__IO uint32_t  QSPI_DDR_DUMMY_MODE_CSN0:  1;  /*!< DDR Address mode                                                      */
			__IO uint32_t  QSPI_DDR_EXTRA_MODE_CSN0:  1;  /*!< DDR Address mode                                                      */
			__IO uint32_t  QSPI_DDR_DATA_MODE_CSN0:  1;   /*!< DDR Address mode                                                      */
		} QSPI_AUTO_CONFIG_3_CSN0_REG_b;                /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  QSPI_AUTO_CONFIG_3_CSN1_REG;     /*!< QSPI Auto Controller Configuration 3 CSN1 Register                    */

		struct {
			uint32_t             : 12;
			__IO uint32_t  QSPI_DDR_CMD_MODE_CSN1:  1;    /*!< DDR Command mode                                                      */
			__IO uint32_t  QSPI_DDR_ADDR_MODE_CSN1:  1;   /*!< DDR Address mode                                                      */
			__IO uint32_t  QSPI_DDR_DUMMY_MODE_CSN1:  1;  /*!< DDR Address mode                                                      */
			__IO uint32_t  QSPI_DDR_EXTRA_MODE_CSN1:  1;  /*!< DDR Address mode                                                      */
			__IO uint32_t  QSPI_DDR_DATA_MODE_CSN1:  1;   /*!< DDR Address mode                                                      */
		} QSPI_AUTO_CONFIG_3_CSN1_REG_b;                /*!< BitSize                                                               */
	};
	__I  uint32_t  RESERVED[11];

	union {
		__IO uint32_t  OCTASPI_BUS_CONTROLLER_2_REG;    /*!< none                                                                  */
		...
		struct {
			...
			__IO uint32_t  AES_SEC_ENABLE_SG4:  1;        /*!< This bit enables the AES security enable or not for segment
                                                         4                                                                     */
			__IO uint32_t  DUAL_MODE_SWAP_LINES:  1;      /*!< This bit controls the 8 lines of qspi with 4 bit swap manner          */
			uint32_t             :  2;
			__IO uint32_t  DUAL_STAGE_EN_MANUAL:  1;      /*!< Dual stage en for dual flash mode                                     */
		} OCTASPI_BUS_CONTROLLER_2_REG_b;               /*!< BitSize                                                               */
	};
	__I  uint32_t  RESERVED1[15];

	union {
		__IO uint32_t  QSPI_SRAM_CTRL_CSN_REG[4];       /*!< none                                                                  */
	...
	union {
		__IO uint32_t  SEMI_AUTO_MODE_CONFIG_REG;       /*!< none                                                                  */

		struct {
			__IO uint32_t  QSPI_SEMI_AUTO_BSIZE:  8;      /*!< This is burst size to read data from flash in semi auto mode          */
			__IO uint32_t  QSPI_SEMI_AUTO_HSIZE:  2;      /*!< Indicates number of bytes valid in each transaction                   */
		} SEMI_AUTO_MODE_CONFIG_REG_b;                  /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  SEMI_AUTO_MODE_CONFIG2_REG;      /*!< none                                                                  */
...
typedef struct {                                /*!< (@ 0x45080000) CRC Structure                                              */
  ...
  union {
    __IOM uint32_t CRC_GEN_CTRL_SET_REG;        /*!< (@ 0x00000000) General control set register                               */
  ...
  union {
    __IOM uint32_t CRC_POLYNOMIAL_CTRL_SET;     /*!< (@ 0x00000010) Polynomial control set register                            */
  ...
  union {
    __IOM uint32_t CRC_POLYNOMIAL_CTRL_RESET;   /*!< (@ 0x00000014) Polynomial control set register                            */
  ...
  union {
    __IOM uint32_t CRC_LFSR_INIT_CTRL_SET;      /*!< (@ 0x0000001C) LFSR state initialization control set register             */
  ...
  union {
    __IOM uint32_t CRC_LFSR_INIT_CTRL_RESET;    /*!< (@ 0x00000020) LFSR state initialization control reset register           */
  ...
  union {
    __IOM uint32_t CRC_DIN_CTRL_RESET_REG;      /*!< (@ 0x0000002C) Input data control set register                            */
  ...
  union {
    ...
    struct {
      __IOM uint32_t DIN_NUM_BYTES : 32;        /*!< (@ 0x00000000) in out data number of bytes                                */
    } CRC_DIN_NUM_BYTES_b;
  } ;
...
typedef struct {                                /*!< (@ 0x4600C000) EFUSE Structure                                            */
  ...
  union {
    __IOM uint32_t EFUSE_DA_CTRL_SET_REG;       /*!< (@ 0x00000004) Direct Access Set Registers                                */
  ...
  union {
    __IOM uint32_t EFUSE_DA_CTRL_CLEAR_REG;     /*!< (@ 0x00000008) Direct Access Clear Registers                              */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t EFUSE_DIRECT_PATH_ENABLE : 1;/*!< (@ 0x00000001) This bit specifies whether the EFUSE direct path
                                                                    ...
                                                                    of the EFUSE pins                                          */
      __IOM uint32_t ENABLE_EFUSE_WRITE : 1;    /*!< (@ 0x00000002) Controls the switch on VDDIQ for eFuse read/write.         */
  ...
  union {
    ...
    struct {
      __IOM uint32_t EFUSE_MEM_MAP_LEN : 1;     /*!< (@ 0x00000000) 0: 8 bit read 1: 16 bit read                               */
      __IM  uint32_t RESERVED1  : 15;           /*!< (@ 0x00000001) reserved1                                                  */
      __IM  uint32_t RESERVED2  : 16;           /*!< (@ 0x00000010) reserved2                                                  */
  ...
  union {
    __IOM uint32_t EFUSE_READ_BLOCK_STARTING_LOCATION;/*!< (@ 0x00000028) Starting address from which the read has to be
                                                                    blocked. Once the end address is written,
                                                                    it cannot be changed till power on reset
                                                                    is given                                                   */
    
    struct {
      __IOM uint32_t EFUSE_READ_BLOCK_STARTING_LOCATION : 16;/*!< (@ 0x00000000) Starting address from which the read has to be
                                                                    blocked. Once the end address is written,
                                                                    it cannot be changed till power on reset
                                                                    is given.                                                  */
      __IM  uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reserved1                                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t EFUSE_READ_BLOCK_END_LOCATION : 16;/*!< (@ 0x00000000) End address till which the read has to be blocked.
  ...
  union {
    ...
    struct {
      __IOM uint32_t efuse_read_block_enable : 1;/*!< (@ 0x00000000) Enable for blocking the read access from a programmable
                                                                    memory location                                            */
      __IM  uint32_t RESERVED1  : 15;           /*!< (@ 0x00000001) reserved1                                                  */
      __IM  uint32_t RESERVED2  : 16;           /*!< (@ 0x00000010) reserved2                                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t EFUSE_STROBE_CLR_CNT : 9;  /*!< (@ 0x00000000) Strobe signal Clear count in direct access mode.
                                                                    ...
                                                                    eFuse controller                                           */
      __IOM uint32_t EFUSE_STROBE_ENABLE : 1;   /*!< (@ 0x00000009) none                                                       */
...
typedef struct {                                /*!< (@ 0x46170000) CCI Structure                                              */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t ENABLED_SLAVES : 3;        /*!< (@ 0x00000002) Indicates Slaves enable.                                   */
      ...
      __IOM uint32_t ADDR_WIDTH_CONFIG : 2;     /*!< (@ 0x00000006) address width configuration of AHB slave during
                                                                    address phase                                              */
      __IOM uint32_t TRANSLATE_ENABLE : 1;      /*!< (@ 0x00000008) translation enable                                         */
      ...
      __IOM uint32_t SLAVE_PRIORITY : 3;        /*!< (@ 0x0000000D) This bits will represents priority of the slaves           */
      __IOM uint32_t TIME_OUT_PRG : 10;         /*!< (@ 0x00000010) configurable time out value for slave response.            */
      __IOM uint32_t RESERVED2  : 3;            /*!< (@ 0x0000001A) reserved2                                                  */
      __IOM uint32_t DISABLE_TIME_OUT_FOR_DATA_ACCESS : 1;/*!< (@ 0x0000001D) configurable time out value for slave response.  */
      __IOM uint32_t SELECT_TIME_OUT_INTR_OR_MSG_INTR : 1;/*!< (@ 0x0000001E) configurable time out value for slave response.  */
      __IOM uint32_t CCI_CTRL_ENABLE : 1;       /*!< (@ 0x0000001F) configurable time out value for slave response.            */
    } CCI_CONTROL_b;
  } ;
  ...
  union {
    __IOM uint32_t CCI_MODE_INTR_STATUS;        /*!< (@ 0x00000028) Interrupt Status                                           */
  ...
  union {
    __IOM uint32_t CCI_FIFO_THRESHOLD_REG;      /*!< (@ 0x00000200) CCI fifo threshold                                         */
    
    struct {
      __IOM uint32_t FIFO_AFULL_THRESHOLD : 5;  /*!< (@ 0x00000000) ALMOST full threshold                                      */
      __IOM uint32_t FIFO_AEMPTY_THRESHOLD : 5; /*!< (@ 0x00000005) ALMOST empty threshold                                     */
      __IOM uint32_t RESERVED1  : 22;           /*!< (@ 0x0000000A) RESERVED1                                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t TRANSLATION_ADDRESS_VALID : 1;/*!< (@ 0x00000000) Translation is enabled or not                           */
      __IOM uint32_t TRANSLATION_ADDRESS : 31;  /*!< (@ 0x00000001) Address offset for translation address                     */
    } CCI_TRANS_ADDRESS_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t CCI_PREFETCH_EN : 1;       /*!< (@ 0x00000000) cci pre-fetch enables on AHB read operation.               */
      __IOM uint32_t CCI_2X_CLK_ENABLE_FOR_DDR_MODE : 1;/*!< (@ 0x00000001) It is an enable for CCI 2x clock in DDR mode       */
      __IOM uint32_t RESERVED1  : 30;           /*!< (@ 0x00000002) Reserved1                                                  */
    } CCI_PREFETCH_CTRL_b;
  } ;
...
typedef struct {                                /*!< (@ 0x47050000) I2S0 Structure                                             */
  ...
  union {
    ...
    struct {
      __IM  uint32_t APB_DATA_WIDTH : 2;        /*!< (@ 0x00000000) Width of APB data bus                                      */
      __IM  uint32_t I2S_FIFO_DEPTH_GLOBAL : 2; /*!< (@ 0x00000002) Determines FIFO depth for all channels                     */
      __IM  uint32_t I2S_FIFO_MODE_EN : 1;      /*!< (@ 0x00000004) Determines whether component act as Master or
                                                                    Slave                                                      */
      __IM  uint32_t I2S_TRANSMITTER_BLOCK : 1; /*!< (@ 0x00000005) Shows the presence of the transmitter block                */
      __IM  uint32_t I2S_RECEIVER_BLOCK : 1;    /*!< (@ 0x00000006) Shows the presence of the receiver block                   */
      __IM  uint32_t I2S_RX_CHANNELS : 2;       /*!< (@ 0x00000007) Returns the number of receiver channels                    */
      __IM  uint32_t I2S_TX_CHANNELS : 2;       /*!< (@ 0x00000009) Returns the number of transmitter channels                 */
  ...
  union {
    ...
    struct {
      __IM  uint32_t I2S_COMP_VERSION : 32;     /*!< (@ 0x00000000) Return the component version(1.02)                         */
  ...
  union {
    ...
    struct {
      __IM  uint32_t I2S_COMP_TYPE : 32;        /*!< (@ 0x00000000) Return the component type                                  */
    } I2S_COMP_TYPE_REG_b;
  } ;
} I2S0_Type; 
/* ================================================================================ */
...
typedef struct {                                    /*!< IID_RPINE Structure                                                   */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  WKE_KEY_FEED_IN_PROGRESS:  1;  /*!< Will be high when WKE is feeding key to AES engine                    */
			__IO uint32_t  WKE_FLUSH_IN_PROGRESS:  1;     /*!< Will be high when WKE flushing out the data from AES                  */
			__IO uint32_t  WKE_COMPARE_IN_PROGRESS:  1;   /*!< Will be high when WKE is comparing the data from AES                  */
			__IO uint32_t  WKE_SET_KEY_IN_PROGRESS:  1;   /*!< Will be high when WKE is doing set key operation with QK              */
...
typedef struct {                                /*!< (@ 0x45060000) CT0 Structure                                              */
  ...
  union {
    __IOM uint32_t CT_GEN_CTRL_SET_REG;         /*!< (@ 0x00000000) General control set register                               */
    ...
    struct {
      ...
      __IOM uint32_t SOFT_RESET_COUNTER_0_FRM_REG : 1;/*!< (@ 0x00000001) This is applied to 32 bits of counter only when
                                                                    the counter is in 32 bit counter mode otherwise
                                                                    this will be applied to only lower 16 bits
                                                                    of counter                                                 */
      __IOM uint32_t PERIODIC_EN_COUNTER_0_FRM_REG : 1;/*!< (@ 0x00000002) This is applied to 32 bits of counter only when
                                                                    the counter is in 32 bit counter mode otherwise
                                                                    this will be applied to only lower 16 bits
                                                                    of counter                                                 */
      __IOM uint32_t COUNTER_0_TRIG_FRM_REG : 1;/*!< (@ 0x00000003) This enables the counter to run/active                     */
      __IOM uint32_t COUNTER_0_UP_DOWN : 2;     /*!< (@ 0x00000004) This enables the counter to run in up/down/up-down/down-up
                                                                    directions                                                 */
      ...
      __IOM uint32_t SOFT_RESET_COUNTER_1_FRM_REG : 1;/*!< (@ 0x00000011) This resets the counter on the write                 */
      __IOM uint32_t PERIODIC_EN_COUNTER_1_FRM_REG : 1;/*!< (@ 0x00000012) This resets the counter on the write                */
      __IOM uint32_t COUNTER_1_TRIG_FRM : 1;    /*!< (@ 0x00000013) This enables the counter to run/active                     */
      __IOM uint32_t COUNTER_1_UP_DOWN : 2;     /*!< (@ 0x00000014) This enables the counter to run in upward direction        */
  ...
  union {
    __IOM uint32_t CT_GEN_CTRL_RESET_REG;       /*!< (@ 0x00000004) General control reset register                             */
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t COUNTER_0_IS_ZERO_L : 1;   /*!< (@ 0x00000002) Counter 0 hit zero in active mode.                         */
      __IM  uint32_t COUNTER_0_IS_PEAK_L : 1;   /*!< (@ 0x00000003) Counter 0 hit peak (MATCH) in active mode.                 */
      __IM  uint32_t RESERVED1  : 12;           /*!< (@ 0x00000004) Reserved1                                                  */
      ...
      __IM  uint32_t COUNTER_1_IS_ZERO_L : 1;   /*!< (@ 0x00000012) Counter 1 hit zero in active mode.                         */
      __IM  uint32_t COUNTER_1_IS_PEAK_L : 1;   /*!< (@ 0x00000013) Counter 1 hit peak (MATCH) in active mode.                 */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t FIFO_0_FULL_L : 1;         /*!< (@ 0x00000001) Interrupt unmask signal.                                   */
      __IOM uint32_t COUNTER_0_IS_ZERO_L : 1;   /*!< (@ 0x00000002) Interrupt unmask signal.                                   */
      __IOM uint32_t COUNTER_0_IS_PEAK_L : 1;   /*!< (@ 0x00000003) Interrupt unmask signal.                                   */
      __IM  uint32_t RESERVED1  : 12;           /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t INTR_1_L   : 1;            /*!< (@ 0x00000010) Interrupt unmask signal.                                   */
      __IOM uint32_t FIFO_1_FULL_L : 1;         /*!< (@ 0x00000011) Interrupt unmask signal                                    */
      __IOM uint32_t COUNTER_1_IS_ZERO_L : 1;   /*!< (@ 0x00000012) Interrupt unmask signal.                                   */
      __IOM uint32_t COUNTER_1_IS_PEAK_L : 1;   /*!< (@ 0x00000013) Interrupt unmask signal.                                   */
      __IM  uint32_t RESERVED2  : 12;           /*!< (@ 0x00000014) Reserved2                                                  */
    } CT_INTER_UNMASK_b;
  } ;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t FIFO_0_FULL_L : 1;         /*!< (@ 0x00000001) Interrupt ack signal.                                      */
      __IOM uint32_t COUNTER_0_IS_ZERO_L : 1;   /*!< (@ 0x00000002) Interrupt ack signal.                                      */
      __IOM uint32_t COUNTER_0_IS_PEAK_L : 1;   /*!< (@ 0x00000003) Interrupt ack signal.                                      */
      __IM  uint32_t RESERVED1  : 12;           /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t INTR_1_L   : 1;            /*!< (@ 0x00000010) Interrupt ack signal.                                      */
      __IOM uint32_t FIFO_1_FULL_L : 1;         /*!< (@ 0x00000011) Interrupt ack signal.                                      */
      __IOM uint32_t COUNTER_1_IS_ZERO_L : 1;   /*!< (@ 0x00000012) Interrupt ack signal.                                      */
      __IOM uint32_t COUNTER_1_IS_PEAK_L : 1;   /*!< (@ 0x00000013) Interrupt ack signal.                                      */
      __IOM uint32_t RESERVED2  : 12;           /*!< (@ 0x00000014) Reserved2                                                  */
    } CT_INTR_ACK_b;
  } ;
  ...
  union {
    ...
    struct {
      __IOM uint32_t COUNTER_0_MATCH : 16;      /*!< (@ 0x00000000) This will be used as lower match                           */
      __IOM uint32_t COUNTER_1_MATCH : 16;      /*!< (@ 0x00000010) This will be used as upper match                           */
    } CT_MATCH_REG_b;
  } ;
  ...
  union {
    __IOM uint32_t CT_OCU_COMPARE_NXT_REG;      /*!< (@ 0x00000038) PWM compare next register                                  */
    
    struct {
      __IOM uint32_t OCU_COMPARE_NXT_COUNTER1 : 16;/*!< (@ 0x00000000) OCU output should be high for counter 1                 */
      __IOM uint32_t OCU_COMPARE_NXT_COUNTER0 : 16;/*!< (@ 0x00000010) PWM output should be high for counter 0                 */
  ...
  union {
    ...
    struct {
      __IOM uint32_t MAKE_OUTPUT_0_TGL_0_SEL : 3;/*!< (@ 0x00000000) Check the counter ocus possibilities for description
                                                                    for channel 0.                                             */
      __IOM uint32_t MAKE_OUTPUT_0_TGL_1_SEL : 3;/*!< (@ 0x00000003) Check the counter ocus possibilities for description
                                                                    for channel 0.                                             */
      __IOM uint32_t RESERVED1  : 2;            /*!< (@ 0x00000006) Reserved1                                                  */
      __IOM uint32_t WFG_TGL_CNT_0_PEAK : 8;    /*!< (@ 0x00000008) WFG mode output toggle count clock for channel
                                                                    0.                                                         */
      __IOM uint32_t MAKE_OUTPUT_1_TGL_0_SEL : 3;/*!< (@ 0x00000010) Check the counter ocus possibilities for description
                                                                    for channel 1.                                             */
      __IOM uint32_t MAKE_OUTPUT_1_TGL_1_SEL : 3;/*!< (@ 0x00000013) Check the counter ocus possibilities for description
                                                                    for channel 1.                                             */
  ...
  union {
    __IOM uint32_t CT_OCU_COMPARE2_NXT_REG;     /*!< (@ 0x00000040) PWM compare next register                                  */
    
    struct {
      __IOM uint32_t OCU_COMPARE2_NXT_COUNTER0 : 16;/*!< (@ 0x00000000) OCU output should be high for counter 1                */
      __IOM uint32_t OCU_COMPARE2_NXT_COUNTER1 : 16;/*!< (@ 0x00000010) PWM output should be high for counter 0                */
    } CT_OCU_COMPARE2_NXT_REG_b;
  } ;
  __IM  uint32_t  RESERVED[3];
  
  union {
    __IOM uint32_t CT_START_COUNTER_EVENT_SEL;  /*!< (@ 0x00000050) Start counter event select register                        */
  ...
  union {
    __IOM uint32_t CT_START_COUNTER_AND_EVENT;  /*!< (@ 0x00000054) Start counter AND event register                           */
    
    struct {
      __IOM uint32_t START_COUNTER_0_AND_EVENT : 4;/*!< (@ 0x00000000) For two 16 bit counter mode: AND expression valids
      ...
      __IOM uint32_t START_COUNTER_0_AND_VLD : 4;/*!< (@ 0x00000008) none                                                      */
      ...
      __IOM uint32_t START_COUNTER_1_AND_VLD : 4;/*!< (@ 0x00000018) none                                                      */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
    } CT_START_COUNTER_AND_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_START_COUNTER_OR_EVENT;   /*!< (@ 0x00000058) Start counter OR event register                            */
    ...
    struct {
      ...
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t START_COUNTER_0_OR_VLD : 4;/*!< (@ 0x00000008) none                                                       */
      __IOM uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      __IOM uint32_t START_COUNTER_1_OR_EVENT : 4;/*!< (@ 0x00000010) For two 16 bit counters mode: OR expression valids
                                                                    for OR event in start counter event For
                                                                    32 bit counter mode : Invalid.                             */
      __IM  uint32_t RESERVED3  : 4;            /*!< (@ 0x00000014) Reserved3                                                  */
      __IOM uint32_t START_COUNTER_1_OR_VLD : 4;/*!< (@ 0x00000018) none                                                       */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
    } CT_START_COUNTER_OR_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_CONTINUE_COUNTER_EVENT_SEL;/*!< (@ 0x0000005C) Continue counter event select register                    */
    
    struct {
      __IOM uint32_t CONTINUE_COUNTER_0_EVENT_SEL : 6;/*!< (@ 0x00000000) For two 16 bit counters mode: Event select for
                                                                    continuing the Counter 0 For 32 bit counter
                                                                    mode: Event select for continuing counter                  */
      __IOM uint32_t RESERVED1  : 10;           /*!< (@ 0x00000006) Reserved1                                                  */
      __IOM uint32_t CONTINUE_COUNTER_1_EVENT_SEL : 6;/*!< (@ 0x00000010) For two 16 bit counters mode: Event select for
  ...
  union {
    __IOM uint32_t CT_CONTINUE_COUNTER_AND_EVENT;/*!< (@ 0x00000060) Continue counter AND event register                       */
    
    struct {
      __IOM uint32_t CONTINUE_COUNTER_0_AND_EVENT : 4;/*!< (@ 0x00000000) For two 16 bit counter mode: AND expression valids
                                                                    for AND event in continue Counter 0 event
                                                                    For 32 bit counter mode AND expression
                                                                    valids for AND event in continue counter
                                                                    event.                                                     */
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t CONTINUE_COUNTER_0_AND_VLD : 4;/*!< (@ 0x00000008) none                                                   */
      __IOM uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      ...
      __IM  uint32_t RESERVED3  : 4;            /*!< (@ 0x00000014) Reserved3                                                  */
      __IOM uint32_t CONTINUE_COUNTER_1_AND_VLD : 4;/*!< (@ 0x00000018) none                                                   */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
    } CT_CONTINUE_COUNTER_AND_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_CONTINUE_COUNTER_OR_EVENT;/*!< (@ 0x00000064) Continue counter OR event register                         */
    
    struct {
      __IOM uint32_t CONTINUE_COUNTER_0_OR_EVENT : 4;/*!< (@ 0x00000000) For two 16 bit counter mode: OR expression valids
      ...
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t CONTINUE_COUNTER_0_OR_VLD : 4;/*!< (@ 0x00000008) none                                                    */
      __IOM uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      __IOM uint32_t CONTINUE_COUNTER_1_OR_EVENT : 4;/*!< (@ 0x00000010) For two 16 bit counters mode: OR expression valids
                                                                    for OR event in continue counter event
                                                                    For 32 bit counter mode : Invalid                          */
      __IM  uint32_t RESERVED3  : 4;            /*!< (@ 0x00000014) Reserved3                                                  */
      __IOM uint32_t CONTINUE_COUNTER_1_OR_VLD : 4;/*!< (@ 0x00000018) none                                                    */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
    } CT_CONTINUE_COUNTER_OR_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_STOP_COUNTER_EVENT_SEL;   /*!< (@ 0x00000068) Stop counter event select register                         */
  ...
  union {
    __IOM uint32_t CT_STOP_COUNTER_AND_EVENT;   /*!< (@ 0x0000006C) Stop counter AND event register                            */
    
    struct {
      __IOM uint32_t STOP_COUNTER_0_AND_EVENT : 4;/*!< (@ 0x00000000) For two 16 bit counter mode: AND expression valids
                                                                    for AND event in stop Counter 0 event For
                                                                    32 bit counter mode AND expression valids
                                                                    for AND event in stop counter event                        */
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t STOP_COUNTER_0_AND_VLD : 4;/*!< (@ 0x00000008) Indicates which bits in 3:0 are valid for considering
                                                                    AND event                                                  */
      __IOM uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      __IOM uint32_t STOP_COUNTER_1_AND_EVENT : 4;/*!< (@ 0x00000010) For two 16 bit counters mode: AND expression
                                                                    ...
                                                                    For 32 bit counter mode : Invalid                          */
      __IM  uint32_t RESERVED3  : 4;            /*!< (@ 0x00000014) Reserved3                                                  */
      __IOM uint32_t STOP_COUNTER_1_AND_VLD : 4;/*!< (@ 0x00000018) none                                                       */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
    } CT_STOP_COUNTER_AND_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_STOP_COUNTER_OR_EVENT;    /*!< (@ 0x00000070) Stop counter OR event register                             */
    ...
    struct {
      ...
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t STOP_COUNTER_0_OR_VLD : 4; /*!< (@ 0x00000008) none                                                       */
      __IOM uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      __IOM uint32_t STOP_COUNTER_1_OR_EVENT : 4;/*!< (@ 0x00000010) For two 16 bit counters mode: OR expression valids
                                                                    ...
                                                                    32 bit counter mode : Invalid                              */
      __IM  uint32_t RESERVED3  : 4;            /*!< (@ 0x00000014) Reserved3                                                  */
      __IOM uint32_t STOP_COUNTER_1_OR_VLD : 4; /*!< (@ 0x00000018) none                                                       */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
    } CT_STOP_COUNTER_OR_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_HALT_COUNTER_EVENT_SEL;   /*!< (@ 0x00000074) Halt counter event select register                         */
  ...
  union {
    __IOM uint32_t CT_HALT_COUNTER_AND_EVENT;   /*!< (@ 0x00000078) Halt counter AND event register                            */
    
    struct {
      __IOM uint32_t HALT_COUNTER_0_AND_EVENT : 4;/*!< (@ 0x00000000) For two 16 bit counter mode: AND expression valids
                                                                    for AND event in stop Counter 0 event For
                                                                    32 bit counter mode AND expression valids
                                                                    for AND event in stop counter event                        */
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t HALT_COUNTER_0_AND_VLD : 4;/*!< (@ 0x00000008) Indicates which bits in 3:0 are valid for considering
                                                                    AND event                                                  */
      __IM  uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      __IOM uint32_t HALT_COUNTER_1_AND_EVENT : 4;/*!< (@ 0x00000010) For two 16 bit counters mode: AND expression
                                                                    ...
                                                                    For 32 bit counter mode : Invalid                          */
      __IM  uint32_t RESERVED3  : 4;            /*!< (@ 0x00000014) Reserved3                                                  */
      __IOM uint32_t HALT_COUNTER_1_AND_VLD : 4;/*!< (@ 0x00000018) none                                                       */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
    } CT_HALT_COUNTER_AND_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_HALT_COUNTER_OR_EVENT;    /*!< (@ 0x0000007C) Halt counter OR event register                             */
    ...
    struct {
      ...
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t HALT_COUNTER_0_OR_VLD : 4; /*!< (@ 0x00000008) none                                                       */
      __IM  uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      __IOM uint32_t HALT_COUNTER_1_OR_EVENT : 4;/*!< (@ 0x00000010) For two 16 bit counters mode: OR expression valids
                                                                    ...
                                                                    32 bit counter mode : Invalid                              */
      __IM  uint32_t RESERVED3  : 4;            /*!< (@ 0x00000014) Reserved3                                                  */
      __IOM uint32_t HALT_COUNTER_1_OR_VLD : 4; /*!< (@ 0x00000018) none                                                       */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
    } CT_HALT_COUNTER_OR_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_INCREMENT_COUNTER_EVENT_SEL;/*!< (@ 0x00000080) Increment counter event select register                  */
    
    struct {
      __IOM uint32_t INCREMENT_COUNTER_0_EVENT_SEL : 6;/*!< (@ 0x00000000) For two 16 bit counters mode: Event select for
      ...
      __IOM uint32_t INCREMENT_COUNTER_1_EVENT_SEL : 6;/*!< (@ 0x00000010) For two 16 bit counters mode: Event select for
  ...
  union {
    __IOM uint32_t CT_INCREMENT_COUNTER_AND_EVENT;/*!< (@ 0x00000084) Increment counter AND event register                     */
    
    struct {
      __IOM uint32_t INCREMENT_COUNTER_0_AND_EVENT : 4;/*!< (@ 0x00000000) For two 16 bit counter mode: AND expression valids
                                                                    for AND event in stop Counter 0 event For
                                                                    32 bit counter mode AND expression valids
                                                                    for AND event in stop counter event                        */
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t INCREMENT_COUNTER_0_AND_VLD : 4;/*!< (@ 0x00000008) none                                                  */
      __IM  uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      __IOM uint32_t INCREMENT_COUNTER_1_AND_EVENT : 4;/*!< (@ 0x00000010) For two 16 bit counters mode: AND expression
                                                                    valids for AND event in stop counter event
                                                                    For 32 bit counter mode : Invalid                          */
      __IM  uint32_t RESERVED3  : 4;            /*!< (@ 0x00000014) Reserved3                                                  */
      __IOM uint32_t INCREMENT_COUNTER_1_AND_VLD : 4;/*!< (@ 0x00000018) none                                                  */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
    } CT_INCREMENT_COUNTER_AND_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_INCREMENT_COUNTER_OR_EVENT;/*!< (@ 0x00000088) Increment counter OR event register                       */
    
    struct {
      __IOM uint32_t INCREMENT_COUNTER_0_OR_EVENT : 4;/*!< (@ 0x00000000) For two 16 bit counter mode: OR expression valids
                                                                    for OR event in Increment Counter 0 event
                                                                    For 32 bit counter mode OR expression valids
                                                                    for OR event in Increment counter event                    */
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t INCREMENT_COUNTER_0_OR_VLD : 4;/*!< (@ 0x00000008) none                                                   */
      __IM  uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      __IOM uint32_t INCREMENT_COUNTER_1_OR_EVENT : 4;/*!< (@ 0x00000010) For two 16 bit counters mode: OR expression valids
                                                                    for OR event in Increment counter event
                                                                    For 32 bit counter mode : Invalid                          */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x00000014) Reserved4                                                  */
      __IOM uint32_t INCREMENT_COUNTER_1_OR_VLD : 4;/*!< (@ 0x00000018) none                                                   */
      __IM  uint32_t RESERVED5  : 4;            /*!< (@ 0x0000001C) Reserved5                                                  */
    } CT_INCREMENT_COUNTER_OR_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_CAPTURE_COUNTER_EVENT_SEL;/*!< (@ 0x0000008C) Capture counter event select register                      */
  ...
  union {
    __IOM uint32_t CT_CAPTURE_COUNTER_AND_EVENT;/*!< (@ 0x00000090) Capture counter AND event register                         */
    
    struct {
      __IOM uint32_t CAPTURE_COUNTER_0_AND_EVENT : 4;/*!< (@ 0x00000000) For two 16 bit counter mode: AND expression valids
                                                                    for AND event in stop Counter 0 event For
                                                                    32 bit counter mode AND expression valids
                                                                    for AND event in stop counter event                        */
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t CAPTURE_COUNTER_0_AND_VLD : 4;/*!< (@ 0x00000008) none                                                    */
      __IM  uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      __IOM uint32_t CAPTURE_COUNTER_1_AND_EVENT : 4;/*!< (@ 0x00000010) For two 16 bit counters mode: AND expression
                                                                    valids for AND event in stop counter event
                                                                    For 32 bit counter mode : Invalid                          */
      __IM  uint32_t RESERVED3  : 4;            /*!< (@ 0x00000014) Reserved3                                                  */
      __IOM uint32_t CAPTURE_COUNTER_1_AND_VLD : 4;/*!< (@ 0x00000018) none                                                    */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
    } CT_CAPTURE_COUNTER_AND_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_CAPTURE_COUNTER_OR_EVENT; /*!< (@ 0x00000094) Capture counter OR event register                          */
    
    struct {
      __IOM uint32_t CAPTURE_COUNTER_0_OR_EVENT : 4;/*!< (@ 0x00000000) For two 16 bit counter mode: OR expression valids
                                                                    for OR event in Capture Counter 0 event
                                                                    For 32 bit counter mode OR expression valids
                                                                    for OR event in Capture counter event                      */
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t CAPTURE_COUNTER_0_OR_VLD : 4;/*!< (@ 0x00000008) none                                                     */
      __IM  uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      __IOM uint32_t CAPTURE_COUNTER_1_OR_EVENT : 4;/*!< (@ 0x00000010) For two 16 bit counters mode: OR expression valids
                                                                    for OR event in Capture counter event For
                                                                    32 bit counter mode : Invalid                              */
      __IM  uint32_t RESERVED3  : 4;            /*!< (@ 0x00000014) Reserved3                                                  */
      __IOM uint32_t CAPTURE_COUNTER_1_OR_VLD : 4;/*!< (@ 0x00000018) none                                                     */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
    } CT_CAPTURE_COUNTER_OR_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_OUTPUT_EVENT_SEL;         /*!< (@ 0x00000098) Output event select register                               */
  ...
  union {
    __IOM uint32_t CT_OUTPUT_AND_EVENT_REG;     /*!< (@ 0x0000009C) Output AND event Register                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t INTR_0_AND_EVENT : 4;      /*!< (@ 0x00000000) None                                                       */
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t INTR_0_AND_VLD : 4;        /*!< (@ 0x00000008) None                                                       */
      __IM  uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      __IOM uint32_t INTR_1_AND_EVENT : 4;      /*!< (@ 0x00000010) None                                                       */
      __IM  uint32_t RESERVED3  : 4;            /*!< (@ 0x00000014) Reserved3                                                  */
      __IOM uint32_t INTR_1_AND_VLD : 4;        /*!< (@ 0x00000018) None                                                       */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
    } CT_INTR_AND_EVENT_b;
  } ;
  
  union {
    __IOM uint32_t CT_INTR_OR_EVENT_REG;        /*!< (@ 0x000000AC) Interrupt OR Event Register                                */
    
    struct {
      __IOM uint32_t INTR_0_OR_EVENT : 4;       /*!< (@ 0x00000000) None                                                       */
      __IOM uint32_t RESERVED1  : 4;            /*!< (@ 0x00000004) Reserved1                                                  */
      __IOM uint32_t INTR_0_OR_VLD : 4;         /*!< (@ 0x00000008) None                                                       */
      __IM  uint32_t RESERVED2  : 4;            /*!< (@ 0x0000000C) Reserved2                                                  */
      __IOM uint32_t INTR_1_OR_EVENT : 4;       /*!< (@ 0x00000010) None                                                       */
      __IM  uint32_t RESERVED3  : 4;            /*!< (@ 0x00000014) Reserved3                                                  */
      __IOM uint32_t INTR_1_OR_VLD : 4;         /*!< (@ 0x00000018) None                                                       */
      __IM  uint32_t RESERVED4  : 4;            /*!< (@ 0x0000001C) Reserved4                                                  */
...
typedef struct {                                /*!< (@ 0x4506F000) CT_MUX_REG Structure                                       */  
  ...
  union {
    __IOM uint32_t CT_OUTPUT_EVENT1_ADC_SEL;    /*!< (@ 0x00000018) OUTPUT_EVENT_ADC_SEL Register                              */
  ...
  union {
    __IOM uint32_t CT_OUTPUT_EVENT2_ADC_SEL;    /*!< (@ 0x0000001C) OUTPUT_EVENT_ADC_SEL Register                              */
...
typedef struct {                                    /*!< ETHERNET Structure                                                    */
	...
	union {
		...
		struct {
			__I  uint32_t  RGMII_INTR_STS:  1;            /*!< This bit is set due to any change in value of the Link Status
                                                         of RGMII interface                                                    */
			__I  uint32_t  PCS_LINK_STATUS_CHANGED:  1;   /*!< This bit is set due to any change in Link Status in the TBI/RTBI/SGMII
                                                         PHYinterface                                                          */
			...
			__I  uint32_t  MMC_RX_CH_OFF_INTR_STS:  1;    /*!< MMC Receive Checksum Offload Interrupt Status                         */
	...
	__IO uint32_t  MAC_ADDR0_LOW_REG;                 /*!< The MAC Address0 Low register holds the lower 32 bits of the
                                                         6-byte first MAC address of the station                               */
	ETHERNET_MAC_16_ADDR_Type MAC_16_ADDR[15];        /*!< MAC_16_ADDR0                                                          */
	...
	ETHERNET_MAC_31_ADDR_Type MAC_31_ADDR[15];        /*!< MAC_31_ADDR0                                                          */
...
typedef struct {                                      /*!<  SDIO structure           */
	...
	union {
		...
		struct {
			__IO  uint32_t  SDIO_WR_INT_CLR           :  1;   /*!<  This bit is used to enable CMD53 write interrupt. =1 Interrupt is enabled =0 - Interrupt is disabled */
	...
	union {
		...
		struct {
			__IO  uint32_t  SDIO_WR_INT_EN           :  1;   /*!<  This bit is used to enable CMD53 write interrupt. =1 Interrupt is enabled =0 - Interrupt is disabled */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  SDIO_CSA_MSK              :  1;   /*!<  This bit is used to mask CMD53 CSA interrupt.Setting this bit will mask the interrupt Clearing this bit has no effect */
			...
			__IO uint32_t  SDIO_ABORT_MSK            :  2;   /*!<  This bit is used to mask abort interrupt Setting this bit will mask the interrupt Clearing this bit has no effect */
	...
	union {
		...
		struct {
			...
			__I  uint32_t  SDIO_BUS_CONTROL_STATE    :  5;   /*!< SDIO bus control state 7 – When set, indicates FSM is in idle state 8 – When set, indicates FSM is in CMD52 read state 9 – When set, indicates FSM is in CMD52 write state 10 – When set, indicates FSM is
	...
	union {
		...
		struct {
			__IO uint32_t  SDIO_CRC_EN              :  1;    /*!<  When set, stops the DMA from doing data accesses till CRC error interrupt is cleared */
			__IO uint32_t  SDIO_ABORT_EN            :  1;    /*!<  When set, stops the DMA from doing data accesses till ABORT interrupt is cleared */
			__IO uint32_t  SDIO_SPI_RD_DATA_ERROR_EN:  1;    /*!< When set, stops the DMA from doing data accesses till read data error interrupt is cleared in SPI mode  */
			uint32_t                           : 13;
	...
	union {
		...
		struct {
			...
			__I  uint32_t  CSA_MSBYTE               : 24;    /*!< MS byre of CSA address. Lower 24 bits of CSA will come through SDIO CSA registers. Whenever CSA access is done,
	...
	union {
		...
		struct {
			__I  uint32_t  NO_OF_IO_FUNCTIONS              :  3;    /*!< Indicates number functions supported. The value written by bootloader can be read here.  */
			__I  uint32_t  COMBOCARD                       :  1;    /*!< When set, combo mode will be enabled  */
			__I  uint32_t  SDMEM_IGNOTRE_SDMEM_PRESENT     :  1;    /*!< When set, sdmem_present signal, coming from GPIO, will be ignored.  */
			__I  uint32_t  ADMEM_DRIVE_HIZ_MB_READ         :  1;    /*!< When set, High will be driven in the second cycle of interrupt period during sd memory mb read transfer */
			__I  uint32_t  SDMEM_DISABLE_INTERRUPT_MB_READ :  1;    /*!< When set, interrupt will be not be driven during sd memory mb read transfer */
			__I  uint32_t  IGNORE_DISABLE_HS               :  1;    /*!< if ignore_disable_hs is set, sdmem_disable_high_speed_switching coming from combo mode module is ignored  */
			uint32_t                                  : 24;
...
typedef struct {                                    /*!< M4_PLL Structure                                                      */
	...
	union {
		...
		struct {
			...
			__IO uint32_t 	CT_CLK_SEL	          : 3 ;//’D0
			__IO uint32_t 	CT_CLK_DIV_FAC	      : 6 ; // ’D1
	...
	/*0x44*/
	union {
		__IO uint32_t  DYN_CLK_GATE_DISABLE_REG;        /*!< Dynamic Clk Ctrl Disable Register                                     */
	...
	union {
		...
		struct {
			__I  uint32_t CC_DONE_b		:1 ;  // ’B 0
			__I  uint32_t CC_ERROR_b	:1 ;  //’B 0
	...
	/*0x80*/
	union {
		__IO  uint32_t  DYN_CLK_GATE_DISABLE_REG2;                     /*!< Clock Calibration Status Register1                                    */
		...
		struct {
			...
			__IO uint32_t 	CT_PCLK_DYN_CTRL_DISABLE_b	        	:1;//’B 0
...
typedef struct {
	...
	/*0x00*/
	union {
		__IO uint32_t  MCU_CAL_RO_TIMEPERIOD_READ;             /*!< none                                                                  */
	...
	/*0x04*/
	union {
		__IO uint32_t  MCU_CAL_TIMER_CLOCK_PERIOD;             /*!< none                                                                  */
	...
	/*0x10*/
	union {
		__IO uint32_t  MCU_CAL_REF_CLK_SETTLE_REG;             /*!< none                                                                  */
	...
	/*0x14*/
	union {
		__IO uint32_t  MCU_CAL_RC_TIMEPERIOD_READ;             /*!< none                                                                  */
	...
	/*0x18*/
	union {
		__IO uint32_t  MCU_CAL_REF_CLK_TIEMPERIOD_REG;             /*!< none                                                                  */
...
typedef struct {                                /*!< (@ 0x24048300) MCU_WDT Structure                                          */
  ...
  union {
    __IOM uint32_t MCU_WWD_INTERRUPT_TIMER;     /*!< (@ 0x00000000) WATCHDOG interrupt timer register                          */
    
    struct {
      __IOM uint32_t WWD_INTERRUPT_TIMER : 5 ;   /*!< (@ 0x00000000) Watchdog Timer programming values                          */
      __IM  uint32_t RESERVED1           : 27;           /*!< (@ 0x00000005) reser                                                      */
    } MCU_WWD_INTERRUPT_TIMER_b;
  } ;
  
  union {
    __IOM uint32_t MCU_WWD_SYSTEM_RESET_TIMER;  /*!< (@ 0x00000004) MCU watchdog system reset register                         */
    
    struct {
      __IOM uint32_t WWD_SYSTEM_RESET_TIMER : 5 ;/*!< (@ 0x00000000) Watch dog soc reset delay timer programming values         */
      __IM  uint32_t RESERVED1              : 27;           /*!< (@ 0x00000005) reser                                                      */
    } MCU_WWD_SYSTEM_RESET_TIMER_b;
  } ;
  
  union {
    __IOM uint32_t MCU_WWD_WINDOW_TIMER;        /*!< (@ 0x00000008) watchdog window timer register                             */
  ...
  union {
    __IOM uint32_t MCU_WWD_ARM_STUCK_EN;        /*!< (@ 0x0000000C) watchdog arm stuck enable register                         */
    
    struct {
      __IM  uint32_t RESERVED1                 : 16;           /*!< (@ 0x00000000) reser                                                      */
      __OM  uint32_t PROCESSOR_STUCK_RESET_EN  : 1 ;/*!< (@ 0x00000010) Enable to reset M4 core on seeing LOCKUP signal          */
      __IOM uint32_t RESERVED2                 : 7 ;            /*!< (@ 0x00000011) reser                                                      */
      __IM  uint32_t PROCESSOR_STUCK_RESET_EN_ : 1 ;/*!< (@ 0x00000018) Read signal for processor stuck reset enable            */
      __IOM uint32_t RESERVED3                 : 7 ;            /*!< (@ 0x00000019) reser                                                      */
    } MCU_WWD_ARM_STUCK_EN_b;
  } ;
  
  union {
    __IOM uint32_t MCU_WWD_MODE_AND_RSTART;     /*!< (@ 0x00000010) WATCHDOG mode and restart register                         */
    
    struct {
      __IOM uint32_t WWD_MODE_RSTART    : 1 ;       /*!< (@ 0x00000000) restart pulse to restart watchdog timer                    */
      __IM  uint32_t RESERVED1          : 15;           /*!< (@ 0x00000001) reser                                                      */
      __IOM uint32_t WWD_MODE_EN_STATUS : 8 ;    /*!< (@ 0x00000010) Watchdog timer mode                                        */
  ...
  union {
    ...
    struct {
      __OM  uint32_t WWD_KEY_ENABLE     : 32;       /*!< (@ 0x00000000) enable access to program Watch dog registers               */
...
typedef struct {
  ...
  __IM  uint32_t  RESERVED[7];
    ...
    __IOM uint32_t MCU_CAL_PROG_TIME_1;         /*!< (@ 0x00000028) MCU calendar prog time 1 register*/
		struct {
      __IOM uint32_t PROG_MSEC  : 10 ;           /*!< (@ 0x00000000) Milli seconds value to be programmed to real time in calendar when pro_time_trig is  1   */
      __IOM uint32_t PROG_SEC   : 6 ;            /*!< (@ 0x0000000A) seconds value to be programmed to real time in calendar when pro_time_trig is 1 */
      __IOM uint32_t PROG_MIN   : 6 ;            /*!< (@ 0x00000010) minutes value to be programmed to real time in calendar when pro_time_trig is 1 */
      __IOM uint32_t PROG_HOUR  : 5 ;            /*!< (@ 0x00000016) hours value to be programmed to real time in calendar when pro_time_trig is 1 */
    ...
    __IOM uint32_t MCU_CAL_PROG_TIME_2;         /*!< (@ 0x0000002C) MCU calendar prog time 2 register*/
		struct {
      __IOM uint32_t PROG_DAY        : 5 ;      /*!< (@ 0x00000000) day count value to be programmed to real time in calendar when pro_time_trig is 1 */
      __IOM uint32_t PROG_WEEK_DAY   : 3 ;      /*!< (@ 0x00000005) program which week day it is     */
      __IOM uint32_t PROG_MONTH      : 4 ;      /*!< (@ 0x00000008) month value to be programmed to real time in calendar when pro_time_trig is 1 */
      __IM  uint32_t RES             : 4 ;      /*!< (@ 0x0000000C) reser     */
      __IOM uint32_t PROG_YEAR       : 7 ;      /*!< (@ 0x00000010) year value to be programmed to real time in calendar when pro_time_trig is 1   */
      __IOM uint32_t PROG_CENTURY    : 2 ;       /*!< (@ 0x00000017) century value to be programmed to real time in calendar when pro_time_trig is 1 */
	...
	/*0x30*/
	union {
    __IOM uint32_t MCU_CAL_READ_TIME_MSB;       /*!< (@ 0x00000030) MCU calendar read time msb                                 */
		struct {
      ...
      __IOM uint32_t CENTURY_COUNT : 2;         /*!< (@ 0x0000000E) century count                                              */
      __IM  uint32_t RESERVED1  : 16;           /*!< (@ 0x00000010) reser                                                      */
		} MCU_CAL_READ_TIME_MSB_b;                        /*!< BitSize                                                               */
	};
	/*0x34*/
	union {
    __IOM uint32_t MCU_CAL_READ_TIME_LSB;       /*!< (@ 0x00000034) MCU calendar read time lsb                                 */
		struct {
      __IOM uint32_t MILLISECONDS_COUNT : 10;   /*!< (@ 0x00000000) milliseconds count                                         */
      __IOM uint32_t SECONDS_COUNT : 6;         /*!< (@ 0x0000000A) seconds count                                              */
    ...
    __IOM uint32_t MCU_CAL_SLEEP_CLK_COUNTERS;  /*!< (@ 0x0000003C) MCU calendar sleep clock counter */
		...
		struct {
      __IM  uint32_t SLEEP_CLK_DURATION        : 12 ;  /*!< (@ 0x00000000) No of sleep clks with respect to APB clock so far from the posedge of sleep clk*/
...
typedef struct {
	...
	/*0x00*/
	union {
		__IO uint32_t  M4SS_BYPASS_PWRCTRL_REG1;             /*!< none                                                                  */
	...
	/*0x04*/
	union {
		__IO uint32_t  M4SS_BYPASS_PWRCTRL_REG2;             /*!< none                                                                  */
	...
	/*0x10*/
	union {
		__IO uint32_t  M4_SRAM_PWRCTRL_SET_REG1;             /*!< none                                                                  */
	...
	/*0x14*/
	union {
		__IO uint32_t  M4_SRAM_PWRCTRL_CLEAR_REG1;             /*!< none                                                                  */
	...
	/*0x18*/
	union {
		__IO uint32_t M4_SRAM_PWRCTRL_SET_REG2;             /*!< none                                                                  */
	...
	/*0x1C*/
	union {
		__IO uint32_t M4_SRAM_PWRCTRL_CLEAR_REG2;             /*!< none                                                                  */
	...
	/*0x20*/
	union {
		__IO uint32_t  M4_SRAM_PWRCTRL_SET_REG3;             /*!< none                                                                  */
	...
	/*0x24*/
	union {
		__IO uint32_t  M4_SRAM_PWRCTRL_CLEAR_REG3;             /*!< none                                                                  */
	...
	/*0x28*/
	union {
		__IO uint32_t  M4_SRAM_PWRCTRL_SET_REG4;             /*!< none                                                                  */
	...
	/*0x2C*/
	union {
		__IO uint32_t  M4_SRAM_PWRCTRL_CLEAR_REG4;             /*!< none                                                                  */
	...
	/*0x38*/
	union {
		__IO uint32_t  M4SS_TASS_CTRL_CLEAR_REG;             /*!< none                                                                  */
	...
	/*0x40*/
	union {
		__IO uint32_t  ULPSS_BYPASS_PWRCTRL_REG;             /*!< none                                                                  */
	...
	/*0x4C*/
	union {
		__IO uint32_t  ULPSS_RAM_PWRCTRL_SET_REG1;             /*!< none                                                                  */
	...
	/*0x50*/
	union {
		__IO uint32_t  ULPSS_RAM_PWRCTRL_CLEAR_REG1;             /*!< none                                                                  */
	...
	/*0x54*/
	union {
		__IO uint32_t  ULPSS_RAM_PWRCTRL_SET_REG2;             /*!< none                                                                  */
	...
	/*0x58*/
	union {
		__IO uint32_t  ULPSS_RAM_PWRCTRL_CLEAR_REG2;             /*!< none                                                                  */
...
typedef struct {
	...
	union {
		...
		struct {
			...
			__IO uint32_t POWER_ENABLE_TIMESTAPING_b     :1  ;
...
typedef struct
{
	/*0x00*/
	union {
		__IO uint32_t  TS_ENABLE_AND_TEMPERATURE_DONE;             /*!< none                                                                  */
		struct {
	...
	/*0x08*/
	union {
		__IO uint32_t  TS_FE_COUNTS_NOMINAL_SETTINGS;             /*!< none                                                                  */
		struct {
...
typedef struct
{
	/*0x00*/
	union {
		__IO uint32_t  MCUAON_NPSS_PWRCTRL_SET_REG;             /*!< none                                                                  */
		struct {
			__IO uint32_t RES 																			:1 ;
	...
	/*0x04*/
	union {
		__IO uint32_t  MCUAON_NPSS_PWRCTRL_CLEAR_REG;             /*!< none                                                                  */
		struct {
			__IO uint32_t RES 																			:1 ;
			__IO uint32_t SLPSS_PWRGATE_EN_N_ULP_MCUBFFS   					:1 ;
			__IO uint32_t SLPSS_PWRGATE_EN_N_ULP_MCUFSM   					:1 ;
	...
	/*0x20*/
	union {
		__IO uint32_t  MCUAON_KHZ_CLK_SEL_POR_RESET_STATUS;             /*!< none                                                                  */
		struct {
...
typedef struct {                                /*!< (@ 0x20210000) USBHS Structure                                            */
  ...
  union {
    __IOM uint32_t USB_PERIODICLISTBASE;        /*!< (@ 0x00000154) Frame List Base Address Register                           */
  ...
  union {
    ...
    __IOM uint32_t USB_ENDPOINTLISTADDR;        /*!< (@ 0x00000158) Address at Endpoint list in memory Register                */
  };
...
typedef struct {                                /*!< (@ 0x24043A14) OPAMP Structure                                            */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t OPAMP1_R1_SEL : 2;          /*!< [3..2] Programmability to select resister bank R1                         */
      __IOM uint32_t OPAMP1_R2_SEL : 3;         /*!< [6..4] Programmability to select resister bank R2                         */
      __IOM uint32_t OPAMP1_EN_RES_BANK : 1;    /*!< [7..7] enables the resistor bank 1 for enable 0 for disable               */
      __IOM uint32_t OPAMP1_RES_MUX_SEL : 3;    /*!< [10..8] selecting input for registor bank                                 */
      __IOM uint32_t OPAMP1_RES_TO_OUT_VDD : 1; /*!< [11..11] connect resistor bank to out or vdd i.e 0-out and 1-vdd          */
      ...
      __IOM uint32_t OPAMP1_OUT_MUX_SEL : 1;    /*!< [20..20] to connect opamp1 output to pad                                  */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t OPAMP2_LP_MODE : 1;        /*!< [1..1] select the power mode 0-normal mode and 1-low power mode           */
      __IOM uint32_t OPAMP2_R1_SEL : 2;         /*!< [3..2] Programmability to select resister bank R1                         */
      __IOM uint32_t OPAMP2_R2_SEL : 3;         /*!< [6..4] Programmability to select resister bank R2                         */
      __IOM uint32_t OPAMP2_EN_RES_BANK : 1;    /*!< [7..7] enables the resistor bank 1 for enable 0 for disable               */
      __IOM uint32_t OPAMP2_RES_MUX_SEL : 3;    /*!< [10..8] selecting input for registor bank                                 */
  ...
  union {
    ...
    struct {
      __IOM uint32_t OPAMP3_ENABLE : 1;         /*!< [0..0] enables the opamp3 1 for enable 0 for disable                      */
      __IOM uint32_t OPAMP3_LP_MODE : 1;        /*!< [1..1] select the power mode 0-normal mode and 1-low power mode           */
      __IOM uint32_t OPAMP3_R1_SEL : 2;         /*!< [3..2] Programmability to select resister bank R1                         */
      __IOM uint32_t OPAMP3_R2_SEL : 3;         /*!< [6..4] Programmability to select resister bank R2                         */
      __IOM uint32_t OPAMP3_EN_RES_BANK : 1;    /*!< [7..7] enables the resistor bank 1 for enable 0 for disable               */
      __IOM uint32_t OPAMP3_RES_MUX_SEL : 3;    /*!< [10..8] selecting input for registor bank                                 */
      __IOM uint32_t OPAMP3_RES_TO_OUT_VDD : 1; /*!< [11..11] connect resistor bank to out or vdd i.e 0-out and 1-vdd          */
...
typedef struct {
  union {
    ...
    struct {
      __IOM uint32_t CHANNEL_BITMAP : 32;       /*!< [31..0] This field explain the bit map for ADC channels                   */
...
typedef struct {                                /*!< (@ 0x24043800) AUX_ADC_DAC_COMP Structure                                 */
  ...
  union {
    ...
    struct {
      __IOM uint32_t ENDAC_FIFO_CONFIG : 1;     /*!< [0..0] This bit activates the DAC path in Aux ADC-DAC controller.
                                                     ...
                                                     is set.                                                                   */
      __IOM uint32_t DAC_STATIC_MODE : 1;       /*!< [1..1] This bit is used to select non-FIFO mode in DAC.                   */
      __IOM uint32_t DAC_FIFO_FLUSH : 1;        /*!< [2..2] This bit is used to flush the DAC FIFO.                            */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t ADC_STATIC_MODE : 1;       /*!< [1..1] This bit is used to select non-FIFO mode in ADC.                   */
      __IOM uint32_t ADC_FIFO_FLUSH : 1;        /*!< [2..2] This bit is used to flush the ADC FIFO                             */
      ...
      __IOM uint32_t ADC_MULTIPLE_CHAN_ACTIVE : 1;/*!< [6..6] This bit is used to control the auxadc sel signal going
                                                     to the Aux ADC.                                                           */
      __IOM uint32_t ADC_CH_SEL_MSB : 2;        /*!< [8..7] It is recommended to write these bits to 0                         */
  ...
  union {
    ...
    struct {
      __IOM uint32_t DAC_CLK_DIV_FAC : 10;      /*!< [9..0] These bits control the DAC clock division factor                   */
  ...
  union {
    ...
    struct {
      __IOM uint32_t ADC_CLK_DIV_FAC : 10;      /*!< [9..0] These bits control the Total-Duration of the ADC clock             */
      __IOM uint32_t RESERVED1  : 6;            /*!< [15..10] Reserved1                                                        */
      __IOM uint32_t ADC_CLK_ON_DUR : 9;        /*!< [24..16] These bits control the On-Duration of the ADC clock              */
  ...
  union {
    ...
    struct {
      __IOM uint32_t ADC_INPUT_DETECTION_THRESHOLD_0 : 8;/*!< [7..0] The value against which the ADC output has to be compared
      ...
      __IOM uint32_t ADC_INPUT_DETECTION_THRESHOLD_1 : 2;/*!< [13..12] Carries upper two bits of ADC detection threshold       */
  ...
  union {
    ...
    struct {
      __IOM uint32_t ADC_INPUT_DETECTION_THRESHOLD_2 : 8;/*!< [7..0] The value against which the ADC output has to be compared
                                                     is to be programmed  in this register.                                    */
      __IOM uint32_t COMP_LESS_THAN_EN : 1;     /*!< [8..8] When set, Aux ADC-DAC controller raises an interrupt
      ...
      __IOM uint32_t COMP_EQ_EN : 1;            /*!< [10..10] When set, Aux ADC-DAC controller raises an interrupt
                                                     ...
                                                     Aux ADC detection threshold.                                              */
      __IOM uint32_t ADC_DETECTION_THRESHOLD_2_UPPER_BITS : 2;/*!< [12..11] Upper 2 bits of ADC detection threshold 2          */
  ...
  union {
    ...
    struct {
      __IOM uint32_t THRESHOLD_DETECTION_INTR_EN : 1;/*!< [0..0] When Cleared, threshold detection interrupt will be unmasked  */
      __IOM uint32_t DAC_FIFO_EMPTY_INTR_MASK : 1;/*!< [1..1] When Cleared, dac_FIFO_empty interrupt will be unmasked          */
      __IOM uint32_t DAC_FIFO_AEMPTY_INTR_MASK : 1;/*!< [2..2] When Cleared, adc FIFO full interrupt will be unmasked          */
      __IOM uint32_t ADC_FIFO_FULL_INTR_MASK : 1;/*!< [3..3] When Cleared, adc FIFO full interrupt will be unmasked            */
      __IOM uint32_t ADC_FIFO_AFULL_INTR_MASK : 1;/*!< [4..4] When Cleared, adc FIFO afull interrupt will be unmasked          */
      __IOM uint32_t ADC_FIFO_OVERFLOW_INTR_MASK : 1;/*!< [5..5] When Cleared, dac FIFO underrun interrupt will be unmasked    */
      __IOM uint32_t DAC_FIFO_UNDERRUN_INTR_MASK : 1;/*!< [6..6] When Cleared, dac FIFO underrun interrupt will be unmasked    */
      __IOM uint32_t FIRST_MEM_SWITCH_INTR_MASK : 16;/*!< [22..7] When Cleared, first_mem_switch_intr will be unmasked         */
  ...
  union {
    ...
    struct {
      __IM  uint32_t ADC_THRESHOLD_DETECTION_INTR : 1;/*!< [0..0] This bit is set when ADC threshold matches with the programmed
  ...
  union {
    __IM  uint32_t INTR_MASKED_STATUS_REG;      /*!< (@ 0x0000002C) Interrupt masked status register                           */
    
    struct {
      __IM  uint32_t ADC_THRESHOLD_DETECTION_INTR_MASKED : 1;/*!< [0..0] Masked Interrupt. This bit is set when ADC threshold
                                                     matches with  the programmed conditions                                   */
      __IM  uint32_t DAC_FIFO_EMPTY_MASKED : 1; /*!< [1..1] Masked Interrupt.Set when DAC FIFO is empty                        */
      ...
      __IM  uint32_t ADC_FIFO_FULL_MASKED : 1;  /*!< [3..3] Masked Interrupt. Set when ADC FIFO is full.                       */
  ...
  union {
    ...
    struct {
      ...
      __IM  uint32_t DAC_FIFO_AFULL : 1;        /*!< [1..1] Set when DAC FIFO occupancy greater than FIFO threshold            */
      __IM  uint32_t ADC_FIFO_EMPTY : 1;        /*!< [2..2] Set when FIFO is empty. This bit gets cleared when the
                                                     ADC FIFO is not empty.                                                    */
      __IM  uint32_t ADC_FIFO_AEMPTY : 1;       /*!< [3..3] Set when the FIFO occupancy less than ADC FIFO threshold           */
      __IM  uint32_t DAC_FIFO_EMPTY : 1;        /*!< [4..4] Set when FIFO is empty. This bit gets cleared when the
                                                     DAC FIFO is not empty.                                                    */
      __IM  uint32_t DAC_FIFO_AEMPTY : 1;       /*!< [5..5] Set when the FIFO occupancy less than DAC FIFO threshold           */
      __IM  uint32_t ADC_FIFO_FULL : 1;         /*!< [6..6] Set when ADC FIFO is full. This bit gets cleared when
                                                     data is read from the FIFO.                                               */
      __IM  uint32_t ADC_FIFO_AFULL : 1;        /*!< [7..7] Set when ADC FIFO occupancy greater than ADC FIFO threshold.       */
      __IM  uint32_t RESERVED1  : 24;           /*!< [31..8] Reserved1                                                         */
    } FIFO_STATUS_REG_b;
  } ;
  __IM  uint32_t  RESERVED;
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t AUXADC_INP_SEL : 5;        /*!< [21..17] Mux select for positive input of adc                             */
      __IOM uint32_t AUXADC_INN_SEL : 4;        /*!< [25..22] Mux select for negetive input of adc                             */
      __IOM uint32_t AUXADC_DIFF_MODE : 1;      /*!< [26..26] AUX ADC Differential Mode select                                 */
  ...
  union {
    ...
    struct {
      __IOM uint32_t ADC_SEQ_CTRL_PING_PONG : 16;/*!< [15..0] To enable/disable per channel DAM mode (One-hot coding)          */
      __IOM uint32_t ADC_SEQ_CTRL_DMA_MODE : 16;/*!< [31..16] To enable/disable per channel ping-pong operation (One-hot
                                                     coding).                                                                  */
    } ADC_SEQ_CTRL_b;
  } ;
  ...
  union {
    __IOM uint32_t INTERNAL_DMA_CH_ENABLE;      /*!< (@ 0x000001DC) This register is internal channel enable                   */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t REFBUF_VOLT_SEL : 4;       /*!< [7..4] selection of voltage of reference buffer                           */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t CMP1_MUX_SEL_P : 4;        /*!< [7..4] Select for positive input of comparator_1                          */
      __IOM uint32_t CMP1_MUX_SEL_N : 4;        /*!< [11..8] Select for negative input of comparator_1                         */
      __IOM uint32_t CMP2_EN    : 1;            /*!< [12..12] To enable comparator 2                                           */
      __IOM uint32_t CMP2_EN_FILTER : 1;        /*!< [13..13] To enable filter for comparator 2                                */
      __IOM uint32_t CMP2_HYST  : 2;            /*!< [15..14] Programmability to control hysteresis of comparator2             */
      __IOM uint32_t CMP2_MUX_SEL_P : 4;        /*!< [19..16] Select for positive input of comparator_2                        */
      __IOM uint32_t CMP2_MUX_SEL_N : 4;        /*!< [23..20] Select for negative input of comparator_2                        */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t AUXADC_CONFIG_ENABLE : 1;  /*!< [11..11] Aux ADC Configuration Enable                                     */
...
typedef struct {                                /*!< (@ 0x24040C00) IR Structure                                               */
  ...
  union {
    ...
    struct {
      __IOM uint32_t IR_OFF_TIME_DURATION : 17; /*!< [16..0] This field define ir off time                                     */
  ...
  union {
    ...
    struct {
      __IOM uint32_t IR_ON_TIME_DURATION : 12;  /*!< [11..0] This field define ir on time for ir detection on                  */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t SREST_IR_CORE : 1;         /*!< [16..16] This bit is used soft reset IR core block                        */
  ...
  union {
    ...
    struct {
      __IM  uint32_t IR_MEM_DATA_OUT : 16;      /*!< [15..0] This field is used to IR Read data from memory.                   */
...
typedef struct {                                /*!< (@ 0x24042C00) CTS Structure                                              */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t CTS_STATIC_CLK_EN : 1;     /*!< (@ 0x0000000F) Enable static for capacitive touch sensor                  */
      __IOM uint32_t FIFO_AFULL_THRLD : 6;      /*!< (@ 0x00000010) Threshold for fifo afull                                   */
      __IOM uint32_t FIFO_AEMPTY_THRLD : 6;     /*!< (@ 0x00000016) Threshold for fifo aempty                                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t POLYNOMIAL_LEN : 2;        /*!< (@ 0x00000000) Length of polynomial                                       */
      ...
      __IOM uint32_t SOFT_RESET_2 : 1;          /*!< (@ 0x0000000A) Reset the FIFO write and FIFO read occupancy
                                                                    pointers                                                   */
      __IOM uint32_t CNT_ONEHOT_MODE : 1;       /*!< (@ 0x0000000B) Continuous or One hot mode                                 */
      __IOM uint32_t SAMPLE_MODE : 2;           /*!< (@ 0x0000000C) Select bits for FIFO write and FIFO average                */
      __IOM uint32_t RESET_WR_FIFO : 1;         /*!< (@ 0x0000000E) Resets the signal fifo_wr_int                              */
  ...
  union {
    ...
    struct {
      __IOM uint32_t PWM_ON_PERIOD : 16;        /*!< (@ 0x00000000) PWM ON period                                              */
      __IOM uint32_t PWM_OFF_PERIOD : 16;       /*!< (@ 0x00000010) PWM OFF period                                             */
  ...
  union {
    ...
    struct {
      __IOM uint32_t INTER_SENSOR_DELAY : 16;   /*!< (@ 0x00000000) Inter-sensor scan delay value                              */
      __IOM uint32_t N_SAMPLE_COUNT : 16;       /*!< (@ 0x00000010) Number of repetitions of sensor scan                       */
  ...
  union {
    ...
    struct {
      __IOM uint32_t VALID_SENSORS : 4;         /*!< (@ 0x00000000) Value of number of sensors valid in the bit map            */
      ...
      __IOM uint32_t WAKE_UP_THRESHOLD : 16;    /*!< (@ 0x00000010) Wakeup threshold.                                          */
...
typedef struct {                                /*!< (@ 0x20240000) ETH Structure                                              */
  ...
  __IOM uint32_t  MAC_HASH_TABLE_HIGH_REG;      /*!< (@ 0x00000008) ETHERNET REG                                               */
  __IOM uint32_t  MAC_HASH_TABLE_LOW_REG;       /*!< (@ 0x0000000C) ETHERNET REG                                               */
  ...
  __IM  uint32_t  RESERVED;
  __IOM uint32_t  MAC_REM_WAKEUP_FRAME_FILTER_REG;/*!< (@ 0x00000028) ETHERNET REG                                             */
  __IOM uint32_t  MAC_PMT_CTRL_STATUS_REG;      /*!< (@ 0x0000002C) ETHERNET REG                                               */
  __IM  uint32_t  RESERVED1[2];
  ...
  __IOM uint32_t  MMC_TX_UNDERFLOW_ERROR_REG;   /*!< (@ 0x00000148) ETHERNET REG                                               */
  __IOM uint32_t  MMC_TX_SINGLE_COL_REG;        /*!< (@ 0x0000014C) ETHERNET REG                                               */
  __IM  uint32_t  RESERVED4;
  __IOM uint32_t  MMC_TX_DEFFERED_REG;          /*!< (@ 0x00000154) ETHERNET REG                                               */
  __IM  uint32_t  RESERVED5[4];
  __IOM uint32_t  MMC_TX_FRAME_COUNT_G_REG;     /*!< (@ 0x00000168) ETHERNET REG                                               */
  __IM  uint32_t  RESERVED6[5];
  __IOM uint32_t  MMC_TX_FRAME_COUNT_GB_REG;    /*!< (@ 0x00000180) ETHERNET REG                                               */
  __IM  uint32_t  RESERVED7[4];
  __IOM uint32_t  MMC_RX_CRC_ERROR_REG;         /*!< (@ 0x00000194) ETHERNET REG                                               */
  __IM  uint32_t  RESERVED8[15];
  __IOM uint32_t  MMC_RX_FIFO_OVER_FLOW_REG;    /*!< (@ 0x000001D4) ETHERNET REG                                               */
  __IM  uint32_t  RESERVED9[906];
  __IOM uint32_t  DMA_BUS_MODE_REG;             /*!< (@ 0x00001000) Ethernet register                                          */
  __IOM uint32_t  DMA_TX_POLL_DEMAND_REG;       /*!< (@ 0x00001004) Ethernet register                                          */
  __IOM uint32_t  DMA_RX_POLL_DEMAND_REG;       /*!< (@ 0x00001008) Ethernet register                                          */
  __IOM uint32_t  DMA_RX_DESC_LIST_ADDR_REG;    /*!< (@ 0x0000100C) Ethernet register                                          */
  __IOM uint32_t  DMA_TX_DESC_LIST_ADDR_REG;    /*!< (@ 0x00001010) Ethernet register                                          */
  ...
  __IOM uint32_t  DMA_MISSED_FRAME_BOC_REG;     /*!< (@ 0x00001020) Ethernet register                                          */
  __IM  uint32_t  RESERVED10[9];
  __IOM uint32_t  DMA_CURRENT_HOST_TX_DESC_REG; /*!< (@ 0x00001048) Ethernet register                                          */
  __IOM uint32_t  DMA_CURRENT_HOST_RX_DESC_REG; /*!< (@ 0x0000104C) Ethernet register                                          */
  __IOM uint32_t  DMA_CURRENT_HOST_TX_BUFF_ADDR_REG;/*!< (@ 0x00001050) Ethernet register                                      */
  __IOM uint32_t  DMA_CURRENT_HOST_RX_BUFF_ADDR_REG;/*!< (@ 0x00001054) Ethernet register                                      */
...
typedef struct {                                /*!< (@ 0x24043400) VAD Structure                                              */
  ...
  union {
    ...
    struct {
      __IOM uint32_t SAMPLS_PER_FRAME : 10;     /*!< [9..0] Indicates the number of samples in one processing frame            */
      __IOM uint32_t THRESHOLD_MAG : 10;        /*!< [19..10] Indicates the magnitude threshold for the AMDF algorithm         */
      __IOM uint32_t SMPLS_PER_ADDR : 2;        /*!< [21..20] Indicates the bit width of the samples                           */
      __IOM uint32_t NORMALIZE_FRAME : 1;       /*!< [22..22] Normalize frame                                                  */
      __IOM uint32_t ENABLE_DC_REMOVAL : 1;     /*!< [23..23] enable dc removal                                                */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t THRESHOLD_SMPL_COLLECT : 10;/*!< [19..10] Indicates the threshold for energy of the samples               */
  ...
  union {
    ...
    struct {
      __IOM uint32_t THRESHOLD_ACF : 12;        /*!< [11..0] Energy threshold for ACF algorithm                                */
      __IOM uint32_t THRESHOLD_WACF : 12;       /*!< [23..12] Energy threshold for WACF algorithm                              */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t THRESHOLD_NULL_COUNT : 10; /*!< [21..12] Indicates the threshold for number of Null's for AMDF
                                                     algorithm to  detect Voice activity.                                      */
      __IOM uint32_t AMDF_BY_SQARING : 1;       /*!< [22..22] Enable or disable sqaring function for ADMF                      */
  ...
  union {
    ...
    struct {
      __IOM uint32_t START_DELAY_VAL : 10;      /*!< [9..0] Start delay used in ACF, WACF and AMDF algorithms                  */
      __IOM uint32_t END_DELAY_VAL : 10;        /*!< [19..10] End delay used in ACF, WACF and AMDF algorithms                  */
      __IOM uint32_t CHOOSE_VAD_METHOD : 3;     /*!< [22..20] Indicates the combination of Algorithms to be used
                                                     for Voice Activity Detection                                              */
      __IOM uint32_t DATA_SOURCE_SELECT : 2;    /*!< [24..23] Data source input select VAD peripheral                          */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t EN_VAD_PROCESS : 1;        /*!< [10..10] Enable vad process                                               */
  ...
  union {
    ...
    struct {
      ...
      __IOM uint32_t PONG_ADDR  : 13;           /*!< [26..14] Indicates the Start Address of Pong Memory containing
                                                     the VAD samples                                                           */
      __OM  uint32_t PING_INT_CLEAR : 1;        /*!< [27..27] clears the VAD interrupt on Ping Buffer samples                  */
      __OM  uint32_t PONG_INT_CLEAR : 1;        /*!< [28..28] clears the VAD interrupt on Pong Buffer samples                  */
  ...
  union {
    ...
    struct {
      __IOM uint32_t PROG_DC_REMOVAL : 12;      /*!< [11..0] 12 bit DC correction for ADC source                               */
      __IM  uint32_t            : 17;
      __IOM uint32_t RESERVED2  : 3;            /*!< [31..29] It is recommended to write these bits to 0                       */
    } VAD_CONF_REG10_b;
  } ;
...
typedef struct {                                /*!< (@ 0x20220000) SDIOH Structure                                            */
	...
	union {
		__IOM uint32_t SMIH_SDMA_SYSTEM_ADDRESS_REGISTER;/*!< (@ 0x00000000) SDMA System Address Register                          */

		struct {
			__IOM uint32_t SDMA_SYSTEM_ADDRESS_OR_ARGUMENT_2 : 32;/*!< [31..0] This register contains the physical system memory address
	...
	union {
		__IOM uint16_t SMIH_BLOCK_SIZE_REGISTER;    /*!< (@ 0x00000004) Block Size Register                                        */
		...
		struct {
			...
			__IOM uint16_t HOST_SDMA_BUFFER_BOUNDARY : 3;/*!< [14..12] Host Driver to update the SDMA System Address register.
	...
	union {
		__IOM uint16_t SMIH_BLOCK_COUNT_REGISTER;   /*!< (@ 0x00000006) Block Count Register                                       */

		struct {
			__IOM uint16_t BLOCK_COUNT_FOR_CURRENT_TRANSFER : 16;/*!< [15..0] This register is enabled when Block Count Enable in
	...
	union {
		__IOM uint32_t SMIH_ARGUMENT1_REGISTER;     /*!< (@ 0x00000008) argument 1 Register                                        */
	...
	union {
		__IOM uint16_t TRANSFER_MODE_REGISTER;      /*!< (@ 0x0000000C) Transfer Mode Register                                     */
		...
		struct {
			...
			__IOM uint16_t AUTO_CMD_ENABLE : 2;       /*!< [3..2] This field determines use of auto command functions.               */
			__IOM uint16_t DATA_TRANSFER_DIRECTION_SELECT : 1;/*!< [4..4] This bit defines the direction of DAT line data transfers.
			...
			__IOM uint16_t SPI_MODE_ENABLE : 1;       /*!< [12..12] Enable or disable SPI mode                                       */
			__IOM uint16_t BOOT_ACK_ENABLE : 1;       /*!< [13..13] Enable or disable boot ack                                       */
	...
	union {
		__IOM uint16_t SMIH_COMMAND_REGISTER;       /*!< (@ 0x0000000E) Command Register                                           */

		struct {
			__IOM uint16_t RESPONSE_TYPE_SELECT : 2;  /*!< [1..0] This register explain the response type select.                    */
			...
			__IOM uint16_t COMMAND_INDEX_CHECK_ENABLE : 1;/*!< [4..4] If this bit is set to 1, the SMIHC Controller shall check
	...
	union {
		__IOM uint32_t SMIH_PRESENT_STATE_REGISTER; /*!< (@ 0x00000024) Present State Register                                     */
		...
		struct {
			...
			__IM  uint32_t DAT_LINE_ACTIVE : 1;       /*!< [2..2] This bit indicates whether one of the DAT line on SD
                                                     Bus is in use.                                                            */
			__IM  uint32_t RE_TUNING_REQUEST : 1;     /*!< [3..3] Re-Tuning Request.                                                 */
			...
			__IM  uint32_t CARD_DETECT_PIN_LEVEL : 1; /*!< [18..18] This bit reflects the inverse value of the SDCD pin.Debouncing
	...
	union {
		__IOM uint8_t SMIH_HOST_CONTROL_1_REGISTER; /*!< (@ 0x00000028) Present State Register                                     */
		...
		struct {
			...
			__IOM uint8_t EXTENDED_DATA_TRANSFER_WIDTH : 1;/*!< [5..5] This bit controls 8-bit bus width mode for embedded device.
			...
			__IOM uint8_t CARD_DETECT_SIGNAL_SELECTION : 1;/*!< [7..7] This bit selects source for the card detection.               */
		} SMIH_HOST_CONTROL_1_REGISTER_b;
	} ;

	union {
		__IOM uint8_t SMIH_POWER_CONTROL_REGISTER;  /*!< (@ 0x00000029) Power Control Register                                     */
	...
	union {
		__IOM uint8_t SMIH_BLOCK_GAP_CONTROL_REGISTER;/*!< (@ 0x0000002A) Power Control Register                                   */

		struct {
			__IOM uint8_t STOP_AT_BLOCK_GAP_REQUEST : 1;/*!< [0..0] This bit is used to stop executing read and write transaction
	...
	union {   
		__IOM uint16_t SMIH_CLOCK_CONTROL_REGISTER; /*!< (@ 0x0000002C) Clock Control Register                                     */
		...
		struct {
			...
			__IOM uint16_t SD_CLOCK_ENABLE : 1;       /*!< [2..2] The SMIHC Controller shall stop SDCLK when writing this
                                                     bit to 0.                                                                 */
			__IOM uint16_t Reserved1  : 2;         /*!< [5..3] Reserved1                                                          */
			__IOM uint16_t UPPER_BITS_OF_SDCLK_FREQUENCY_SELECT : 2;/*!< [7..6] PE_SMIH Controller shall support these bits to expand
	...
	union {
		__IOM uint8_t SMIH_TIMEOUT_CONTROL_REGISTER;/*!< (@ 0x0000002E) Clock Control Register                                     */
	...
	union {
		__IOM uint8_t SMIH_SOFTWARE_RESET_REGISTER; /*!< (@ 0x0000002F) Software Reset Register                                    */
		...
		struct {
			...
			__IOM uint8_t SOFTWARE_RESET_FOR_CMD_LINE : 1;/*!< [1..1] Only part of command circuit is reset.                         */
	...
	union {
		__IOM uint16_t SMIH_NORMAL_INTERRUPT_STATUS_REGISTER;/*!< (@ 0x00000030) Normal Interrupt Status Register                  */
		...
		struct {
			...
			__IM  uint16_t RE_TUNING_EVENT : 1;       /*!< [12..12] This status is set if Re-Tuning Request in the Present
                                                     State register changes from 0 to 1.                                       */
			__IOM uint16_t BOOT_ACK_COMPLETE_INTERRUPT : 1;/*!< [13..13] This status is set if Re-Tuning Request in the Present
                                                     State register changes from 0 to 1.                                       */
			__IOM uint16_t BOOT_DONE_INTERRUPT : 1;   /*!< [14..14] boot acknowledge interrupt                                       */
			__IM  uint16_t ERROR_INTERRUPT : 1;       /*!< [15..15] If any of the bits in the RSI_SMIH_ERROR Interrupt Status register
                                                     are set, then this bit is set.                                            */
		} SMIH_NORMAL_INTERRUPT_STATUS_REGISTER_b;
	} ;

	union {  
		__IOM uint16_t SMIH_ERROR_INTERRUPT_STATUS_REGISTER;/*!< (@ 0x00000032) RSI_SMIH_ERROR Interrupt Status Register                    */
		...
		struct {
			...
			__IOM uint16_t COMMAND_CRC_ERROR : 1;     /*!< [1..1] Command CRC RSI_SMIH_ERROR is generated in two cases.                       */
	...
	union { 
		__IOM uint16_t SMIH_NORMAL_INTERRUPT_STATUS_ENABLE_REGISTER;/*!< (@ 0x00000034) Normal Interrupt Status Enable Register    */

		struct {
			__IOM uint16_t COMMAND_COMPLETE_STATUS_ENABLE : 1;/*!< [0..0] Command Complete Status Enable                             */
			__IOM uint16_t TRANSFER_COMPLETE_STATUS_ENABLE : 1;/*!< [1..1] Command Complete Status Enable                            */
			__IOM uint16_t BLOCK_GAP_EVENT_STATUS_ENABLE : 1;/*!< [2..2] Command Complete Status Enable                              */
			__IOM uint16_t DMA_INTERRUPT_STATUS_ENABLE : 1;/*!< [3..3] DMA Interrupt Status Enable                                   */
			__IOM uint16_t BUFFER_WRITE_READY_STATUS_ENABLE : 1;/*!< [4..4] DMA Interrupt Status Enable                              */
			__IOM uint16_t BUFFER_READ_READY_STATUS_ENABLE : 1;/*!< [5..5] Buffer read Ready Status Enable                           */
			__IOM uint16_t CARD_INSERTION_STATUS_ENABLE : 1;/*!< [6..6] Card Insertion Status Enable                                 */
			__IOM uint16_t CARD_REMOVAL_STATUS_ENABLE : 1;/*!< [7..7] Card Insertion Status Enable                                   */
			__IOM uint16_t CARD_INTERRUPT_STATUS_ENABLE : 1;/*!< [8..8] If this bit is set to 0, the SMIHC Controller shall clear
			...
			__IOM uint16_t BOOT_ACK_COMPLETE_INTERRUPT_STATUS_ENABLE : 1;/*!< [13..13] If this bit is set to 0, the SMIHC Controller shall
                                                     clear interrupt request to the System                                     */
			__IOM uint16_t BOOT_DONE_INTERRUPT_STATUS_ENABLE : 1;/*!< [14..14] Boot Done Interrupt Status Enable                     */
	...
	union { 
		__IOM uint16_t SMIH_ERROR_INTERRUPT_STATUS_ENABLE_REGISTER;/*!< (@ 0x00000036) RSI_SMIH_ERROR Interrupt Status Enable Register      */

		struct {
			__IOM uint16_t COMMAND_TIMEOUT_ERROR_STATUS_ENABLE : 1;/*!< [0..0] Command Timeout RSI_SMIH_ERROR Status Enable                   */
			__IOM uint16_t COMMAND_CRC_ERROR_STATUS_ENABLE : 1;/*!< [1..1] Command Timeout RSI_SMIH_ERROR Status Enable                       */
			__IOM uint16_t COMMAND_END_BIT_ERROR_STATUS_ENABLE : 1;/*!< [2..2] Command Timeout RSI_SMIH_ERROR Status Enable                   */
			__IOM uint16_t COMMAND_INDEX_ERROR_STATUS_ENABLE : 1;/*!< [3..3] Command Index RSI_SMIH_ERROR Status Enable                       */
			__IOM uint16_t DATA_TIMEOUT_ERROR_STATUS_ENABLE : 1;/*!< [4..4] Data Timeout RSI_SMIH_ERROR Status Enable                         */
			__IOM uint16_t DATA_CRC_ERROR_STATUS_ENABLE : 1;/*!< [5..5] Data Timeout RSI_SMIH_ERROR Status Enable                             */
			__IOM uint16_t DATA_END_BIT_ERROR_STATUS_ENABLE : 1;/*!< [6..6] Data End Bit RSI_SMIH_ERROR Status Enable                         */
			__IOM uint16_t CURRENT_LIMIT_ERROR_STATUS_ENABLE : 1;/*!< [7..7] Data End Bit RSI_SMIH_ERROR Status Enable                        */
			__IOM uint16_t AUTO_CMD_ERROR_STATUS_ENABLE : 1;/*!< [8..8] Auto CMD RSI_SMIH_ERROR Status Enable                                 */
			__IOM uint16_t ADMA_ERROR_STATUS_ENABLE : 1;/*!< [9..9] Auto CMD RSI_SMIH_ERROR Status Enable                                     */
			__IOM uint16_t TUNING_ERROR_STATUS_ENABLE : 1;/*!< [10..10] Tuning RSI_SMIH_ERROR Status Enable                                   */
			__IOM uint16_t Reserved1  : 5;            /*!< [15..11] Reserved1                                                        */
		} SMIH_ERROR_INTERRUPT_STATUS_ENABLE_REGISTER_b;
	} ;

	union { 
		__IOM uint16_t SMIH_NORMAL_INTERRUPT_SIGNAL_ENABLE_REGISTER;/*!< (@ 0x00000038) Normal Interrupt Signal Enable Register    */

		struct {
			__IOM uint16_t COMMAND_COMPLETE_SIGNAL_ENABLE : 1;/*!< [0..0] Command Complete Signal Enable                             */
			__IOM uint16_t TRANSFER_COMPLETE_SIGNAL_ENABLE : 1;/*!< [1..1] Command Complete Signal Enable                            */
			__IOM uint16_t BLCOK_GAP_EVENT_SIGNAL_ENABLE : 1;/*!< [2..2] Block Gap Event Signal Enable                               */
			__IOM uint16_t DMA_INTERRUPT_SIGNAL_ENABLE : 1;/*!< [3..3] DMA Interrupt Signal Enable                                   */
			__IOM uint16_t BUFFER_WRITE_READY_SIGNAL_ENABLE : 1;/*!< [4..4] Buffer Write Ready Signal Enable                         */
			__IOM uint16_t BUFFER_READ_READY_SIGNAL_ENABLE : 1;/*!< [5..5] Buffer read Ready Signal Enable                           */
			__IOM uint16_t CARD_INSERTION_SIGNAL__ENABLE : 1;/*!< [6..6] Card Insertion Signal Enable                                */
			__IOM uint16_t CARD_REMOVAL_SIGNAL__ENABLE : 1;/*!< [7..7] Card Insertion Signal Enable                                  */
			__IOM uint16_t CARD_INTERRUPT_SIGNAL_ENABLE : 1;/*!< [8..8] Card Interrupt Signal Enable                                 */
			__IOM uint16_t INT_A_SIGNAL_ENABLE : 1;   /*!< [9..9] INT_A Signal Enable                                                */
			__IOM uint16_t INT_B_SIGNAL_ENABLE : 1;   /*!< [10..10] INT_B Signal Enable                                              */
			__IOM uint16_t INT_C_SIGNAL_ENABLE : 1;   /*!< [11..11] INT_C Signal Enable                                              */
			__IOM uint16_t RE_TUNNING_EVENT_SIGNAL_ENABLE : 1;/*!< [12..12] Re-Tuning Event Signal Enable                            */
			__IM  uint16_t BOOT_ACK_COMPLETE_INTERRUPT_SIGNAL_ENABLE : 1;/*!< [13..13] Boot Ack Complete Interrupt Signal Enable     */
			__IM  uint16_t BOOT_DONE_INTERRUPT_SIGNAL_ENABLE : 1;/*!< [14..14] Boot Ack Complete Interrupt Signal Enable             */
			__IM  uint16_t FIXED_TO_0 : 1;            /*!< [15..15] The Host Driver shall control error interrupts  using
	...
	union { 
		__IOM uint16_t SMIH_ERROR_INTERRUPT_SIGNAL_ENABLE_REGISTER;/*!< (@ 0x0000003A) RSI_SMIH_ERROR Interrupt Signal Enable Register      */

		struct {
			__IOM uint16_t COMMAND_TIMEOUT_ERROR_SIGNAL_ENABLE : 1;/*!< [0..0] Command Timeout RSI_SMIH_ERROR Signal Enable                   */
			__IOM uint16_t COMMAND_CRC_ERROR_SIGNAL_ENABLE : 1;/*!< [1..1] Command CRC RSI_SMIH_ERROR Signal Enable                           */
			__IOM uint16_t COMMAND_END_BIT_ERROR_SIGNAL_ENABLE : 1;/*!< [2..2] Command End Bit Signal Enable                         */
			__IOM uint16_t COMMAND_INDEX_ERROR_SIGNAL_ENABLE : 1;/*!< [3..3] Command Index Signal Enable                             */
			__IOM uint16_t DATA_TIMEOUT_ERROR_SIGNAL_ENABLE : 1;/*!< [4..4] Data Timeout RSI_SMIH_ERROR Signal Enable                         */
			__IOM uint16_t DATA_CRC_ERROR_SIGNAL_ENABLE : 1;/*!< [5..5] Data CRC RSI_SMIH_ERROR Signal Enable                                 */
			__IOM uint16_t DATA_END_BIT_ERROR_SIGNAL_ENABLE : 1;/*!< [6..6] Data CRC RSI_SMIH_ERROR Signal Enable                             */
			__IOM uint16_t CURRENT_LIMIT_ERROR_SIGNAL_ENABLE : 1;/*!< [7..7] Data CRC RSI_SMIH_ERROR Signal Enable                            */
			__IOM uint16_t AUTO_CMD_ERROR_SIGNAL_ENABLE : 1;/*!< [8..8] Auto CMD RSI_SMIH_ERROR Signal Enable                                 */
			__IOM uint16_t ADMA_ERROR_SIGNAL_ENABLE : 1;/*!< [9..9] ADMA RSI_SMIH_ERROR Signal Enable                                         */
			__IOM uint16_t TUNING_ERROR_SIGNAL_ENABLE : 1;/*!< [10..10] Tuning RSI_SMIH_ERROR Signal Enable                                   */
			__IOM uint16_t RESERVED1  : 5;            /*!< [15..11] reserved1                                                        */
		} SMIH_ERROR_INTERRUPT_SIGNAL_ENABLE_REGISTER_b;
	} ;

	union {
		__IM  uint16_t SMIH_AUTO_CMD_ERROR_STATUS_REGISTER;/*!< (@ 0x0000003C) Auto CMD RSI_SMIH_ERROR Status Register                      */
		...
		struct {
			...
			__IM  uint16_t COMMAND_NOT_ISSUED_BY_AUTO_CMD12_ERROR : 1;/*!< [7..7] Setting this bit to 1 means CMD_wo_DAT is not executed
	...
	union { 
		__IOM uint16_t SMIH_HOST_CONTROL_2_REGISTER;/*!< (@ 0x0000003E) Host Control 2 Register                                    */
		...
		struct {
			...
			__IOM uint16_t _1_8V_SIGNALING_ENABLE : 1; /*!< [3..3] This bit controls voltage regulator for I/O cell. 3.3V
                                                     ...
                                                     from 3.3V to 1.8V.                                                        */
			__IOM uint16_t DRIVER_STRENGTH_SELECT : 2;/*!< [5..4] SMIHC Controller output driver in 1.8V signaling is selected
			...
			__IOM uint16_t ASYNCHRONOUS_INTERRUPT_ENABLE : 1;/*!< [14..14] This bit can be set to 1 if a card that supports asynchronous
	...
	union {
		__IM  uint32_t SMIH_ADMA_ERROR_STATUS_REGISTER;/*!< (@ 0x00000054) ADMA RSI_SMIH_ERROR Status Register                              */
		...
		struct {
			...
			__IM  uint32_t ADMA_LENGHT_MISMATCH_ERROR : 1;/*!< [2..2] While Block Count Enable being set, the total data length
	...
	union {
		__IM  uint16_t SMIH_PRESET_VALUE_REGISTER[8];/*!< (@ 0x00000060) Preset Value for Initialization register                  */
		...
		struct {
			...
			__IM  uint16_t UPPER_BIT_OF_DRIVER_STRENGTH_SELECT : 1;/*!< [13..13] This bit reflects the SMIH_DRIVE_STRENGTH2  in association
	...
	union {
		__IOM uint32_t SMIH_TX_TUNE_REGISTER;       /*!< (@ 0x000000E0) Tx Tune Register                                           */

		struct {
			__IOM uint32_t TAP_POINT_VALUE : 6;       /*!< [5..0] Tap point value                                                    */
			__IOM uint32_t AUTO_INCREMENT : 1;        /*!< [6..6] Increment locally or not.                                          */
	...
	union {
		__IOM uint32_t SMIH_RX_TUNE_REGISTER;       /*!< (@ 0x000000E4) Rx Tune Register                                           */
	...
	union {
		__IOM uint32_t SMIH_DS_TUNE_REGISTER;       /*!< (@ 0x000000E8) Ds Tune Register                                           */
	...
	union {
		__IOM uint16_t SMIH_AHB_BURST_SIZE_REGISTER;/*!< (@ 0x000000EC) AHB Burst Size Register                                    */

		struct {
			__IOM uint16_t AHB_MASTER_BURST_SIZE_REGISTER : 7;/*!< [6..0] AHB Master performs Burst operations as per this register.
	...
	union {
		__IM  uint32_t SMIH_SDH_REVISION_ID_REGISTER;/*!< (@ 0x000000F4) SDH Revision ID Register                                  */
	...
	union {
		__IOM uint16_t SMIH_SLOT_INTERRUPT_STATUS_REGISTER;/*!< (@ 0x000000FC) Slot Interrupt Status Register                      */
	...
	union {
		__IM  uint16_t SMIH_HOST_CONTROLLER_VERSION_REGISTER;/*!< (@ 0x000000FE) Slot Interrupt Status Register                    */

		struct {
			__IM  uint16_t SPECIFICATION_VERSION_NUMBER : 8;/*!< [7..0] This status indicates the Host Controller Spec Version,The
