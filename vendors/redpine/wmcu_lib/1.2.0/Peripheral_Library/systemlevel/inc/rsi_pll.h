 ...
 *
 * @brief This file contains functions prototypes related to PLL  peripheral
 *
 * @section Description
 * This file contains the list of function prototypes for the PLL and low level function definitions
...
#define SD_MEM_INTF_CLK_ENABLE            BIT(29)           /*  Static Clock gating Enable for sd_mem_intf clk1'b1 => Clock is enabled1'b0 => Invalid*/
...
error_t clk_qspi_clk_config(M4Clk_Type *pCLK ,QSPI_CLK_SRC_SEL_T clkSource,boolean_t swalloEn,boolean_t OddDivEn,uint32_t divFactor);

error_t clk_usart_clk_config(M4Clk_Type *pCLK ,CLK_ENABLE_T clkType,boolean_t FracDivEn ,EN_USART_T enUsart,USART_CLK_SRC_SEL_T clkSource,uint32_t divFactor);
