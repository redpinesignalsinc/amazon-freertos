 ...
 *
 * @brief This files contains functions prototypes related to ULPSS clock
 *
 * @section Description
 * This file contains the list of function prototypes for the ULPSS clock and low level function definitions
