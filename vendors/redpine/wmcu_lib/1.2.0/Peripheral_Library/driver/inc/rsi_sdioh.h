 ...
 *
 * @brief This files contains functions prototypes related to SMIH Master
 *
 * @section Description
 * This file contains the list of function prototypes for the SMIH Master and low level function definitions
...
#define ENABLE_HIGH_SPEED_MODE_ARG (0x80002602)    //SDIO_CMD52 ARG(CCR REG OFFSET IS 0X13 IE:13 LEFT SHIF BY 9,HERE 9 MEANS 8 BITS DATA AND 1 BIT STUFF IN CMD 52(SETTING BIT 1 IN 13TH PFFSET))

#define CHECK_UHS_SUPPORT_MODES   (0x00002800)    //SDIO_CMD52 ARG(CCR REG OFFSET IS 0X14 IE:14 LEFT SHIF BY 9,HERE 9 MEANS 8 BITS DATA AND 1 BIT STUFF IN CMD 52) (CHECK ARGMENT)
#define UHS_1_SDR25_MODE_ARG      (0x80002602)    //SDIO_CMD52 ARG(CCR REG OFFSET IS 0X13 IE:13 LEFT SHIF BY 9,HERE 9 MEANS 8 BITS DATA AND 1 BIT STUFF IN CMD 52(SETTING BIT 1 IN 13TH PFFSET))
