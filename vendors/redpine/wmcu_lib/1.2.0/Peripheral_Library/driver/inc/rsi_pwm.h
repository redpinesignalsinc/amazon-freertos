 ...
 *
 * @brief This files contains functions prototypes releated to PWM peripheral
 * 
 * @section Description
 * This file contains the list of function prototypes for the PWM and low level function definations 
...
#define   RSI_MCPWM_EVENT_RISE_TIME_PERIOD_MATCH_CH0		(1UL << 0)  /*!< Time base match for 0th channel without considering postscaler */			     
...
#define   RSI_MCPWM_EVENT_RISE_TIME_PERIOD_MATCH_CH1        (1UL << 4)  /*!< Time base match for 1st channel without considering postscaler */
#define   RSI_MCPWM_EVENT_TIME_PERIOD_MATCH_CH1			    (1UL << 5)  /*!< Time base match for  1st channel which considering postscaler 	*/
#define   RSI_MCPWM_EVENT_RISE_TIME_PERIOD_MATCH_CH2        (1UL << 6)  /*!< Time base match for 2nd channel without considering postscaler */
#define   RSI_MCPWM_EVENT_TIME_PERIOD_MATCH_CH2			    (1UL << 7)  /*!< Time base match for 2nd channel which considering postscaler 	*/
#define   RSI_MCPWM_EVENT_RISE_TIME_PERIOD_MATCH_CH3        (1UL << 8)  /*!< Time base match for 3rd channel without considering postscaler */
#define   RSI_MCPWM_EVENT_TIME_PERIOD_MATCH_CH3			    (1UL << 9)  /*!< Time base match for 3rd channel without considering postscaler	*/
 ...
 */
STATIC INLINE error_t RSI_MCPWM_ReadCounter( RSI_MCPWM_T *pMCPWM,
                                             uint16_t *counterVal,
                                             uint8_t chnlNum )
{
 ...
 */
STATIC INLINE error_t RSI_MCPWM_GetCounterDir( RSI_MCPWM_T *pMCPWM,
                                               uint8_t *counterDir,
                                               uint8_t chnlNum )
{
 ...
 * @return 		  none
 */
STATIC INLINE void RSI_MCPWM_DeadTimeEnable( RSI_MCPWM_T *pMCPWM,
                                             uint32_t flag )	
{	
 ...
 * @return 		  none
 */
STATIC INLINE void RSI_MCPWM_DeadTimeDisable( RSI_MCPWM_T *pMCPWM ,
                                              uint32_t flag )	
{
 ...
 * @return 		  none
 */
STATIC INLINE void RSI_MCPWM_InterruptClear( RSI_MCPWM_T *pMCPWM, 
                                             uint32_t clrFlag )
{		
 ...
 * @return 		  none
 */
STATIC INLINE void RSI_MCPWM_InterruptDisable( RSI_MCPWM_T *pMCPWM, 
                                               uint16_t flag )
{
 ...
 */
STATIC INLINE uint16_t RSI_PWM_GetInterruptStatus( RSI_MCPWM_T *pMCPWM, 
                                                   uint16_t flag )
{	
 ...
 */
STATIC INLINE error_t RSI_MCPWM_DutyCycleControlSet( RSI_MCPWM_T *pMCPWM,
                                                     uint32_t value,
                                                     uint8_t chnlNum )
{
 ...
 * @return 	    \ref ERROR_PWM_INVALID_CHNLNUM : If channel number is invalid
                \n \ref RSI_OK                 : If process is done successfully.
 */
STATIC INLINE error_t RSI_MCPWM_DutyCycleControlReset( RSI_MCPWM_T *pMCPWM,
                                                       uint32_t value,
																				               uint8_t chnlNum )
{
	if(chnlNum <= PWM_CHNL_3)
 ...
 * @return 		  none	
 */
STATIC INLINE void RSI_MCPWM_OverrideControlSet( RSI_MCPWM_T *pMCPWM, 
                                                 uint32_t value )
{
 ...
 * @return 	  	\ref ERROR_PWM_INVALID_ARG : If pwmOutput value is invalid
                \n \ref RSI_OK             : If process is done successfully.
 */
 STATIC INLINE error_t RSI_MCPWM_OverrideValueReSet( RSI_MCPWM_T *pMCPWM,
                                                     uint8_t pwmOutput,
																			               uint8_t value )
{
	if(pwmOutput <= PWM_OUTPUT_MAX)
 ...
 * @return 		  none
 */
STATIC INLINE void RSI_MCPWM_FaultControlSet( RSI_MCPWM_T *pMCPWM, 
                                              uint32_t value )
{
 ...
 * @return 		  none
 */
STATIC INLINE void RSI_MCPWM_FaultControlReSet( RSI_MCPWM_T *pMCPWM, 
                                                uint32_t value )
{
 ...
 * @return 		  none
 */
STATIC INLINE void RSI_MCPWM_DeadTimeControlSet( RSI_MCPWM_T *pMCPWM, 
                                                 uint32_t value )
{
 ...
 * @return 		  none
 */
STATIC INLINE void RSI_MCPWM_DeadTimeControlReSet( RSI_MCPWM_T *pMCPWM, 
                                                   uint32_t value )
{
 ...
 * @return 		  none 
 */
STATIC INLINE void RSI_MCPWM_ExternalTriggerControl( RSI_MCPWM_T *pMCPWM, 
                                                     boolean_t enable )
{
...
error_t mcpwm_counter_reset( RSI_MCPWM_T *pMCPWM, 
                                uint8_t chnlNum );

error_t mcpwm_channel_reset( RSI_MCPWM_T *pMCPWM,
                                uint8_t chnlNum );

error_t mcpwm_start( RSI_MCPWM_T *pMCPWM , 
                         uint8_t chnlNum );

error_t mcpwm_stop( RSI_MCPWM_T *pMCPWM , 
                        uint8_t chnlNum );

error_t mcpwm_set_time_period( RSI_MCPWM_T *pMCPWM, 
                                 uint8_t chnlNum, 
																 uint16_t period, 
                                 uint16_t initVal );
...
error_t mcpwm_dead_time_value_set( RSI_MCPWM_T *pMCPWM , 
                                    RSI_MCPWM_DT_CONFIG_T *pMCPWMDeadTimeConfig,
																	  uint8_t chnlNum );																	 
error_t mcpwm_fault_avalue_set( RSI_MCPWM_T *pMCPWM,
                                  uint8_t pwmOutput,
																	uint8_t value );
																	
error_t mcpwm_fault_bvalue_set( RSI_MCPWM_T *pMCPWM,
                                  uint8_t pwmOutput,
																	uint8_t value);

error_t mcpwm_set_base_timer_mode( RSI_MCPWM_T *pMCPWM,
                                    uint8_t mode,	
																	  uint8_t chnlNum );
																		
error_t mcpwm_set_output_mode( RSI_MCPWM_T *pMCPWM, 
                                 boolean_t mode, 
                                 uint8_t chnlNum );
...
error_t mcpwm_period_control_config( RSI_MCPWM_T *pMCPWM,
                                       uint32_t postScale,
                                       uint32_t preScale,
                                       uint8_t chnlNum );
