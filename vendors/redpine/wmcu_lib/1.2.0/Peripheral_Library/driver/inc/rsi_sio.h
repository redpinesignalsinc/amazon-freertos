...
typedef enum en_sio_spi_states{
	SioSpiIdle,
	SioSpiBusy,
	SioSpiTrasmitDone
}en_sio_spi_states_t;
...
typedef enum en_sio_i2s_events{
	SioI2sTxDone,
	SioI2sRxDone
}en_sio_i2s_events_t;
...
typedef enum en_sio_spi_events{
	SioSpiTxDone,
	SioSpiRxDone
}en_sio_spi_events_t;
...
typedef enum en_i2s_audio_depth{
	i2sAudioDepth16Bit,
	i2sAudioDepth32Bit
}en_i2s_audio_depth_t;
...
uint16_t RSI_SIO_UartFramePrepare(uint8_t u8StopBits  , uint16_t u16Data ,
