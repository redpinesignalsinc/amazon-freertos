 ...
 * @return 		  none
 */ 
STATIC INLINE void RSI_CT_StartEventConfig( RSI_CT_T *pCT,
                                            uint32_t andValue, 
                                            uint32_t orValue )	
{																							
 ...
 * @return 		  none
 */ 
STATIC INLINE  void RSI_CT_StopEventConfig( RSI_CT_T *pCT,
                                            uint32_t andValue, 
                                            uint32_t orValue )	
{		
 ...
 * @return 		  none
 */
STATIC INLINE  void RSI_CT_ContinueEventConfig( RSI_CT_T *pCT,
                                                uint32_t andValue,
                                                uint32_t orValue )	
{		
 ...
 * @return 		  none
 */ 
STATIC INLINE  void RSI_CT_HaltEventConfig( RSI_CT_T *pCT,
                                            uint32_t andValue, 
                                            uint32_t orValue )	
{		
 ...
 * @return 		  none
 */ 
STATIC INLINE  void RSI_CT_IncrementEventConfig( RSI_CT_T *pCT,uint32_t andValue,
                                   uint32_t orValue)	
{		
 ...
 * @return 		  none
*/
STATIC INLINE  void RSI_CT_CaptureEventConfig( RSI_CT_T *pCT, 
                                               uint32_t andValue,
                                               uint32_t orValue )	
{		
 ...
 * @return 		  none
 */
STATIC INLINE  void RSI_CT_InterruptEventConfig( RSI_CT_T *pCT, 
                                                 uint32_t andValue,
	                                               uint32_t orValue )	
{		
 ...
 * @return 		  none
 */ 
STATIC INLINE  void RSI_CT_OutputEventConfig( RSI_CT_T *pCT, 
                                              uint32_t andValue,
                                              uint32_t orValue )	
{		
 ...
 * @return 		  none
 */ 
STATIC INLINE  void RSI_CT_StopEventSelect( RSI_CT_T *pCT, 
                                            uint32_t value )	
{
 ...
 * @return 		  none
 */ 
STATIC INLINE  void RSI_CT_ContinueEventSelect( RSI_CT_T *pCT, 
                                                uint32_t value )	
{
 ...
 * @return 		  none
 */ 
STATIC INLINE  void RSI_CT_HaltEventSelect( RSI_CT_T *pCT, 
                                            uint32_t value )	
{
 ...
 * @return 		  none 
 */ 
STATIC INLINE  void RSI_CT_IncrementEventSelect( RSI_CT_T *pCT, 
                                                 uint32_t value )	
{
 ...
 * @return 		  none
 */ 
STATIC INLINE  void RSI_CT_CaptureEventSelect( RSI_CT_T *pCT,
                                               uint32_t value )	
{
 ...
 * @return 		  none 
 */ 
STATIC INLINE  void RSI_CT_OutputEventSelect( RSI_CT_T *pCT,
                                              uint32_t value )	
{
 ...
 * @return 		  none 
 */ 
STATIC INLINE  void RSI_CT_InterruptEventSelect( RSI_CT_T *pCT,
                                                 uint32_t value )	
{
 ...
 * @return 		  none
 */ 
STATIC INLINE  void RSI_CT_OutputEventADCTrigger( RSI_CT_MUX_REG_T *pCTmux,
																	                uint8_t output1,
                                                  uint8_t output2 )
{	 
 ...
 * @return 		  none               
 */ 
STATIC INLINE void RSI_CT_SetTimerMuxSelect( RSI_CT_MUX_REG_T *pCTMux, 
                                             uint8_t timerIns )
{
 ...
 * @return 		  none               
 */ 
STATIC INLINE void RSI_CT_ResumeHaltEvent( RSI_CT_T *pCT,
 ...
 * @return 		  none
 */
STATIC INLINE void RSI_CT_PeripheralReset( RSI_CT_T *pCT, 
                                           boolean_t counterNum )
{
  if(counterNum)
  {
 ...
 * @return 		  none
 */ 
STATIC INLINE void RSI_CT_StartSoftwareTrig( RSI_CT_T *pCT, 
                                             boolean_t counterNum )
{
 ...
 * @return 		  none
 */ 
STATIC INLINE void RSI_CT_OCUModeSet( RSI_CT_T *pCT, 
                                      boolean_t counterNum )
{
  if(counterNum)
  {
 ...
 * @return 		  none
 */ 
STATIC INLINE  void RSI_CT_SetMatchCount( RSI_CT_T *pCT, uint32_t value, 
                                          boolean_t counterMode, 
                                          boolean_t counterNum ) 
{  
  if(counterMode == 0)
  {
 ...
 */ 
STATIC INLINE uint16_t RSI_CT_CaptureRead( RSI_CT_T *pCT,
                                           boolean_t counterNum )
{
  if(counterNum)
  {
 ...
 */ 
STATIC INLINE uint32_t RSI_CT_GetCounter( RSI_CT_T *pCT,
                                          boolean_t counterNum,
                                          boolean_t mode )
{
	if(mode)
 ...
 * @return 		  none 
 */ 
STATIC INLINE void RSI_CT_SetCounerSync( RSI_CT_T *pCT, 
                                         uint8_t syncCounter, 
                                         boolean_t counterNum )
{
	if(counterNum)
