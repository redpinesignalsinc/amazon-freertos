 ...
 *
 * @brief This files contains functions prototypes releated to EFUSE peripheral
 * 
 * @section Description
 * This file contains the list of function prototypes for the EFUSE and low level function definations 
