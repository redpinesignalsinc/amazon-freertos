...
void RSI_CTS_ClkSelection(CTS_Type *cts,uint8_t clk_sel_1,
	                        uint8_t clk_sel_2,
...
void RSI_CTS_ConfigPolynomial( CTS_Type *cts,boolean_t enable,
	                             uint8_t poly_length,uint32_t seed,
                               uint32_t polynomial );
...
void RSI_CTS_ConfigRefVoltage(CTS_Type *cts,int16_t ref_voltage,
	                            boolean_t enable,uint16_t *samples,
                              uint16_t *avg_samples);

void RSI_CTS_ConfigWakeUp(CTS_Type *cts,uint8_t mode,
	                        uint16_t threshold);
