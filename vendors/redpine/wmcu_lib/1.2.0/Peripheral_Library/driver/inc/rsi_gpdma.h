 ...
 *
 * @brief This files contains functions prototypes and macro releated to GPDMA peripheral
 * 
 * @section Description 
 * This file contains the list of function prototypes for the GPDMA and low level function definations 
...
typedef void (*gpdmaTransferDescFetchCompleteCB)(RSI_GPDMA_HANDLE_T gpdmaHandle, RSI_GPDMA_DESC_T *pTranDesc, uint32_t dmaCh);
...
error_t gpdma_abort_channel( RSI_GPDMA_HANDLE_T pHandle,
                                uint8_t dmaCh );
...
error_t gpdma_setup_channelTransfer( RSI_GPDMA_HANDLE_T pHandle, 
                                        uint8_t dmaCh, 
                                        RSI_GPDMA_DESC_T *pDesc );
...
error_t gpdma_dma_channel_trigger( RSI_GPDMA_HANDLE_T pHandle ,
                                     uint8_t dmaCh );


uint32_t gpdma_channel_is_enabled( RSI_GPDMA_HANDLE_T pHandle ,
                                     uint8_t dmaCh );
