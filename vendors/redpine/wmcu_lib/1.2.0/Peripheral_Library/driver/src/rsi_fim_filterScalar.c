 ...
 *@brief This files contains functions prototypes related to FIM filter scale
 */
...
/**
 *@brief      This API is used to set sat trunc values to FIM module for corresponding inputs 
 ...
 *@return       none
 */
void rsi_fim_Iir_init_f32( fim_iir_instance_f32 *S,uint16_t numStages, int32_t *pCoeffs,int32_t *pvCoeffs,int32_t *pState)
{
	/* Assign filter taps */
 ...
 *@return     none
 */
void rsi_fim_Iir_f32(fim_iir_instance_f32 *S,int32_t *pSrc,int32_t *pDst,uint32_t blockSize,uint16_t inBank1, uint16_t inBank2, uint16_t outBank)
{
 ...
 *@return       none
 **/
void rsi_fim_Iir_init_q31( fim_iir_instance_q31 *S,uint16_t numStages, q31_t *pCoeffs,q31_t *pvCoeffs,uint32_t *pState)
{
	/* Assign filter taps */
	S->numStages = numStages;
	/* Assign coefficient pointer */
 ...
 *@return     none
 */
void rsi_fim_Iir_q31(fim_iir_instance_q31 *S, int32_t *pSrc,q31_t *pDst,uint32_t blockSize,uint16_t inBank1, uint16_t inBank2, uint16_t outBank)
{
...
void rsi_fim_Iir_q15(fim_iir_instance_q15 *S,q15_t *pSrc,q15_t *pDst,uint32_t blockSize, typ_data_t typ_data,uint16_t inBank1, uint16_t inBank2, uint16_t outBank)
{
	uint32_t i;
