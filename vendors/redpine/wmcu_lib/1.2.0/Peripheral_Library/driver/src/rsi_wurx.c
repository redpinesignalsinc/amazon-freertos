 ...
 *
 * @brief This files contains functions related to WURX peripheral
 * 
 * @section Description
 * This file contains the list of function definations for the WURX
...
void RSI_IPMU_DCCalib()
{
  ...
  uint32_t cntr =0;
	...
	WURX_COMP_OFFSET_CALIB_REG |= (( VAL1 << POS10) | 
	                                ( DC_OFFSET_VALUE << POS3 )|
	                                ( VAL2 << POS1));              
