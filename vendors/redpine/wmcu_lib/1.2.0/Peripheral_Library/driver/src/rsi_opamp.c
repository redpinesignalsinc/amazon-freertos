 ...
 *
 *  @brief This file contains APIs related to OPAMP
 *
 *  @section Description
 *  This file contains APIs to program all features of OPAMP peripheral 
 *
 *
 */
 ...
 * @return      none
 */
void RSI_OPAMP1_UGB(uint8_t vin_p_sel,uint8_t enable,uint8_t lp_mode,
	                  uint8_t out_mux_en,uint8_t out_mux_sel,
		                uint8_t dyn_en,uint8_t channel)
{
 ...
 * @return      none
 */
void RSI_OPAMP2_UGB(uint8_t vin_p_sel,uint8_t enable,uint8_t lp_mode,
	                  uint8_t out_mux_en,uint8_t dyn_en,uint8_t channel)
{
	OPAMP_CONFIG_T Config;
 ...
 * @return      none
 */
void RSI_OPAMP3_UGB(uint8_t vin_p_sel,uint8_t enable,uint8_t lp_mode,
	                  uint8_t out_mux_en,uint8_t dyn_en,uint8_t channel)
{
	OPAMP_CONFIG_T Config;
 ...
 * @return      none
 */
void RSI_OPAMP1_TIA(uint8_t vref_sel,uint8_t iin_sel,uint8_t enable,uint8_t lp_mode,
		                uint8_t r2_sel,uint8_t out_mux_en,uint8_t out_mux_sel,uint8_t dyn_en,
                    uint8_t channel)
{
	OPAMP_CONFIG_T Config;
	Config.opamp1.opamp1_dyn_en    = dyn_en;
 ...
 * @return      none
 */
void RSI_OPAMP2_TIA(uint8_t vref_sel,uint8_t iin_sel,uint8_t enable,uint8_t lp_mode,
		                uint8_t r2_sel,uint8_t out_mux_en,uint8_t dyn_en,uint8_t channel)
{
	OPAMP_CONFIG_T Config;
	Config.opamp2.opamp2_dyn_en    = dyn_en;
 ...
 * @return      none
 */
void RSI_OPAMP3_TIA(uint8_t vref_sel,uint8_t iin_sel,uint8_t enable,uint8_t lp_mode,
		                uint8_t r2_sel,uint8_t out_mux_en,uint8_t dyn_en,uint8_t channel)
{
	OPAMP_CONFIG_T Config;
	Config.opamp3.opamp3_dyn_en     = dyn_en;
 ...
 * @return      none
 */
void RSI_OPAMP1_InvPGA(uint8_t vref_sel,uint8_t vin_sel,uint8_t enable,uint8_t lp_mode,
		                   uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t out_mux_sel,
                       uint8_t dyn_en,uint8_t channel)
{
	OPAMP_CONFIG_T Config;
	Config.opamp1.opamp1_dyn_en    = dyn_en;
 ...
 * @return      none
 */
void RSI_OPAMP2_InvPGA(uint8_t vref_sel,uint8_t vin_sel,uint8_t enable,uint8_t lp_mode,
		                   uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t dyn_en,
                       uint8_t channel)
{
	OPAMP_CONFIG_T Config;
	Config.opamp2.opamp2_dyn_en    = dyn_en;
 ...
 * @return      none
 */
void RSI_OPAMP3_InvPGA(uint8_t vref_sel,uint8_t vin_sel,uint8_t enable,uint8_t lp_mode,
		                   uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t dyn_en,
                       uint8_t channel)
{
	OPAMP_CONFIG_T Config;
 ...
 * @return      none
 */
void RSI_OPAMP1_NonInvPGA(uint8_t vin_sel,uint8_t vref_sel,uint8_t enable,uint8_t lp_mode,
		                      uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t out_mux_sel,
                          uint8_t dyn_en,uint8_t channel)
{
	OPAMP_CONFIG_T Config;
 ...
 * @return      none
 */
void RSI_OPAMP2_NonInvPGA(uint8_t vin_sel,uint8_t vref_sel,uint8_t enable,uint8_t lp_mode,
		                      uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t dyn_en,
                          uint8_t channel)
{
	OPAMP_CONFIG_T Config;
 ...
 * @return      none
 */
void RSI_OPAMP3_NonInvPGA(uint8_t vin_sel,uint8_t vref_sel,uint8_t enable,uint8_t lp_mode,
		                      uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t dyn_en,
                          uint8_t channel)
{
	OPAMP_CONFIG_T Config;
 ...
 * @return      none
 */
void RSI_OPAMP1_InvCMP(uint8_t vin_sel,uint8_t vref_sel,uint8_t enable,uint8_t lp_mode,
		                   uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t out_mux_sel,
                       uint8_t dyn_en,uint8_t channel)
{
	OPAMP_CONFIG_T Config;
 ...
 * @return      none
 */
void RSI_OPAMP2_InvCMP(uint8_t vin_sel,uint8_t vref_sel,uint8_t enable,uint8_t lp_mode,
		                   uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t dyn_en,
                       uint8_t channel)
{
	OPAMP_CONFIG_T Config;
 ...
 * @return      none
 */
void RSI_OPAMP3_InvCMP(uint8_t vin_sel,uint8_t vref_sel,uint8_t enable,uint8_t lp_mode,
		                   uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t dyn_en,
                       uint8_t channel)
{
	OPAMP_CONFIG_T Config;
 ...
 * @return      none
 */
void RSI_OPAMP1_NonInvCMP(uint8_t vin_sel,uint8_t vref_sel,uint8_t enable,uint8_t lp_mode,
		                      uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t out_mux_sel,
                          uint8_t dyn_en,uint8_t channel)
{
	OPAMP_CONFIG_T Config;
 ...
 * @return      none
 */
void RSI_OPAMP2_NonInvCMP(uint8_t vin_sel,uint8_t vref_sel,uint8_t enable,uint8_t lp_mode,
		                      uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t dyn_en,
                          uint8_t channel)
{
	OPAMP_CONFIG_T Config;
 ...
 * @return      none
 */
void RSI_OPAMP3_NonInvCMP(uint8_t vin_sel,uint8_t vref_sel,uint8_t enable,uint8_t lp_mode,
                      		uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t dyn_en,
                          uint8_t channel)
{
	OPAMP_CONFIG_T Config;
 ...
 * @return      none
 */
void RSI_OPAMP_InstrAMP(uint8_t vin_p_sel,uint8_t vin_n_sel,uint8_t enable,uint8_t lp_mode,
		                    uint8_t r1_sel,uint8_t r2_sel,uint8_t out_mux_en,uint8_t dyn_en,uint8_t channel)
{
	OPAMP_CONFIG_T Config;
	Config.opamp1.opamp1_dyn_en     = dyn_en;
...
void RSI_OPAMP1_Config(OPAMP_Type *Opamp,uint32_t channel,OPAMP_CONFIG_T *config)
{
	...
	{	
		...
		AUX_ADC_DAC_COMP->ADC_CH_BIT_MAP_CONFIG[channel].ADC_CH_BIT_MAP_CONFIG_1_b.CHANNEL_BITMAP = ( config->opamp1.opamp1_out_mux_sel	<< 29 |  
				                                                                                          config->opamp1.opamp1_sel_p_mux   << 25 |	 
				                                                                                          config->opamp1.opamp1_sel_n_mux 	<< 22 |   
				                                                                                          config->opamp1.opamp1_out_mux_en	<< 21 |   
				                                                                                          config->opamp1.opamp1_res_to_out_vdd	 << 20 |  
				                                                                                          config->opamp1.opamp1_res_mux_sel			 << 17 |   
																																																	config->opamp1.opamp1_en_res_bank	     << 16 |   
																																																	config->opamp1.opamp1_r2_sel			     << 13 |  
																																																	config->opamp1.opamp1_r1_sel		       << 11 |   
																																																	config->opamp1.opamp1_lp_mode	         << 10 |   
...
{			
	...
	{	
		...
		AUX_ADC_DAC_COMP->ADC_CH_BIT_MAP_CONFIG[channel].ADC_CH_BIT_MAP_CONFIG_1_b.CHANNEL_BITMAP =  (config->opamp2.opamp2_lp_mode << 31 |  
	                                                                                          			config->opamp2.opamp2_enable  << 30 ) ;
		AUX_ADC_DAC_COMP->ADC_CH_BIT_MAP_CONFIG[channel].ADC_CH_BIT_MAP_CONFIG_2_b.CHANNEL_BITMAP = ( config->opamp2.opamp2_sel_p_mux	 << 14 |
																																																	config->opamp2.opamp2_sel_n_mux		<< 12 |
																																																	config->opamp2.opamp2_out_mux_en  << 11 |
																																																	config->opamp2.opamp2_res_to_out_vdd	 << 9  |
																																																	config->opamp2.opamp2_res_mux_sel  << 6  |
																																																	config->opamp2.opamp2_en_res_bank	 << 5  |
																																																	config->opamp2.opamp2_r2_sel  << 2  |
																																																	config->opamp2.opamp2_r1_sel  << 0   );	
	}else{
...
void RSI_OPAMP3_Config(OPAMP_Type *Opamp, uint32_t channel,OPAMP_CONFIG_T *config)
{
	if(config->opamp3.opamp3_dyn_en)
	{
		...
		AUX_ADC_DAC_COMP->ADC_CH_BIT_MAP_CONFIG[channel].ADC_CH_BIT_MAP_CONFIG_3_b.CHANNEL_BITMAP = config->opamp3.opamp3_sel_p_mux;
		AUX_ADC_DAC_COMP->ADC_CH_BIT_MAP_CONFIG[channel].ADC_CH_BIT_MAP_CONFIG_2_b.CHANNEL_BITMAP = (config->opamp3.opamp3_sel_n_mux  << 30 |
																																																config->opamp3.opamp3_out_mux_en	<< 29 |
																																																config->opamp3.opamp3_res_to_out_vdd << 28 |
																																																config->opamp3.opamp3_res_mux_sel	<< 25 |
																																																config->opamp3.opamp3_en_res_bank	<< 24 |
																																																config->opamp3.opamp3_r2_sel	  << 21 |
																																																config->opamp3.opamp3_r1_sel		<< 19 |
																																																config->opamp3.opamp3_lp_mode   << 18 |
