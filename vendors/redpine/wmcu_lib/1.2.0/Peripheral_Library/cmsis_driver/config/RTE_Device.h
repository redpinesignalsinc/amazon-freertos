...
#define RTE_ETH_RMII_CRS_DV_PORT_ID     2
#if (PACKAGE_TYPE == CC1) || (PACKAGE_TYPE == SB0N_B00) || (PACKAGE_TYPE == SB00_B00)
...
#define RTE_USART0_CLK_SRC                 USART_SOCPLLCLK
...
#define  RTE_SSI_MASTER_CS                   1
#define  RTE_SSI_MASTER_CS_PORT            0
#define  RTE_SSI_MASTER_CS_PIN             17
#define  RTE_SSI_MASTER_CS_MODE            EGPIO_PIN_MUX_MODE3
#define  RTE_SSI_MASTER_CS_PADSEL          5
...
#define  RTE_SSI_MASTER_CS                   1
#define  RTE_SSI_MASTER_CS_PORT            0
#define  RTE_SSI_MASTER_CS_PIN             43
#define  RTE_SSI_MASTER_CS_MODE            EGPIO_PIN_MUX_MODE5
#define  RTE_SSI_MASTER_CS_PADSEL          10
#elif   (RTE_SSI_MASTER_CS_PORT_ID == 10)
#define  RTE_SSI_MASTER_CS                   1
#define  RTE_SSI_MASTER_CS_PORT            0
...
#define  RTE_SSI_MASTER_CS                   1
#define  RTE_SSI_MASTER_CS_PORT            0
#define  RTE_SSI_MASTER_CS_PIN             20
#define  RTE_SSI_MASTER_CS_MODE            EGPIO_PIN_MUX_MODE3
#define  RTE_SSI_MASTER_CS_PADSEL          7
#elif   (RTE_SSI_MASTER_CS_PORT_ID == 13)
#define  RTE_SSI_MASTER_CS                   1
#define  RTE_SSI_MASTER_CS_PORT            0
...
#define  RTE_SSI_MASTER_CS                   1
#define  RTE_SSI_MASTER_CS_PORT            0
#define  RTE_SSI_MASTER_CS_PIN             35
#define  RTE_SSI_MASTER_CS_MODE            EGPIO_PIN_MUX_MODE4
#define  RTE_SSI_MASTER_CS_PADSEL          9
#elif   (RTE_SSI_MASTER_CS_PORT_ID == 15)
#define  RTE_SSI_MASTER_CS                   1
#define  RTE_SSI_MASTER_CS_PORT            0
#define  RTE_SSI_MASTER_CS_PIN             44
#define  RTE_SSI_MASTER_CS_MODE            EGPIO_PIN_MUX_MODE5
#define  RTE_SSI_MASTER_CS_PADSEL          10
#elif   (RTE_SSI_MASTER_CS_PORT_ID == 16)
#define  RTE_SSI_MASTER_CS                   1
#define  RTE_SSI_MASTER_CS_PORT            0
#define  RTE_SSI_MASTER_CS_PIN             48
#define  RTE_SSI_MASTER_CS_MODE            EGPIO_PIN_MUX_MODE3
#define  RTE_SSI_MASTER_CS_PADSEL          11
 #elif   (RTE_SSI_MASTER_CS_PORT_ID == 17)
#define  RTE_SSI_MASTER_CS                   1
#define  RTE_SSI_MASTER_CS_PORT            0
...
//cs3
#elif   (RTE_SSI_MASTER_CS_PORT_ID == 18)
#define  RTE_SSI_MASTER_CS                   1
#define  RTE_SSI_MASTER_CS_PORT            0
#define  RTE_SSI_MASTER_CS_PIN             23
#define  RTE_SSI_MASTER_CS_MODE            EGPIO_PIN_MUX_MODE3
#define  RTE_SSI_MASTER_CS_PADSEL          0//no pad
#elif   (RTE_SSI_MASTER_CS_PORT_ID == 19)
#define  RTE_SSI_MASTER_CS                   1
#define  RTE_SSI_MASTER_CS_PORT            0
#define  RTE_SSI_MASTER_CS_PIN             45
#define  RTE_SSI_MASTER_CS_MODE            EGPIO_PIN_MUX_MODE5
#define  RTE_SSI_MASTER_CS_PADSEL          10
#elif   (RTE_SSI_MASTER_CS_PORT_ID == 20)
#define  RTE_SSI_MASTER_CS                   1
#define  RTE_SSI_MASTER_CS_PORT            0
...
#define RTE_SSI_ULP_MASTER_CS                  1
#define  RTE_SSI_ULP_MASTER_CS_PORT            0
#define  RTE_SSI_ULP_MASTER_CS_PIN             12
#define  RTE_SSI_ULP_MASTER_CS_MODE            1
//cs2
#elif    (RTE_SSI_ULP_MASTER_CS_PORT_ID == 6)
#define RTE_SSI_ULP_MASTER_CS                  1
#define  RTE_SSI_ULP_MASTER_CS_PORT            0
#define  RTE_SSI_ULP_MASTER_CS_PIN             6
#define  RTE_SSI_ULP_MASTER_CS_MODE            1
#elif    (RTE_SSI_ULP_MASTER_CS_PORT_ID == 7)
#define RTE_SSI_ULP_MASTER_CS                  1
#define  RTE_SSI_ULP_MASTER_CS_PORT            0
#define  RTE_SSI_ULP_MASTER_CS_PIN             13
#define  RTE_SSI_ULP_MASTER_CS_MODE            1
#else
...
//     <i> WSCLK for I2S0
#define RTE_I2S0_WSCLK_PORT_ID                 4
...
#define RTE_SCT_OUT_0_PORT_ID                 2
