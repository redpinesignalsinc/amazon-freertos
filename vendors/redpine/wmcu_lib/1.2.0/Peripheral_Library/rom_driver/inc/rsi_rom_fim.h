 ...
 *@return       none
 * */
STATIC INLINE void   arm_offset_f32_opt( int32_t *pSrc,int32_t scale, int32_t *pDst,
		uint32_t length )
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_offset_f32_opt( pSrc,scale,pDst,length,0x00,BANK1);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_offset_q7_opt( pSrc,scale,pDst,length,0x00,BANK1);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_offset_q15_opt( pSrc, scale,pDst,length,0x00,BANK1);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_offset_q31_opt( pSrc, scale,pDst,length,0x00,BANK1);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_scalar_sub_q7( pSrc, scale,pDst,blockSize,0x00,BANK1);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_scalar_sub_q31( pSrc, scale,pDst, blockSize,0x00,BANK1);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_scalar_sub_f32( pSrc, scale,pDst, length,0x00,BANK1);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_scale_f32_opt( pSrc, scale,pDst, length,0x00,BANK1);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_scale_q7_opt( pSrc, scaleFract, shift, pDst,blockSize,0x00,BANK1);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_scale_q15_opt( pSrc, scaleFract, shift, pDst,blockSize,0x00,BANK1);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_scale_q31_opt( pSrc, scaleFract, shift, pDst,blockSize,0x00,BANK1);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_scalar_mul_q15( pSrc, scale, blockSize,typ_data,0x00,BANK1);
#else
	rsi_fim_scalar_mul_q15( pSrc, scale, blockSize,typ_data,0x00,BANK1);
#endif
}
 ...
 *return      none
 */
STATIC INLINE void  arm_add_f32_opt( int32_t *pSrcA, int32_t *pSrcB,uint32_t blockSize)
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_add_f32_opt( pSrcA, pSrcB, blockSize,0x00,BANK1,BANK2);
#else
	rsi_arm_add_f32_opt( pSrcA, pSrcB, blockSize,0x00,BANK1,BANK2);
#endif
}
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_add_q7_opt( pSrcA, pSrcB,pDst, blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_add_q15_opt( pSrcA, pSrcB,pDst, blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_add_q31_opt( pSrcA, pSrcB,pDst, blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_vector_add_q15( pIn1,pIn2,pDst, blockSize, typ_data,0x00,BANK3,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_sub_f32_opt( pSrcA, pSrcB,pDst, blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_sub_q7_opt( pSrcA, pSrcB,pDst, blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_sub_q15_opt( pSrcA, pSrcB,pDst, blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_sub_q31_opt(pSrcA,pSrcB,pDst,blockSize,0x00,BANK1,BANK2);
#else
 ...
 *@return     none
 */
STATIC INLINE void  fim_read_data( uint32_t bank,uint32_t length,volatile void  *pDst,uint8_t data_type,typ_data_t type_data)
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_read_data(bank,length,pDst,data_type,type_data);
#else
	rsi_fim_read_data(bank,length,pDst,data_type,type_data);
#endif
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_vector_sub_q15(pIn1,pIn2,pDst,blockSize,typ_data,0x00,BANK1,BANK2);
#else
 ...
 *@return     none
 */
STATIC INLINE void  arm_mult_f32_opt( int32_t *pIn1, int32_t *pIn2,uint32_t SatTruncRound, uint32_t length)
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_mult_f32_opt(pIn1,pIn2,SatTruncRound,length,0x00,BANK1,BANK2);
#else
	rsi_arm_mult_f32_opt(pIn1,pIn2,SatTruncRound,length,0x00,BANK1,BANK2);
#endif
}
/**
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_mult_q7_opt(pSrcA,pSrcB,pDst,blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_mult_q15_opt(pSrcA,pSrcB,pDst,blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_mult_q31_opt(pSrcA,pSrcB,pDst,blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_vector_mul_q15(pIn1,pIn2,pDst,blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_cmplx_mult_real_q15_opt(pSrcCmplx,pSrcReal,pDst,numSamples,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_cmplx_mult_cmplx_q15_opt(pSrcA,pSrcB,pDst,numSamples,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_cmplx_mag_squared_q15_opt(pSrc,pDst,numSamples,0x00,BANK1);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_absSqr_q7(pSrc,length,0x00,BANK1);
#else
	rsi_fim_absSqr_q7(pSrc,length,0x00,BANK1);
#endif
}
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_absSqr_q15(pSrc,length,0x00,BANK1);
#else
	rsi_fim_absSqr_q15(pSrc,length,0x00,BANK1);
#endif
}
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_absSqr_q31(pSrc,length,0x00,BANK1);
#else
	rsi_fim_absSqr_q31(pSrc,length,0x00,BANK1);
#endif
}
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_absSqr_f32(pSrc,length,0x00,BANK1);
#else
	rsi_fim_absSqr_f32(pSrc,length,0x00,BANK1);
#endif
}
...
{
#if defined(ROMDRIVER_PRESENT)
	return ROMAPI_FIM_API->rsi_arm_mat_mult_f32_opt(pSrcA,pSrcB,pDst,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	return ROMAPI_FIM_API->rsi_arm_mat_mult_q31_opt(pSrcA,pSrcB,pDst,0x00,BANK1,BANK2);
#else
...
STATIC INLINE error_t arm_mat_mult_q15_opt( const arm_matrix_instance_q15_opt * pSrcA,
		...
		arm_matrix_instance_q15_opt * pDst,q15_t * pState)
{
#if defined(ROMDRIVER_PRESENT )
	return ROMAPI_FIM_API->rsi_arm_mat_mult_q15_opt(pSrcA,pSrcB,pDst,pState,0x00,BANK1,BANK2);
#else
 ...
 *@return        none
 */
STATIC INLINE void  arm_fir_init_f32_opt( arm_fir_instance_f32_opt *S, uint16_t numTaps,int32_t *pCoeffs,
		int32_t *pState,uint32_t blockSize)
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_fir_init_f32_opt(S,numTaps,pCoeffs,pState,blockSize);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_fir_f32_opt(S,pSrc,pDst,blockSize,0x00,BANK1,BANK2);
#else
 ...
 *return         none
 */
STATIC INLINE void  arm_fir_init_q31_opt( arm_fir_instance_q31_opt *S,uint16_t numTaps,q31_t *pCoeffs,
		q31_t *pState, uint32_t blockSize)
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_fir_init_q31_opt(S,numTaps,pCoeffs,pState,blockSize);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_fir_q31_opt( S,pSrc,pDst,blockSize,0x00,BANK1,BANK2);
#else
 ...
 *
 */
STATIC INLINE void  arm_fir_init_q15_opt( arm_fir_instance_q15_opt *S,uint16_t numTaps,q15_t *pCoeffs,
		q15_t *pState, uint32_t blockSize)
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_fir_init_q15_opt( S,numTaps,pCoeffs,pState,blockSize);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_fir_q15_opt( S,pSrc,pDst,blockSize,0x00,BANK1,BANK2);
#else
 ...
 *return         none
 */
STATIC INLINE void  arm_fir_init_q7_opt( arm_fir_instance_q7_opt *S,uint16_t numTaps,q7_t *pCoeffs,
		q7_t *pState, uint32_t blockSize)
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_fir_init_q7_opt( S,numTaps,pCoeffs,pState,blockSize);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_fir_q7_opt( S,pSrc,pDst,blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_fim_interrupt_handler( ptFim);
#else
 ...
 *@return       none
 */
STATIC INLINE void  arm_fir_interpolate_f32_opt( const arm_fir_interpolate_instance_f32_opt * S, int32_t * pSrc,
		int32_t * pDst,uint32_t blockSize)
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_fir_interpolate_f32_opt( S,pSrc,pDst,blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	return ROMAPI_FIM_API->rsi_arm_fir_interpolate_init_f32_opt( S,L,numTaps,pCoeffs,pState,blockSize);
#else
...
#if defined(ROMDRIVER_PRESENT )
	return ROMAPI_FIM_API->rsi_arm_fir_interpolate_init_q15_opt( S,L,numTaps,pCoeffs,pState,blockSize);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	return ROMAPI_FIM_API->rsi_arm_fir_interpolate_init_q31_opt( S,L,numTaps,pCoeffs,pState,blockSize);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_fir_interpolate_q15_opt( S,pSrc,pDst,blockSize,0x00,BANK1,BANK2);
#else
...
{
#if defined(ROMDRIVER_PRESENT )
	ROMAPI_FIM_API->rsi_arm_fir_interpolate_q31_opt( S,pSrc,pDst,blockSize,0x00,BANK1,BANK2);
#else
	rsi_arm_fir_interpolate_q31_opt( S,pSrc,pDst,blockSize,0x00,BANK1,BANK2);
#endif
}
		/* function prototypes */
		void  arm_offset_f32_opt( int32_t *pSrc,int32_t scale, int32_t *pDst,
				uint32_t length ) ;
		...
		void  fim_scalar_mul_q15(q15_t *pSrc,q15_t *scale,uint32_t blockSize, typ_data_t typ_data );


		void  arm_add_f32_opt( int32_t *pSrcA, int32_t *pSrcB,uint32_t blockSize);
		...
		void  arm_mult_f32_opt( int32_t *pIn1, int32_t *pIn2,uint32_t SatTruncRound, uint32_t length);
		...
		void  fim_absSqr_q7( q7_t *pSrc,uint32_t length);


		void  fim_absSqr_q15( q15_t *pSrc,uint32_t length);


		void  fim_absSqr_q31( q31_t *pSrc,uint32_t length);


		void  fim_absSqr_f32( int32_t *pSrc,uint32_t length);
		...
		void  arm_fir_init_f32_opt( arm_fir_instance_f32_opt *S, uint16_t numTaps,int32_t *pCoeffs,
				int32_t *pState,uint32_t blockSize);
		...
		void  arm_fir_init_q31_opt( arm_fir_instance_q31_opt *S,uint16_t numTaps,q31_t *pCoeffs,
				q31_t *pState, uint32_t blockSize);

		void  arm_fir_q31_opt( arm_fir_instance_q31_opt *S, q31_t *pSrc,q31_t *pDst, uint32_t blockSize);


		void  arm_fir_init_q15_opt( arm_fir_instance_q15_opt *S,uint16_t numTaps,q15_t *pCoeffs,
				q15_t *pState, uint32_t blockSize);
		...
		void  arm_fir_init_q7_opt( arm_fir_instance_q7_opt *S,uint16_t numTaps,q7_t *pCoeffs,
				q7_t *pState, uint32_t blockSize);
		...
		void  arm_fir_interpolate_f32_opt( const arm_fir_interpolate_instance_f32_opt * S, int32_t * pSrc,
				int32_t * pDst,uint32_t blockSize);
		...
		void  arm_fir_interpolate_q15_opt( arm_fir_interpolate_instance_q15_opt * S,
				q15_t * pSrc,q15_t *pDst,
				uint32_t blockSize);
