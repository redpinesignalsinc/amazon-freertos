...
STATIC INLINE error_t RSI_MCPWM_Start( RSI_MCPWM_T *pMCPWM,
		uint8_t chnlNum )
{
#if defined(PWM_ROMDRIVER_PRESENT)
 ...
 */
STATIC INLINE error_t RSI_MCPWM_Stop( RSI_MCPWM_T *pMCPWM,
		uint8_t chnlNum )
{
#if defined(PWM_ROMDRIVER_PRESENT)
 ...
 * @return 		  \ref ERROR_PWM_INVALID_CHNLNUM : If channel is invalid
                \n \ref RSI_OK            : If process is done successfully.
 */
STATIC INLINE error_t RSI_MCPWM_ChannelReset( RSI_MCPWM_T *pMCPWM,
		uint8_t chnlNum )
{
#if defined(PWM_ROMDRIVER_PRESENT)
 ...
 * @return      \ref ERROR_PWM_INVALID_CHNLNUM : If channel number is invalid
                \n \ref RSI_OK            : If process is done successfully
 */
STATIC INLINE error_t RSI_MCPWM_CounterReset( RSI_MCPWM_T *pMCPWM,
		uint8_t chnlNum )
{
#if defined(PWM_ROMDRIVER_PRESENT)
 ...
 * @return      \ref ERROR_PWM_INVALID_PWMOUT : If pwmOutput is invalid
                \n RSI_OK                : If process is done successfully
 */
STATIC INLINE error_t RSI_MCPWM_FaultAValueSet( RSI_MCPWM_T *pMCPWM,
		uint8_t pwmOutput,
		uint8_t value )
{
#if defined(PWM_ROMDRIVER_PRESENT)
 ...
 * @return      \ref ERROR_PWM_INVALID_PWMOUT : If pwmOutput is invalid
                \n RSI_OK                : If process is done successfully
 */
STATIC INLINE error_t RSI_MCPWM_FaultBValueSet( RSI_MCPWM_T *pMCPWM,
		uint8_t pwmOutput,
		uint8_t value )
{
#if defined(PWM_ROMDRIVER_PRESENT)
 ...
 * @return      none
 */
STATIC INLINE void  RSI_MCPWM_InterruptHandler( RSI_MCPWM_T *pMCPWM,
		RSI_MCPWM_CALLBACK_T *pCallBack )
{
#if defined(PWM_ROMDRIVER_PRESENT)
		...
		uint16_t *timePeriod )
{
	...
	return RSI_OK;
		 ...
		 **************************************************************************************/
		 ...
		 error_t RSI_MCPWM_SetTimePeriod( RSI_MCPWM_T *pMCPWM, uint8_t chnlNum,
				 uint16_t period, uint16_t initVal );

		 void RSI_MCPWM_SpecialEventTriggerConfig( RSI_MCPWM_T *pMCPWM,boolean_t   svtDir,
				 RSI_MCPWM_SVT_CONFIG_T *pMCPWMSVTConfig);


		 error_t RSI_MCPWM_DeadTimeValueSet( RSI_MCPWM_T *pMCPWM ,
				 RSI_MCPWM_DT_CONFIG_T *pMCPWMDeadTimeConfig,
				 uint8_t chnlNum );
		 ...
		 error_t RSI_MCPWM_PeriodControlConfig( RSI_MCPWM_T *pMCPWM, uint32_t postScale,
				 uint32_t preScale, uint8_t chnlNum );

		 error_t RSI_MCPWM_FaultAValueSet( RSI_MCPWM_T *pMCPWM, uint8_t pwmOutput,
				 uint8_t value );


		 error_t RSI_MCPWM_FaultBValueSet( RSI_MCPWM_T *pMCPWM, uint8_t pwmOutput,
				 uint8_t value );

		 error_t RSI_MCPWM_SetBaseTimerMode( RSI_MCPWM_T *pMCPWM, uint8_t mode,
				 uint8_t chnlNum );

		 error_t RSI_MCPWM_SetOutputMode( RSI_MCPWM_T *pMCPWM,
				 boolean_t mode,
				 uint8_t chnlNum);

		 void RSI_MCPWM_SetOutputPolarity( RSI_MCPWM_T *pMCPWM,
				 boolean_t polL, boolean_t polH);

		 void RSI_MCPWM_InterruptHandler( RSI_MCPWM_T *pMCPWM,
				 RSI_MCPWM_CALLBACK_T *pCallBack );

		 uint16_t RSI_MCPWM_GetTimePeriod( RSI_MCPWM_T *pMCPWM,
				 uint8_t chnlNum, uint16_t *timePeriod );
