 ...
 *
 * @brief This files contains functions prototypes related to EFUSE
 *
 * @section Description
 * This file contains the list of function prototypes for the EFUSE and low level function definitions
 ...
 *               \n 0      : If success
 */
STATIC INLINE error_t RSI_EFUSE_MemMapReadWord(EFUSE_Type *pstcEfuse , uint16_t u16Addr , uint16_t *pu16Word ,uint32_t SocClk)
{
#if defined(ROMDRIVER_PRESENT )
