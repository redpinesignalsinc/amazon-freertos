 ...
 *
 * @brief This files contains function prototype  related to GPDMA.
 *
 * @section Description
 * This file contains the list of function for prototype related to the GPDMA .
 *
 */
 ...
 * @return 		  none
 */
STATIC INLINE void  RSI_GPDMA_RegisterCallback( RSI_GPDMA_HANDLE_T pHandle,
		uint32_t cbIndex,
		void *pCB )
{
#if defined(GPDMA_ROMDRIVER_PRESENT)
 ...
 */
STATIC INLINE error_t RSI_GPDMA_AbortChannel( RSI_GPDMA_HANDLE_T pHandle,
		uint8_t dmaCh )
{
#if defined(GPDMA_ROMDRIVER_PRESENT)
 ...
 * @return     \ref ERROR_GPDMA_INVALID_TRANS_LEN   : If transSize parameter of descriptor is invalid
               ...
               \n \ref RSI_OK                  : If process is done successfully
 */
STATIC INLINE error_t RSI_GPDMA_SetupChannelTransfer( RSI_GPDMA_HANDLE_T pHandle,
		uint8_t dmaCh,
		RSI_GPDMA_DESC_T *pDesc )
{
#if defined(GPDMA_ROMDRIVER_PRESENT)
 ...
 * @return 		  none
 */
STATIC INLINE void  RSI_GPDMA_DeInit( RSI_GPDMA_HANDLE_T pHandle,
 ...
 * @return 		  \ref ERROR_GPDMA_INVALIDCHNLNUM : If DMA channel number is invalid
                \n \ref RSI_OK                  : If process is done successfully
 */
STATIC INLINE error_t RSI_GPDMA_InterruptDisable( RSI_GPDMA_HANDLE_T pHandle,
		RSI_GPDMA_CHA_CFG_T *pCfg )
{
#if defined(GPDMA_ROMDRIVER_PRESENT)
 ...
 * @return 		  \ref ERROR_GPDMA_INVALIDCHNLNUM : If DMA channel number is invalid
                \n \ref RSI_OK                  : If process is done successfully
 */
STATIC INLINE error_t RSI_GPDMA_InterruptEnable( RSI_GPDMA_HANDLE_T pHandle,
		RSI_GPDMA_CHA_CFG_T *pCfg )
{
#if defined(GPDMA_ROMDRIVER_PRESENT)
 ...
 * @return 		 \ref ERROR_GPDMA_INVALIDCHNLNUM : If DMA channel number is invalid
               \n \ref RSI_OK                  : If process is done successfully
 */
STATIC INLINE error_t RSI_GPDMA_ErrorStatusClear( RSI_GPDMA_HANDLE_T pHandle,
		RSI_GPDMA_CHA_CFG_T *pCfg )
{
#if defined(GPDMA_ROMDRIVER_PRESENT)
 ...
 */
STATIC INLINE uint32_t  RSI_GPDMA_GetErrorStatus( RSI_GPDMA_HANDLE_T pHandle,
		RSI_GPDMA_CHA_CFG_T *pCfg )
{
#if defined(GPDMA_ROMDRIVER_PRESENT)
 ...
 * @return 		  \ref ERROR_GPDMA_INVALIDCHNLNUM : If DMA channel number is invalid
                \n \ref RSI_OK                  : If process is done successfully
 */
STATIC INLINE error_t RSI_GPDMA_InterruptClear( RSI_GPDMA_HANDLE_T pHandle,
		RSI_GPDMA_CHA_CFG_T *pCfg )
{
#if defined(GPDMA_ROMDRIVER_PRESENT)
 ...
 * @return 		    Returns the interrupt status of any one of the below flags
                  ...
                  \n \ref RSI_OK                     : If process is done successfully
 */
STATIC INLINE uint32_t  RSI_GPDMA_InterruptStatus( RSI_GPDMA_HANDLE_T pHandle,
		RSI_GPDMA_CHA_CFG_T *pCfg )
{
#if defined(GPDMA_ROMDRIVER_PRESENT)
