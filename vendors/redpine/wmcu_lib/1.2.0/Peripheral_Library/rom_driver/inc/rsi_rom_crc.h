 ...
 *
 * @brief This files contains functions prototypes related to CRC.
 * 
 * @section Description
 * This file contains the function definitions for the CRC in different and configuring parameters
 *
 */
