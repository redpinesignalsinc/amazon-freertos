 ...
 */
STATIC INLINE error_t RSI_UDMA_SetupChannelTransfer( RSI_UDMA_HANDLE_T pHandle, RSI_UDMA_CHA_CFG_T *pCfg,
		RSI_UDMA_CHA_CONFIG_DATA_T vsUdmaChaConfigData,
		void *pSrcAddr, void *pDstAddr )
{
 ...
 */
STATIC INLINE error_t RSI_UDMA_SetChannelScatterGatherTransfer( RSI_UDMA_HANDLE_T pHandle, uint8_t dmaCh, uint8_t taskCount,
		void *pTaskList, uint32_t transferType )
 ...
 */
STATIC INLINE uint32_t  RSI_UDMA_GetChannelTransferLength(RSI_UDMA_HANDLE_T pHandle, RSI_UDMA_CHA_CFG_T *pCfg,
		RSI_UDMA_CHA_CONFIG_DATA_T vsUDMAChaConfigData)
{
#if defined(UDMA_ROMDRIVER_PRESENT)
...
/* @} end of  RSI_UDMA_DRIVERS */
		...
		uint32_t RSI_UDMA_GetChannelTransferMode(RSI_UDMA_HANDLE_T pHandle,
				RSI_UDMA_CHA_CFG_T *pCfg);


		RSI_UDMA_HANDLE_T RSI_UDMA_Init(void *mem,
				const RSI_UDMA_INIT_T *pInit);


		error_t RSI_UDMA_SetupChannel(RSI_UDMA_HANDLE_T pHandle,
				RSI_UDMA_CHA_CFG_T *pCfg);

		void RSI_UDMA_DeInit(RSI_UDMA_HANDLE_T pHandle,
				RSI_UDMA_CHA_CFG_T *pCfg);
		...
		error_t RSI_UDMA_InterruptEnable(RSI_UDMA_HANDLE_T pHandle,
				uint8_t dmaCh);
