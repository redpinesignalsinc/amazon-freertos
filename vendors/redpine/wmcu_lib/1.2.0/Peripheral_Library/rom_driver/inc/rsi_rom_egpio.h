 ...
 *
 * @brief This files contains functions prototypes related to EGPIO
 *
 * @section Description
 ...
 * @brief        This API is used to used to clear the pin interrupt in status register
 * @param[in]    pEGPIO  : Pointer to the EGPIO register instance
 * @param[in]    intCh   : GPIO pin interrupt channel number (0 to 7)
 ...
 * @brief        This API is used to used to set pin multiplexing
 ...
 * @brief        This API is used to used to disable the group interrupt one
 * @param[in]    pEGPIO  : Pointer to the EGPIO register instance
 * @param[in]    port    : GPIO port number
 * @param[in]    pin     : GPIO pin number
 * @return       None
 ...
 * @brief        This API is used to select the host pad gpios(26 to 30)
 ...
 * @brief        This API is used to deselect the host pad gpios(26 to 30)
 * @param[in]    u8GpioNum  :  PAD number to be use
 * @return       None
 */
