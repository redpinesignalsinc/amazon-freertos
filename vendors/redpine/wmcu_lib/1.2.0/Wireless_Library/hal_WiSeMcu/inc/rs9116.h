 ...
 *           RSI9116 from Redpine Signals Inc..
 *
 * @version  V1.2
 * @date     4. March 2016
 *
 * @note     Generated with SVDConv V2.86d 
 *           from CMSIS SVD File 'RSI9116.svd' Version 1.2,
 *
...
typedef struct {
	...
	union {
		...
		struct {
			...
			__IO uint32_t  LINK_LIST_MSTR_SEL:  1;        /*!< This mode is set, when we do link listed operation                    */
			__IO uint32_t  SRC_ADDR_CONTIGUOUS:  1;       /*!< Indicates Address is contiguous from previous                         */
			__IO uint32_t  DEST_ADDR_CONTIGUOUS:  1;      /*!< Indicates Address is contiguous from previous                         */
...
typedef struct {
	...
	union {
		__IO uint32_t  GPIO_GRP_INTR_STATUS_REG;        /*!< GPIO Interrupt 0 Status Register                                      */
...
typedef struct {                                    /*!< I2C0 Structure                                                        */
	...
	union {
		...
		struct {
			...
			__I  uint16_t  R_MST_ON_HOLD:  1;             /*!< Indicates whether a master is holding the bus and the Tx FIFO
                                                         is empty.                                                             */
			__I  uint16_t  R_SCL_STUCK_AT_LOW:  1;        /*!< Indicates whether the SCL Line is stuck at low for the IC_SCL_STUCK_LOW_TI
	...
	union {
		...
		struct {
			...
			__I  uint32_t  M_MST_ON_HOLD:  1;             /*!< Indicates whether a master is holding the bus and the Tx FIFO
                                                         is empty.                                                             */
			__I  uint32_t  M_SCL_STUCK_AT_LOW:  1;        /*!< Indicates whether the SCL Line is stuck at low for the IC_SCL_STUCK_LOW_TI
                                                         MOUT number of ic_clk periods                                         */
	...
	union {
		...
		struct {
			...
			__I  uint32_t  ABRT_USER_ABRT:  1;            /*!< This is a master-mode-only bit. Master has detected the transfer
                                                         abort (IC_ENABLE[1]).                                                 */
			__I  uint32_t  ABRT_SDA_STUCK_AT_LOW:  1;     /*!< Master detects the SDA is Stuck at low for the IC_SDA_STUCK_AT_LOW_TIMEOUT
                                                         value of ic_clks                                                      */
	...
	union {
		__IO uint32_t  IC_SCL_STUCK_AT_LOW_TIMEOUT;     /*!< I2C SCL Stuck at Low Timeout                                          */

		struct {
			__IO uint32_t  IC_SCL_STUCK_LOW_TIMEOUT: 32;  /*!< Generates the interrupt to indicate SCL stuck at low if it detects
	...
	union {
		__IO uint32_t  IC_SDA_STUCK_AT_LOW_TIMEOUT;     /*!< I2C SDA Stuck at Low Timeout                                          */
...
typedef struct {                                    /*!< MCPWM Structure                                                       */
	...
	union {
		...
		struct {
			__I  uint32_t  RISE_PWM_TIME_PERIOD_MATCH_INTR_CH0:  1;/*!< This time base interrupt for 0th channel without considering
                                                         postscaler                                                            */
			__I  uint32_t  PWM_TIME_PRD_MATCH_INTR_CH0:  1;/*!< This time base interrupt for 0th channel, which considers postscaler
                                                         value                                                                 */
			...
			__I  uint32_t  RISE_PWM_TIME_PERIOD_MATCH_INTR_CH1:  1;/*!< This time base interrupt for 1st channel without considering
                                                         postscaler value                                                      */
			__I  uint32_t  PWM_TIME_PRD_MATCH_INTR_CH1:  1;/*!< This time base interrupt for 1st channel, which considers postscaler
                                                         value.                                                                */
			__I  uint32_t  RISE_PWM_TIME_PERIOD_MATCH_INTR_CH2:  1;/*!< This time base interrupt for 2nd channel without considering
                                                         postscaler value.                                                     */
			__I  uint32_t  PWM_TIME_PRD_MATCH_INTR_CH2:  1;/*!< This time base interrupt for 2nd channel, which considers postscaler
                                                         value                                                                 */
			__I  uint32_t  RISE_PWM_TIME_PERIOD_MATCH_INTR_CH3:  1;/*!< This time base interrupt for 3rd channel without considering
                                                         postscaler value.                                                     */
			__I  uint32_t  PWM_TIME_PRD_MATCH_INTR_CH3:  1;/*!< This time base interrupt for 3rd channel, which considers postscaler
                                                         value.                                                                */
	...
	union {
		...
		struct {
			__IO uint32_t  RISE_PWM_TIME_PERIOD_MATCH_CH0_ACK:  1;/*!< NONE                                                          */
			__IO uint32_t  PWM_TIME_PRD_MATCH_INTR_CH0_ACK:  1;/*!< NONE                                                             */
			__IO uint32_t  FLT_A_INTR_ACK:  1;            /*!< NONE                                                                  */
			__IO uint32_t  FLT_B_INTR_ACK:  1;            /*!< NONE                                                                  */
			__IO uint32_t  RISE_PWM_TIME_PERIOD_MATCH_CH1_ACK:  1;/*!< NONE                                                          */
			__IO uint32_t  PWM_TIME_PRD_MATCH_INTR_CH1_ACK:  1;/*!< NONE                                                             */
			__IO uint32_t  RISE_PWM_TIME_PERIOD_MATCH_CH2_ACK:  1;/*!< NONE                                                          */
			__IO uint32_t  PWM_TIME_PRD_MATCH_INTR_CH2_ACK:  1;/*!< NONE                                                             */
			__IO uint32_t  RISE_PWM_TIME_PERIOD_MATCH_CH3_ACK:  1;/*!< NONE                                                          */
			__IO uint32_t  PWM_TIME_PRD_MATCH_INTR_CH3_ACK:  1;/*!< NONE                                                             */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_CNTR_WR_REG_CH0;    /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_PARAM_REG_CH0;      /*!< NONE                                                                  */

		struct {
			__IO uint32_t  TMR_OPEARATING_MODE_CH0:  3;   /*!< Base timer operating mode for channel0                                */
			uint32_t             :  1;
			__IO uint32_t  PWM_TIME_PRD_PRE_SCALAR_VALUE_CH0:  3;/*!< Base timer input clock prescale select value for channel0.     */
			uint32_t             :  1;
			__IO uint32_t  PWM_TIME_PRD_POST_SCALAR_VALUE_CH0:  4;/*!< Time base output post scale bits for channel0                 */
		} PWM_TIME_PRD_PARAM_REG_CH0_b;                 /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PWM_TIME_PRD_CTRL_REG_CH0;       /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_STS_REG_CH0;        /*!< NONE                                                                  */
	...
	union {
		__I  uint32_t  PWM_TIME_PRD_CNTR_VALUE_CH0;     /*!< NONE                                                                  */
	...
	union {
		...
		struct {
			__IO uint32_t  PWM_DC_REG_WR_VALUE_CH: 16;   /*!< Duty cycle value for channel0                                         */
		} DUTYCYCLE_b[4];                               /*!< BitSize                                                               */
	};
	__I  uint32_t  RESERVED2[4];

	union {
		__IO uint32_t  PWM_DEADTIME_CTRL_SET_REG;       /*!< NONE                                                                  */

		struct {
			__IO uint32_t  DEADTIME_SELECT_ACTIVE:  4;    /*!< Dead time select bits for PWM going active                            */
			__IO uint32_t  DEADTIME_SELECT_INACTIVE:  4;  /*!< Dead time select bits for PWM going inactive                          */
			__IO uint32_t  DEADTIME_DISABLE_FRM_REG:  4;  /*!< Dead time counter soft reset for each channel.                        */
		} PWM_DEADTIME_CTRL_SET_REG_b;                  /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PWM_DEADTIME_CTRL_RESET_REG;     /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_DEADTIME_PRESCALE_SELECT_A;  /*!< NONE                                                                  */

		struct {
			__IO uint32_t  DEADTIME_PRESCALE_SELECT_A:  4;/*!< Dead time prescale selection bits for unit A.                         */
		} PWM_DEADTIME_PRESCALE_SELECT_A_b;             /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PWM_DEADTIME_PRESCALE_SELECT_B;  /*!< NONE                                                                  */

		struct {
			__IO uint32_t  DEADTIME_PRESCALE_SELECT_B:  4;/*!< Dead time prescale selection bits for unit B                          */
	...
	union {
		__IO uint32_t  PWM_OP_OVERRIDE_CTRL_SET_REG;    /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_OP_OVERRIDE_CTRL_RESET_REG;  /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_OP_OVERRIDE_ENABLE_SET_REG;  /*!< NONE                                                                  */

		struct {
			__IO uint32_t  PWM_OP_OVERRIDE_ENABLE_REG:  8;/*!< Pwm output over ride enable                                           */
		} PWM_OP_OVERRIDE_ENABLE_SET_REG_b;             /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PWM_OP_OVERRIDE_ENABLE_RESET_REG;/*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_OP_OVERRIDE_VALUE_SET_REG;   /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_OP_OVERRIDE_VALUE_RESET_REG; /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_FLT_OVERRIDE_CTRL_SET_REG;   /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_FLT_OVERRIDE_CTRL_RESET_REG; /*!< NONE                                                                  */
		...
		struct {
			...
			__IO uint32_t  FLT_A_ENABLE:  4;              /*!< Fault A enable. Separate enable bit is present for channel            */
			__IO uint32_t  FLT_B_ENABLE:  4;              /*!< Fault B enable. Separate enable bit is present for channel            */
			__IO uint32_t  COMPLEMENTARY_MODE:  4;        /*!< PWM I/O pair mode                                                     */
		} PWM_FLT_OVERRIDE_CTRL_RESET_REG_b;            /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PWM_FLT_A_OVERRIDE_VALUE_REG;    /*!< Fault input A PWM override value                                      */

		struct {
			__IO uint32_t  PWM_FLT_A_OVERRIDE_VALUE_L0:  1;/*!< 0 bit for L0                                                         */
			__IO uint32_t  PWM_FLT_A_OVERRIDE_VALUE_L1:  1;/*!< 1 bit for L1                                                         */
			__IO uint32_t  PWM_FLT_A_OVERRIDE_VALUE_L2:  1;/*!< 2 bit for L2                                                         */
			__IO uint32_t  PWM_FLT_A_OVERRIDE_VALUE_L3:  1;/*!< 3 bit for L3                                                         */
			__IO uint32_t  PWM_FLT_A_OVERRIDE_VALUE_H0:  1;/*!< 4 bit for H0                                                         */
			__IO uint32_t  PWM_FLT_A_OVERRIDE_VALUE_H1:  1;/*!< 5 bit for H1                                                         */
			__IO uint32_t  PWM_FLT_A_OVERRIDE_VALUE_H2:  1;/*!< 6 bit for H2                                                         */
			__IO uint32_t  PWM_FLT_A_OVERRIDE_VALUE_REG_H3:  1;/*!< 7 bit for H3                                                     */
		} PWM_FLT_A_OVERRIDE_VALUE_REG_b;               /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PWM_FLT_B_OVERRIDE_VALUE_REG;    /*!< Fault input B PWM override value                                      */

		struct {
			__IO uint32_t  PWM_FLT_B_OVERRIDE_VALUE_L0:  1;/*!< 0 bit for L0                                                         */
			__IO uint32_t  PWM_FLT_B_OVERRIDE_VALUE_L1:  1;/*!< 1 bit for L1                                                         */
			__IO uint32_t  PWM_FLT_B_OVERRIDE_VALUE_L2:  1;/*!< 2 bit for L2                                                         */
			__IO uint32_t  PWM_FLT_B_OVERRIDE_VALUE_L3:  1;/*!< 3 bit for L3                                                         */
			__IO uint32_t  PWM_FLT_B_OVERRIDE_VALUE_H0:  1;/*!< 4 bit for H0                                                         */
			__IO uint32_t  PWM_FLT_B_OVERRIDE_VALUE_H1:  1;/*!< 5 bit for H1                                                         */
			__IO uint32_t  PWM_FLT_B_OVERRIDE_VALUE_H2:  1;/*!< 6 bit for H2                                                         */
			__IO uint32_t  PWM_FLT_B_OVERRIDE_VALUE_H3:  1;/*!< 7 bit for H3                                                         */
	...
	union {
		__IO uint32_t  PWM_SVT_COMPARE_VALUE_REG;       /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_CNTR_WR_REG_CH1;    /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_PARAM_REG_CH1;      /*!< NONE                                                                  */

		struct {
			__IO uint32_t  TMR_OPEARATING_MODE_CH1:  3;   /*!< Base timer operating mode for channel1                                */
			uint32_t             :  1;
			__IO uint32_t  PRE_SCALAR_VALUE_CH1:  3;      /*!< Base timer input clock prescale select value for channel1.            */
			uint32_t             :  1;
			__IO uint32_t  POST_SCALAR_VALUE_CH1:  4;     /*!< Time base output post scale bits for channel1                         */
		} PWM_TIME_PRD_PARAM_REG_CH1_b;                 /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PWM_TIME_PRD_CTRL_REG_CH1;       /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_STS_REG_CH1;        /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_CNTR_VALUE_CH1;     /*!< NONE                                                                  */

		struct {
			__IO uint32_t  PWM_TIME_PRD_CNTR_VALUE_CH1:  1;/*!< Time period counter current value for channel1                       */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_CNTR_WR_REG_CH2;    /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_PARAM_REG_CH2;      /*!< NONE                                                                  */

		struct {
			__IO uint32_t  TMR_OPEARATING_MODE_CH2:  3;   /*!< Base timer operating mode for channel2                                */
			uint32_t             :  1;
			__IO uint32_t  PRE_SCALAR_VALUE_CH2:  3;      /*!< Base timer input clock prescale select value for channel2.            */
			uint32_t             :  1;
			__IO uint32_t  POST_SCALAR_VALUE_CH2:  4;     /*!< Time base output post scale bits for channel2                         */
		} PWM_TIME_PRD_PARAM_REG_CH2_b;                 /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PWM_TIME_PRD_CTRL_REG_CH2;       /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_STS_REG_CH2;        /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_CNTR_VALUE_CH2;     /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_CNTR_WR_REG_CH3;    /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_PARAM_REG_CH3;      /*!< NONE                                                                  */

		struct {
			__IO uint32_t  TMR_OPEARATING_MODE_CH3:  3;   /*!< Base timer operating mode for channel3                                */
			uint32_t             :  1;
			__IO uint32_t  PRE_SCALAR_VALUE_CH3:  3;      /*!< Base timer input clock prescale select value for channel2.            */
			uint32_t             :  1;
			__IO uint32_t  POST_SCALAR_VALUE_CH3:  4;     /*!< Time base output postscale bits for channel3                          */
		} PWM_TIME_PRD_PARAM_REG_CH3_b;                 /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PWM_TIME_PRD_CTRL_REG_CH3;       /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_STS_REG_CH3;        /*!< NONE                                                                  */
	...
	union {
		__IO uint32_t  PWM_TIME_PRD_CNTR_VALUE_CH3;     /*!< NONE                                                                  */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  PWM_TIME_PRD_COMMON_TIMER_VALUE:  2;/*!< Base timers select to generate special event trigger             */
...
typedef struct {                                    /*!< UDMA0 Structure                                                       */
	...
	union {
		...
		struct {
			__IO uint32_t  DMA_WAITONREQ_STATUS: 32;      /*!< Per Channel wait on request status                                    */
	...
	union {
		...
		struct {
			__IO uint32_t  DONE_STATUS_CHANNEL_0:  1;     /*!< UDMA done Status of the channel 0                                     */
			__IO uint32_t  DONE_STATUS_CHANNEL_1:  1;     /*!< UDMA done Status of the channel 1                                     */
			__IO uint32_t  DONE_STATUS_CHANNEL_2:  1;     /*!< UDMA done Status of the channel 2                                     */
			__IO uint32_t  DONE_STATUS_CHANNEL_3:  1;     /*!< UDMA done Status of the channel 3                                     */
			__IO uint32_t  DONE_STATUS_CHANNEL_4:  1;     /*!< UDMA done Status of the channel 4                                     */
			__IO uint32_t  DONE_STATUS_CHANNEL_5:  1;     /*!< UDMA done Status of the channel 5                                     */
			__IO uint32_t  DONE_STATUS_CHANNEL_6:  1;     /*!< UDMA done Status of the channel 6                                     */
			__IO uint32_t  DONE_STATUS_CHANNEL_7:  1;     /*!< UDMA done Status of the channel 7                                     */
			__IO uint32_t  DONE_STATUS_CHANNEL_8:  1;     /*!< UDMA done Status of the channel 8                                     */
			__IO uint32_t  DONE_STATUS_CHANNEL_9:  1;     /*!< UDMA done Status of the channel 9                                     */
			__IO uint32_t  DONE_STATUS_CHANNEL_10:  1;    /*!< UDMA done Status of the channel 10                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_11:  1;    /*!< UDMA done Status of the channel 3                                     */
			__IO uint32_t  DONE_STATUS_CHANNEL_12:  1;    /*!< UDMA done Status of the channel 12                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_13:  1;    /*!< UDMA done Status of the channel 13                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_14:  1;    /*!< UDMA done Status of the channel 14                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_15:  1;    /*!< UDMA done Status of the channel 15                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_16:  1;    /*!< UDMA done Status of the channel 16                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_17:  1;    /*!< UDMA done Status of the channel 17                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_18:  1;    /*!< UDMA done Status of the channel 18                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_19:  1;    /*!< UDMA done Status of the channel 19                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_20:  1;    /*!< UDMA done Status of the channel 3                                     */
			__IO uint32_t  DONE_STATUS_CHANNEL_21:  1;    /*!< UDMA done Status of the channel 21                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_22:  1;    /*!< UDMA done Status of the channel 22                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_23:  1;    /*!< UDMA done Status of the channel 23                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_24:  1;    /*!< UDMA done Status of the channel 24                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_25:  1;    /*!< UDMA done Status of the channel 25                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_26:  1;    /*!< UDMA done Status of the channel 26                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_27:  1;    /*!< UDMA done Status of the channel 27                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_28:  1;    /*!< UDMA done Status of the channel 28                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_29:  1;    /*!< UDMA done Status of the channel 29                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_30:  1;    /*!< UDMA done Status of the channel 30                                    */
			__IO uint32_t  DONE_STATUS_CHANNEL_31:  1;    /*!< UDMA done Status of the channel 31                                    */
	...
	union {
		...
		struct {
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_0:  1;/*!< Reading 1 indicates that the channel 0 is busy                    */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_1:  1;/*!< Reading 1 indicates that the channel 1 is busy                    */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_2:  1;/*!< Reading 1 indicates that the channel 2 is busy                    */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_3:  1;/*!< Reading 1 indicates that the channel 3 is busy                    */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_4:  1;/*!< Reading 1 indicates that the channel 4 is busy                    */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_5:  1;/*!< Reading 1 indicates that the channel 5 is busy                    */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_6:  1;/*!< Reading 1 indicates that the channel 6 is busy                    */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_7:  1;/*!< Reading 1 indicates that the channel 7 is busy                    */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_8:  1;/*!< Reading 1 indicates that the channel 8 is busy                    */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_9:  1;/*!< Reading 1 indicates that the channel 9 is busy                    */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_10:  1;/*!< Reading 1 indicates that the channel 10 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_11:  1;/*!< Reading 1 indicates that the channel 11 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_12:  1;/*!< Reading 1 indicates that the channel 12 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_13:  1;/*!< Reading 1 indicates that the channel 13 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_14:  1;/*!< Reading 1 indicates that the channel 14 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_15:  1;/*!< Reading 1 indicates that the channel 15 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_16:  1;/*!< Reading 1 indicates that the channel 16 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_17:  1;/*!< Reading 1 indicates that the channel 17 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_18:  1;/*!< Reading 1 indicates that the channel 18 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_19:  1;/*!< Reading 1 indicates that the channel 19 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_20:  1;/*!< Reading 1 indicates that the channel 20 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_21:  1;/*!< Reading 1 indicates that the channel 21 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_22:  1;/*!< Reading 1 indicates that the channel 22 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_23:  1;/*!< Reading 1 indicates that the channel 23 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_24:  1;/*!< Reading 1 indicates that the channel 24 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_25:  1;/*!< Reading 1 indicates that the channel 25 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_26:  1;/*!< Reading 1 indicates that the channel 26 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_27:  1;/*!< Reading 1 indicates that the channel 27 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_28:  1;/*!< Reading 1 indicates that the channel 28 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_29:  1;/*!< Reading 1 indicates that the channel 29 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_30:  1;/*!< Reading 1 indicates that the channel 30 is busy                  */
			__IO uint32_t  BUSY_OR_IDEAL_STATUS_CHANNEL_31:  1;/*!< Reading 1 indicates that the channel 31 is busy                  */
		} CHANNEL_STATUS_REG_b;                         /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PERIPHERAL_SELECT_CHANNEL0_REG;  /*!< Peripheral Select Channel0 register                                   */

		struct {
			__IO uint32_t  PERIPHERAL_SELECT_CHANNEL0:  6;/*!< Selects which peripheral will be selected for the channel 0           */
		} PERIPHERAL_SELECT_CHANNEL0_REG_b;             /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PERIPHERAL_SELECT_CHANNEL1;      /*!< Peripheral Select Channel1 register                                   */

		struct {
			__IO uint32_t  PERIPHERAL_SELECT_CHANNEL1:  6;/*!< Selects which peripheral will be selected for the channel 1           */
		} PERIPHERAL_SELECT_CHANNEL1_b;                 /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PERIPHERAL_SELECT_CHANNEL2;      /*!< Peripheral Select Channel2 register                                   */

		struct {
			__IO uint32_t  PERIPHERAL_SELECT_CHANNEL2:  6;/*!< Selects which peripheral will be selected for the channel 2           */
		} PERIPHERAL_SELECT_CHANNEL2_b;                 /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PERIPHERAL_SELECT_CHANNEL3;      /*!< Peripheral Select Channel3 register                                   */

		struct {
			__IO uint32_t  PERIPHERAL_SELECT_CHANNEL3:  6;/*!< Selects which peripheral will be selected for the channel 3           */
		} PERIPHERAL_SELECT_CHANNEL3_b;                 /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PERIPHERAL_SELECT_CHANNEL4;      /*!< Peripheral Select Channel4 register                                   */

		struct {
			__IO uint32_t  PERIPHERAL_SELECT_CHANNEL4:  6;/*!< Selects which peripheral will be selected for the channel 4           */
		} PERIPHERAL_SELECT_CHANNEL4_b;                 /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PERIPHERAL_SELECT_CHANNEL5;      /*!< Peripheral Select Channel5 register                                   */

		struct {
			__IO uint32_t  PERIPHERAL_SELECT_CHANNEL5:  6;/*!< Selects which peripheral will be selected for the channel 3           */
		} PERIPHERAL_SELECT_CHANNEL5_b;                 /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PERIPHERAL_SELECT_CHANNEL6;      /*!< Peripheral Select Channel6 register                                   */

		struct {
			__IO uint32_t  PERIPHERAL_SELECT_CHANNEL6:  6;/*!< Selects which peripheral will be selected for the channel 6           */
		} PERIPHERAL_SELECT_CHANNEL6_b;                 /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PERIPHERAL_SELECT_CHANNEL7;      /*!< Peripheral Select Channel7 register                                   */

		struct {
			__IO uint32_t  PERIPHERAL_SELECT_CHANNEL7:  6;/*!< Selects which peripheral will be selected for the channel 7           */
	...
	union {
		...
		struct {
			__IO uint16_t  SINGLE_REQUEST_ENABLE:  1;     /*!< Enabled signal for single request                                     */
...
typedef struct {                                    /*!< RPDMA_C Structure                                                     */
	RPDMA_C_CHANNEL_CONFIG_Type CHANNEL_CONFIG[8];    /*!< CHANNEL_CONFIG0                                                       */
} RPDMA_C_Type;
...
typedef struct {                                    /*!< GSPI0 Structure                                                       */
	...
	union {
		...
		struct {
			__IO uint32_t  GSPI_DATA_SAMPLE_EDGE:  1;     /*!< Samples MISO data on clock edges. This should be ZERO for mode3
                                                         clock                                                                 */
			__IO uint32_t  GSPI_CLK_MODE_CSN0:  1;        /*!< NONE                                                                  */
			__IO uint32_t  GSPI_CLK_MODE_CSN1:  1;        /*!< NONE                                                                  */
			__IO uint32_t  GSPI_CLK_MODE_CSN2:  1;        /*!< NONE                                                                  */
			__IO uint32_t  GSPI_CLK_MODE_CSN3:  1;        /*!< NONE                                                                  */
			__IO uint32_t  GSPI_GPIO_MODE_ENABLES:  6;    /*!< These bits are used to map GSPI on GPIO pins                          */
			__IO uint32_t  SPI_9115_FEATURE_EN:  1;       /*!< 9115 specific features are enabled with this enable                   */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  GSPI_MANUAL_RD_CNT: 10;        /*!< Indicates total number of bytes to be read                            */
			__IO uint32_t  GSPI_MANUAL_CSN_SELECT:  2;    /*!< Indicates which CSn is valid. Can be programmable in manual
                                                         mode                                                                  */
			__IO uint32_t  SPI_FULL_DUPLEX_ENA:  1;        /*!< Full duplex mode enable                                               */
	...
	union {
		...
		struct {
			__IO uint32_t  GSPI_WR_DATA_SWAP_MNL_CSN0:  1;/*!< Swap the write data inside the GSPI controller it-self.               */
			__IO uint32_t  GSPI_WR_DATA_SWAP_MNL_CSN1:  1;/*!< Swap the write data inside the GSPI controller it-self.               */
			__IO uint32_t  GSPI_WR_DATA_SWAP_MNL_CSN2:  1;/*!< Swap the write data inside the GSPI controller it-self.               */
			__IO uint32_t  GSPI_WR_DATA_SWAP_MNL_CSN3:  1;/*!< Swap the write data inside the GSPI controller it-self.               */
			__IO uint32_t  GSPI_RD_DATA_SWAP_MNL_CSN0:  1;/*!< Swap the read data inside the GSPI controller it-self.                */
			__IO uint32_t  GSPI_RD_DATA_SWAP_MNL_CSN1:  1;/*!< Swap the read data inside the GSPI controller it-self.                */
			__IO uint32_t  GSPI_RD_DATA_SWAP_MNL_CSN2:  1;/*!< Swap the read data inside the GSPI controller it-self.                */
			__IO uint32_t  GSPI_RD_DATA_SWAP_MNL_CSN3:  1;/*!< Swap the read data inside the GSPI controller it-self.                */
			__IO uint32_t  GSPI_MANUAL_SIZE_FRM_REG:  1;  /*!< Manual reads and manual writes                                        */
			uint32_t             :  1;
			__IO uint32_t  TAKE_GSPI_MANUAL_WR_SIZE_FRM_REG:  1;/*!< NONE                                                            */
	...
	union {
		...
		struct {
			__IO uint32_t  GSPI_MANUAL_WRITE_DATA2:  4;   /*!< Number of bits to be written in write mode                            */
			uint32_t             :  3;
	...
	union {
		...
		struct {
			...
			__I  uint32_t  FIFO_AEMPTY_RFIFO_S:  1;       /*!< Empty status indication for Rfifo in manual mode                      */
	...
	union {
		...
		struct {
			__IO uint32_t  GSPI_INTR_UNMASK_EN:  1;          /*!< GSPI Interrupt unmask bit                                             */
			__IO uint32_t  FIFO_AEMPTY_RFIFO_UNMASK:  1;  /*!< NONE                                                                  */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  FIFO_AEMPTY_WFIFO_LVL:  1;     /*!< NONE                                                                  */
			__I  uint32_t  FIFO_AFULL_WFIFO_LVL:  1;      /*!< NONE                                                                  */
			__I  uint32_t  FIFO_FULL_WFIFO_LVL:  1;       /*!< NONE                                                                  */
			__IO uint32_t  FIFO_EMPTY_RFIFO_LVL:  1;      /*!< NONE                                                                  */
	...
	union {
		...
		struct {
			__IO  uint32_t  SPI_FIFO;   /*!< GSPI FIFO registers used for write and read the data in to FIFO Registers                                     */
		} GSPI_FIFO_b;                        /*!< BitSize                                                               */
	};
...
typedef struct {                                    /*!< SIO Structure                                                         */
	...
	union {
		...
		struct {
			__IO uint32_t  SIO_OPERATION_ENABLE: 16;      /*!< Contains the Enables for all SIO                                      */
	...
	union {
		...
		struct {
			__IO uint32_t  SIO_POSITION_COUNTER_DISABLE: 16;/*!< Contains sio position counter disable for all SIOs                  */
		} PAUSE_REG_b;                                  /*!< BitSize                                                               */
	};
	...
	union {
		__IO  uint32_t  GPIO_INTR_MASK_CLEAR_REG;        /*!< GPIO Interrupt Enable Clear Register                                  */
	...
	union {
		__IO uint32_t  SHIFT_COUNT_PRELOAD_REG[16];     /*!< Shift counter Reload Register                                         */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  IGNORE_FIRST_SHIFT_CONDITION:  1;/*!< data shift condition                                                */
			__IO uint32_t  FLOW_CONTROL_ENABLED:  1;      /*!< flow control                                                          */
			__IO uint32_t  PATTERN_MATCH_ENABLE:  1;      /*!< pattern match                                                         */
			...
			__IO uint32_t  PIN_DETECTION_MODE:  2;        /*!< Pin mode to be considered for gpio interrupt                          */
			...
			__IO uint32_t  RESET_CLK_OUT:  1;             /*!< When high resets the sio clock_out port. This is used only when
                                                         sio is not enabled                                                    */
			__IO uint32_t  LOAD_DATA_POS_CNTR_VIA_APB:  1;/*!< When set, data position counter can be loaded via APB                 */
		} CONFIG_REG_b[16];                             /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PATTERN_MATCH_MASK_REG_SLICE_0;  /*!< Pattern Match Mask Register 0                                         */

		struct {
			__IO uint32_t  MATCH_MASK_LOWER16_BITS: 32;   /*!< Enable for lower 16 bits                                              */
		} PATTERN_MATCH_MASK_REG_SLICE_0_b;             /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PATTERN_MATCH_MASK_REG_slice_1;  /*!< Pattern Match Mask Register Slice 1                                   */
	...
	union {
		__IO uint32_t  PATTERN_MATCH_MASK_REG_SLICE_2;  /*!< Pattern Match Mask Register Slice 2                                   */
	...
	union {
		__IO uint32_t  PATTERN_MATCH_MASK_REG_SLICE_8;  /*!< Pattern Match Mask Register Slice 8                                   */
	...
	union {
		__IO uint32_t  PATTERN_MATCH_MASK_REG_SLICE_9;  /*!< Pattern Match Mask Register Slice 9                                   */
	...
	union {
		__IO uint32_t  PATTERN_MATCH_MASK_REG_SLICE_10; /*!< Pattern Match Mask Register Slice 10                                  */
	...
	union {
		__IO uint32_t  PATTERN_MATCH_REG_SLICE_0;       /*!< Pattern Match Mask Register Slice 0                                   */

		struct {
			__IO uint32_t  PATTERN_MATCH_LOWER16_BITS: 32;/*!< Lower 16-bits of pattern to be detected                               */
		} PATTERN_MATCH_REG_SLICE_0_b;                  /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  PATTERN_MATCH_REG_SLICE_1;       /*!< Pattern Match Mask Register Slice 1                                   */
	...
	union {
		__IO uint32_t  PATTERN_MATCH_REG_SLICE_2;       /*!< Pattern Match Mask Register Slice 2                                   */
	...
	union {
		__IO uint32_t  PATTERN_MATCH_REG_SLICE_8;       /*!< Pattern Match Mask Register Slice 8                                   */
	...
	union {
		__IO uint32_t  PATTERN_MATCH_REG_SLICE_9;       /*!< Pattern Match Mask Register Slice 9                                   */
	...
	union {
		__IO uint32_t  PATTERN_MATCH_REG_SLICE_10;      /*!< Pattern Match Mask Register Slice 10                                  */
	...
	union {
		...
		struct {
			__IO uint32_t  INRT_ENABLE_CLEAR: 16;         /*!< Common shift interrupt enable Set register for all SIOs               */
		} SHIFT_INTR_MASK_SET_REG_b;                    /*!< BitSize                                                               */
	};

	union {
		__I  uint32_t  SHIFT_INTR_MASK_CLEAR_REG;       /*!< Shift Interrupt Mask Clear Register                                   */
	...
	union {
		__IO  uint32_t  SWAP_INTR_MASK_CLEAR_REG;        /*!< Swap Interrupt Mask Clear Register                                    */
	...
	union {
		__IO uint32_t  PATTERN_MATCH_INTR_EN_SET_REG;   /*!< Pattern Match Interrupt Enable Set Register                           */
	...
	union {
		__I  uint32_t  PATTERN_MATCH_INTR_EN_CLEAR_REG; /*!< Pattern Match Interrupt Enable Clear Register                         */
	...
	union {
		__IO uint32_t  PATTERN_MATCH_INTR_MASK_SET_REG; /*!< Pattern Match Interrupt Mask Set Register                             */
	...
	union {
		__I  uint32_t  PATTERN_MATCH_INTR_MASK_CLEAR_REG;/*!< Pattern Match Interrupt Mask Clear Register                          */
	...
	union {
		__IO uint32_t  PATTERN_MATCH_INTR_STATUS_REG;   /*!< Pattern Match Interrupt Status Register                               */
...
typedef struct {                                    /*!< CRC Structure                                                         */
	...
	union {
		__IO uint32_t  POLYNOMIAL_CTRL_RESET_REG;       /*!< Polynomial control set register                                       */
	...
	union {
		__IO uint32_t  LFSR_INIT_CTRL_RESET_REG;        /*!< LFSR state initialization control reset register                      */
...
typedef struct {                                    /*!< EFUSE Structure                                                       */
	...
	union {
		__IO uint32_t  EFUSE_MEM_MAP_LENGTH_REG;        /*!< none                                                                  */

		struct {
			__IO uint32_t  EFUSE_MEM_MAP_LEN:  1;         /*!< 0: 8 bit read 1: 16 bit read                                          */
		} EFUSE_MEM_MAP_LENGTH_REG_b;                   /*!< BitSize                                                               */
	};
	__IO uint32_t  EFUSE_READ_BLOCK_STARTING_LOCATION_REG;/*!< Starting address from which the read has to be blocked. Once
	...
	union {
		...
		struct {
			__IO uint32_t  STROBE_CLEAR_COUNT_VALUE:  9;  /*!< none                                                                  */
...
typedef struct {                                    /*!< CCI Structure                                                         */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  EARLY_BURST_TERMINATE_SUPRT:  1;  /*!< Support for Early Burst Termination                                  */
	...
	/*0x28*/
	union {
		__IO uint32_t  CCI_MODE_INTR_STATUS_REG;        /*!< Interrupt Status                                                      */
	...
	union {
		...
		struct {
			__IO uint32_t  FIFO_AFULL_THRESHOLD :  5;      /*!< Alomost Full Threshold                                                */
			__IO uint32_t  FIFO_AEMPTY_THRESHOLD:  5;     /*!< Almost Empty Threshold                                                */
	...
	/*0x208*/
	union {
		__IO uint32_t  CCI_PREFETCH_CONTROL_REG;        /*!< Interrupt Status                                                      */

		struct {
			__IO uint32_t  CCI_PREFECT_ENABLE            :  1;            /*!<cci pre-fetch enable:1: prefetch is enable on AHB read operation. In this mode,
			...
			__IO uint32_t  CCI_2X_CLK_ENBALE_FOR_DDR_MODE :  1;            /*!< This is an enable for CCI 2x clock in DDR mode.                       */
...
typedef struct {                                    /*!< I2S1 Structure                                                        */
	...
	I2S0_CHANNEL_CONFIG_Type CHANNEL_CONFIG[4];       /*!< CHANNEL_CONFIG0                                                       */
	...
	union {
		...
		struct {
			...
			__I  uint32_t  I2S_FIFO_DEPTH_GLOBAL:  2;     /*!< Determines FIFO depth for all channels                                */
			__I  uint32_t  I2S_FIFO_MODE_EN:  1;          /*!< Determines whether component act as Master or Slave                   */
			__I  uint32_t  I2S_TRANSMITTER_BLOCK:  1;     /*!< Shows the presence of the transmitter block                           */
...
typedef struct {                                    /*!< SCT0 Structure                                                        */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  PERIODIC_EN_COUNTER_0_FRM_REG:  1;/*!< This is applied to 32 bits of counter only when the counter
                                                         is in 32 bit counter mode otherwise this will be applied to
                                                          only lower 16 bits of counter                                        */
			__IO uint32_t  COUNTER_0_TRIG_FRM_REG:  1;    /*!< This enables the counter to run/active                                */
			...
			__IO uint32_t  BUF_REG_0_EN:  1;              /*!< Buffer register gets enabled for MATCH REG. MATCH_BUF_REG is
                                                         always available and whenever this bit is set only, gets copied
                                                          to MATCH REG.                                                        */
			uint32_t             :  9;
			__IO uint32_t  SOFT_RESET_COUNTER_1_FRM_REG:  1;/*!< This resets the counter on the write                                */
			__IO uint32_t  PERIODIC_EN_COUNTER_1_FRM_REG:  1;/*!< This resets the counter on the write                               */
			__IO uint32_t  COUNTER_1_TRIG_FRM_REG:  1;        /*!< This enables the counter to run/active                                */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  SOFT_RESET_COUNTER_1_FRM_REG:  1;/*!< This resets the counter on the write                                */
			__IO uint32_t  PERIODIC_EN_COUNTER_1_FRM_REG:  1;/*!< This resets the counter on the write                               */
			__IO uint32_t  COUNTER_1_TRIG_FRM:  1;        /*!< This enables the counter to run/active                                */
			__IO uint32_t  COUNTER_1_UP_DOWN:  2;         /*!< This enables the counter to run in upward direction                   */
			__IO uint32_t  COUNTER_1_SYNC_TRIG:  1;       /*!< This is applied to 32 bits of counter only when the counter
                                                         is in 32 bit counter mode otherwise this will be applied to
                                                          only lower 16 bits of counter.This enables the counter to run/active
	...
	union {
		...
		struct {
			...
			__I  uint32_t  COUNTER_0_IS_ZERO_L:  1;       /*!< Counter 0 hit zero in active mode.                                    */
			__I  uint32_t  COUNTER_0_IS_PEAK_L:  1;       /*!< Counter 0 hit peak (MATCH) in active mode.                            */
			uint32_t             : 12;
			...
			__I  uint32_t  COUNTER_1_IS_ZERO_L:  1;       /*!< Counter 1 hit zero in active mode.                                    */
			__I  uint32_t  COUNTER_1_IS_PEAK_L:  1;       /*!< Counter 1 hit peak (MATCH) in active mode.                            */
		} INTR_STS_b;                                   /*!< BitSize                                                               */
	};
	...
	union {
		...
		struct {
			...
			__IO uint32_t  COUNTER_0_IS_ZERO_L:  1;       /*!< Interrupt mask signal.                                                */
			__IO uint32_t  COUNTER_0_IS_PEAK_L:  1;       /*!< Interrupt mask signal.                                                */
			uint32_t             : 12;
			__IO uint32_t  INTR_1_L   :  1;               /*!< Interrupt mask signal.                                                */
			__IO uint32_t  FIFO_1_FULL_L:  1;             /*!< Interrupt mask signal.                                                */
			__IO uint32_t  COUNTER_1_IS_ZERO_L:  1;       /*!< Interrupt mask signal.                                                */
			__IO uint32_t  COUNTER_1_IS_PEAK_L:  1;       /*!< Interrupt mask signal.                                                */
		} INTR_MASK_b;                                  /*!< BitSize                                                               */
	};
	...
	union {
		...
		struct {
			...
			__IO uint32_t  COUNTER_0_IS_ZERO_L:  1;       /*!< Interrupt unmask signal.                                              */
			__IO uint32_t  COUNTER_0_IS_PEAK_L:  1;       /*!< Interrupt unmask signal.                                              */
			uint32_t             : 12;
			__IO uint32_t  INTR_1_L   :  1;               /*!< Interrupt unmask signal.                                              */
			__IO uint32_t  FIFO_1_FULL_L:  1;             /*!< Interrupt unmask signal.                                              */
			__IO uint32_t  COUNTER_1_IS_ZERO_L:  1;       /*!< Interrupt unmask signal.                                              */
			__IO uint32_t  COUNTER_1_IS_PEAK_L:  1;       /*!< Interrupt unmask signal.                                              */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  COUNTER_0_IS_ZERO_L:  1;       /*!< Interrupt ack signal.                                                 */
			__IO uint32_t  COUNTER_0_IS_PEAK_L:  1;       /*!< Interrupt ack signal.                                                 */
			uint32_t             : 12;
			__IO uint32_t  INTR_1_L   :  1;               /*!< Interrupt ack signal.                                                 */
			__IO uint32_t  FIFO_1_FULL_L:  1;             /*!< Interrupt ack signal.                                                 */
			__IO uint32_t  COUNTER_1_IS_ZERO_L:  1;       /*!< Interrupt ack signal.                                                 */
			__IO uint32_t  COUNTER_1_IS_PEAK_L:  1;       /*!< Interrupt ack signal.                                                 */
		} INTR_ACK_b;                                   /*!< BitSize                                                               */
	};
	...
	union {
		...
		struct {
			__IO uint32_t  OCU_SYNC_CHANNEL0: 16;         /*!< Starting point of channel 0 for synchronization purpose               */
			__IO uint32_t  OCU_SYNC_CHANNEL1: 16;         /*!< Starting point of channel 1 for synchronization purpose               */
	...
	union {
		...
		struct {
			__IO uint32_t  OCU_COMPARE_NXT_COUNTER1: 16;  /*!< OCU output should be high for counter 1                               */
			__IO uint32_t  OCU_COMPARE_NXT_COUNTER0: 16;  /*!< PWM output should be high for counter 0                               */
	...
	union {
		...
		struct {
			...
			__IO uint32_t  MAKE_OUTPUT_0_TGL_1_SEL:  3;   /*!< Check the counter ocus possibilities for description for channel
                                                         0.                                                                    */
			uint32_t             :  2;
			__IO uint32_t  WFG_TGL_CNT_0_PEAK:  8;        /*!< WFG mode output toggle count clock for channel 0.                     */
			...
			__IO uint32_t  MAKE_OUTPUT_1_TGL_1_SEL:  3;   /*!< Check the counter ocus possibilities for description for channel
                                                         1.                                                                    */
			uint32_t             :  2;
			__IO uint32_t  WFG_TGL_CNT_1_PEAK:  8;        /*!< WFG mode output toggle count clock for channel 1                      */
	...
	union {
		...
		struct {
			__IO uint32_t  OCU_COMPARE2_NXT_COUNTER0: 16; /*!< OCU output should be high for counter 1                               */
			__IO uint32_t  OCU_COMPARE2_NXT_COUNTER1: 16; /*!< PWM output should be high for counter 0                               */
	...
	union {
		...
		struct {
			...
			uint32_t             :  4;
			__IO uint32_t  START_COUNTER_0_AND_VLD:  4;   /*!< none                                                                  */
			uint32_t             :  4;
			 ...
			 */
			uint32_t             :  4;
			__IO uint32_t  START_COUNTER_1_AND_VLD:  4;   /*!< none                                                                  */
	...
	union {
		...
		struct {
			...
			uint32_t             :  4;
			__IO uint32_t  START_COUNTER_0_OR_VLD:  4;    /*!< none                                                                  */
			uint32_t             :  4;
			...
			uint32_t             :  4;
			__IO uint32_t  START_COUNTER_1_OR_VLD:  4;    /*!< none                                                                  */
		} START_COUNTER_OR_EVENT_b;                     /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  CONTINUE_COUNTER_EVENT_SEL;      /*!< Continue counter event select register                                */
	...
	union {
		__IO uint32_t  CONTINUE_COUNTER_AND_EVENT;      /*!< Continue counter AND event register                                   */

		struct {
			__IO uint32_t  CONTINUE_COUNTER_0_AND_EVENT:  4;/*!< For two 16 bit counter mode: AND expression valids for AND event
                                                         in continue Counter 0 event For 32 bit counter mode AND expression
                                                          valids for AND event in continue counter event.                      */
			uint32_t             :  4;
			__IO uint32_t  CONTINUE_COUNTER_0_AND_VLD:  4;/*!< none                                                                  */
			uint32_t             :  4;
			 ...
			 */
			uint32_t             :  4;
			__IO uint32_t  CONTINUE_COUNTER_1_AND_VLD:  4;/*!< none                                                                  */
		} CONTINUE_COUNTER_AND_EVENT_b;                 /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  CONTINUE_COUNTER_OR_EVENT;       /*!< Continue counter OR event register                                    */
		...
		struct {
			...
			uint32_t             :  4;
			__IO uint32_t  CONTINUE_COUNTER_0_OR_VLD:  4; /*!< none                                                                  */
			uint32_t             :  4;
			__IO uint32_t  CONTINUE_COUNTER_1_OR_EVENT:  4;/*!< For two 16 bit counters mode: OR expression valids for OR event
                                                         in continue counter event For 32 bit counter mode : Invalid
			 */
			uint32_t             :  4;
			__IO uint32_t  CONTINUE_COUNTER_1_OR_VLD:  4; /*!< none                                                                  */
	...
	union {
		...
		struct {
			...
			uint32_t             :  4;
			__IO uint32_t  STOP_COUNTER_0_AND_VLD:  4;    /*!< none                                                                  */
			uint32_t             :  4;
			 ...
			 */
			uint32_t             :  4;
			__IO uint32_t  STOP_COUNTER_1_AND_VLD:  4;    /*!< none                                                                  */
	...
	union {
		...
		struct {
			...
			uint32_t             :  4;
			__IO uint32_t  STOP_COUNTER_0_OR_VLD:  4;     /*!< none                                                                  */
			uint32_t             :  4;
			...
			uint32_t             :  4;
			__IO uint32_t  STOP_COUNTER_1_OR_VLD:  4;     /*!< none                                                                  */
	...
	union {
		...
		struct {
			__IO uint32_t  HALT_COUNTER_0_EVENT_SEL:  6;  /*!< For two 16 bit counters mode: Event select for Halting the Counter
                                                         0 For 32 bit counter mode: Event select for Halting counter*/\
                                                         __IO uint32_t  RESUME_HALT_COUNTER_0   :  1;
                                                         uint32_t             : 10;
                                                         __IO uint32_t  HALT_COUNTER_1_EVENT_SEL:  6;  /*!< For two 16 bit counters mode: Event select for Halting the Counter
	...
	union {
		...
		struct {
			...
			uint32_t             :  4;
			__IO uint32_t  HALT_COUNTER_0_OR_VLD:  4;     /*!< none                                                                  */
			uint32_t             :  4;
			...
			uint32_t             :  4;
			__IO uint32_t  HALT_COUNTER_1_OR_VLD:  4;     /*!< none                                                                  */
		} HALT_COUNTER_OR_EVENT_b;                      /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  INCREMENT_COUNTER_EVENT_SEL;     /*!< Increment counter event select register                               */
	...
	union {
		__IO uint32_t  INCREMENT_COUNTER_AND_EVENT;     /*!< Increment counter AND event register                                  */

		struct {
			__IO uint32_t  INCREMENT_COUNTER_0_AND_EVENT:  4;/*!< For two 16 bit counter mode: AND expression valids for AND event
                                                         in stop Counter 0 event For 32 bit counter mode AND expression
                                                          valids for AND event in stop counter event                           */
			uint32_t             :  4;
			__IO uint32_t  INCREMENT_COUNTER_0_AND_VLD:  4;/*!< none                                                                 */
			uint32_t             :  4;
			__IO uint32_t  INCREMENT_COUNTER_1_AND_EVENT:  4;/*!< For two 16 bit counters mode: AND expression valids for AND
                                                         event in stop counter event For 32 bit counter mode : Invalid
			 */
			uint32_t             :  4;
			__IO uint32_t  INCREMENT_COUNTER_1_AND_VLD:  4;/*!< none                                                                 */
		} INCREMENT_COUNTER_AND_EVENT_b;                /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  INCREMENT_COUNTER_OR_EVENT;      /*!< Increment counter OR event register                                   */

		struct {
			__IO uint32_t  INCREMENT_COUNTER_0_OR_EVENT:  4;/*!< For two 16 bit counter mode: OR expression valids for OR event
                                                         in Increment Counter 0 event For 32 bit counter mode OR expression
                                                          valids for OR event in Increment counter event                       */
			uint32_t             :  4;
			__IO uint32_t  INCREMENT_COUNTER_0_OR_VLD:  4;/*!< none                                                                  */
			uint32_t             :  4;
			__IO uint32_t  INCREMENT_COUNTER_1_OR_EVENT:  4;/*!< For two 16 bit counters mode: OR expression valids for OR event
                                                         in Increment counter event For 32 bit counter mode : Invalid
			 */
			uint32_t             :  4;
			__IO uint32_t  INCREMENT_COUNTER_1_OR_VLD:  4;/*!< none                                                                  */
		} INCREMENT_COUNTER_OR_EVENT_b;                 /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  CAPTURE_COUNTER_EVENT_SEL;       /*!< Capture counter event select register                                 */
	...
	union {
		__IO uint32_t  CAPTURE_COUNTER_AND_EVENT;       /*!< Capture counter AND event register                                    */

		struct {
			__IO uint32_t  CAPTURE_COUNTER_0_AND_EVENT:  4;/*!< For two 16 bit counter mode: AND expression valids for AND event
                                                         in stop Counter 0 event For 32 bit counter mode AND expression
                                                          valids for AND event in stop counter event                           */
			uint32_t             :  4;
			__IO uint32_t  CAPTURE_COUNTER_0_AND_VLD:  4; /*!< none                                                                  */
			uint32_t             :  4;
			__IO uint32_t  CAPTURE_COUNTER_1_AND_EVENT:  4;/*!< For two 16 bit counters mode: AND expression valids for AND
                                                         event in stop counter event For 32 bit counter mode : Invalid
			 */
			uint32_t             :  4;
			__IO uint32_t  CAPTURE_COUNTER_1_AND_VLD:  4; /*!< none                                                                  */
		} CAPTURE_COUNTER_AND_EVENT_b;                  /*!< BitSize                                                               */
	};

	union {
		__IO uint32_t  CAPTURE_COUNTER_OR_EVENT;        /*!< Capture counter OR event register                                     */
		...
		struct {
			...
			uint32_t             :  4;
			__IO uint32_t  CAPTURE_COUNTER_0_OR_VLD:  4;  /*!< none                                                                  */
			uint32_t             :  4;
			...
			uint32_t             :  4;
			__IO uint32_t  CAPTURE_COUNTER_1_OR_VLD:  4;  /*!< none                                                                  */
	...
	union {
		...
		struct {
			__IO uint32_t  OUTPUT_0_AND_EVENT:  4;        /*!< AND expression for AND event in output Counter_0 event.               */
			uint32_t             :  4;
			__IO uint32_t  OUTPUT_0_AND_VLD:  4;          /*!< AND expression for AND event in output Counter_0 event.               */
			uint32_t             :  4;
			__IO uint32_t  OUTPUT_1_AND_EVENT:  4;        /*!< AND expression for AND event in output Counter_1 event.               */
			uint32_t             :  4;
...
typedef struct {                                    /*!< EGPIO0 Structure                                                      */
	...
	__I  uint32_t  RESERVED2[4];
	EGPIO0_GPIO_GRP_INTR_Type GPIO_GRP_INTR[4];       /*!< GPIO_GRP_INTR0                                                        */
} EGPIO_Type;
...
typedef struct {                                    /*!< M4_PLL Structure                                                      */
	...
	/*0x80*/
	union {
		__I  uint32_t  DYN_CLK_GATE_DISABLE_REG2;                     /*!< Clock Calibration Status Register1                                    */
...
typedef struct {
	...
	/*0x04*/
	union {
		__IO uint32_t  MCU_WWD_SYSTEM_RESET_TIMER;             /*!< none                                                                  */
...
typedef struct {
	...
	/*0x38*/
	union {
		__IO uint32_t  MCU_CAL_READ_COUNT_TIMER;             /*!< none                                                                  */
	...
	/*0x3C*/
	union {
		__IO uint32_t  MCU_CAL_SLEEP_CLK_COUNTERS;             /*!< none                                                                  */
...
typedef struct {
	...
	union {
		...
		struct {
			...
			__IO uint32_t POWER_ENABLE_TIMESTAPING     :1  ;
