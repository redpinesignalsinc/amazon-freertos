...
#define RSI_TCP_IP_FEATURE_BIT_MAP  (TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_FEAT_DNS_CLIENT | TCP_IP_FEAT_DHCPV4_SERVER | TCP_IP_FEAT_EXTENSION_VALID)
...
#define RSI_EXT_TCPIP_FEATURE_BITMAP   EXT_TCP_IP_BI_DIR_ACK_UPDATE
...
#define TCP_RX_WINDOW_SIZE_CAP           5 //10               //@ TCP RX Window size
