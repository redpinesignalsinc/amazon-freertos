...
check_fs_params_existing = [
    ...
    (afqp_check.AFR_ROOT, 'rules.json', 'espressif', 'esp32', 'make'),
...
check_platform_name_params = [
    ...
    (afqp_check.AFR_ROOT, 'espressif', 'esp32'),
    ...
    (afqp_check.AFR_ROOT, 'redpine', 'RS14100'),
...
get_eclipse_project_errors_params = [
    (os.path.join(afqp_check.AFR_ROOT, 'projects/ti/cc3220_launchpad/ccs/aws_demos/.project'), 0),
    (os.path.join(afqp_check.AFR_ROOT, 'projects/st/stm32l475_discovery/ac6/aws_demos/.project'), 0),
    (os.path.join(afqp_check.AFR_ROOT, 'projects/infineon/xmc4800_iotkit/dave4/aws_demos/.project'), 0),
    (os.path.join(afqp_check.AFR_ROOT, 'projects/nxp/lpc54018iotmodule/mcuxpresso/aws_demos/.project'), 0),
    (os.path.join(afqp_check.AFR_ROOT, 'projects/xilinx/microzed/xsdk/aws_demos/.project'), 0),
...
eclipse_check_params = [
    (afqp_check.AFR_ROOT, 'aws_demos', 'ti', 'cc3220_launchpad', 'ccs', 2),
    (afqp_check.AFR_ROOT, 'aws_demos', 'st', 'stm32l475_discovery', 'ac6', 0),
    (afqp_check.AFR_ROOT, 'aws_demos', 'infineon', 'xmc4800_iotkit', 'dave4', 0),
    (afqp_check.AFR_ROOT, 'aws_demos', 'nxp', 'lpc54018iotmodule', 'mcuxpresso', 0),
